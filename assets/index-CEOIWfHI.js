...
\`\`\``,WS="",KS=`# Most Feared Linux Commands to Know
...
This command turns experience into a searchable database. The longer you work in Linux, the more powerful it becomes.`,ZS=`# Reflections on My Tenure at Iskaan
...
Sincerely,  
[Your Full Name]`,JS=`# Run Claude Code Locally on Apple Silicon Using LM Studio and LiteLLM (Zero Cost)
...
[Service Provider]`,e1=`# Passwordless SSH Login Using SSH Key Authentication (Step-by-Step Guide)
...
\`\`\`
ssh -vvv user@server
\`\`\``,n1=`# Setting a Login Banner on Linux Servers 
...
\`\`\``,t1=`# What SRE Interviewers Really Look For
...
Used correctly, this boosts productivity massively.`,a1=`## Convert a Meeting from Video .mp4 to Audio with AI in Mac Terminal and Generating MoM's. 
...
> "Summarize the following meeting transcript into key decisions, action items, and important discussion points and generate a MoM for this."`,i1=`# Using Manga-Downloader on Mac
...
Check flags on how to use CLI properly from the documentation.`,l1=`# DevOps Commands Cheat Sheet (With Real-World Examples)
...
48.  \`journalctl\`  — View system logs
    ...
    Copy:  \`journalctl -u nginx\`  # Shows logs for the nginx service.`,r1=`# How to Write Markdown .md Files in Your Code and Push It to GitHub Pages (Deployment)
...
to publish the changes to the GitHub repo (main branch) and it will automatically push the new build to the gh-pages branch (where you can check the deployment status).`,o1=`Terminal Tools For Mac OS and Linux
==============
...
nyancat in action`,s1=`# ✏️ Start writing
...
<img 
    ...
    alt="Example Image" 
    style="width:200px; height:200px; object-fit:cover; border-radius:10px; display:block; margin:10px 0;">`,u1=Object.assign({"/public/docs/10 Grep Commands for Linux Systems.md":HS,"/public/docs/5 Useful Linux and Mac Automationn Scripts.md":IS,"/public/docs/Basic Git Commands.md":jS,"/public/docs/Dangerous Linux Commands.md":qS,"/public/docs/Download flac and convert to run on Mac and iPhone.md":YS,"/public/docs/Hacking Prevention.md":GS,"/public/docs/Interview Preperation.md":FS,"/public/docs/Linux Basic and Advanced Questions.md":VS,"/public/docs/Linux Cheat Sheet.md":PS,"/public/docs/Linux Commands.md":XS,"/public/docs/Linux Hacker Commands.md":QS,"/public/docs/Low Latency Setup Techniques Before Starting Projects.md":WS,"/public/docs/Most Feared Linux Commands.md":KS,"/public/docs/Reflection Of My Tenure at Iskaan.md":ZS,"/public/docs/Run Claude Code Local On Mac.md":JS,"/public/docs/SOW Template.md":$S,"/public/docs/SSH Auth.md":e1,"/public/docs/Setting Up a Login Banner on Linux Server.md":n1,"/public/docs/Thinking Like an SRE.md":t1,"/public/docs/Transcribe and Generate MoM in Mac Terminal.md":a1,"/public/docs/Use Manga Downloader on Mac.md":i1,"/public/docs/devopsCommands.md":l1,"/public/docs/howTo.md":r1,"/public/docs/macAndLinuxTerminalTools.md":o1,"/public/docs/nginx.md":s1}),wc=Object.entries(u1).map(([a,l])=>{const r=a.split("/").pop().replace(".md",""),o=l.match(/^#\s+(.*)/)?.[1]??r.replace(/-/g," ");return{slug:r,title:o,content:l}});function c1(){return sn.jsx("aside",{style:ju.sidebar,children:wc.map(a=>sn.jsx(Jp,{to:`/docs/${a.slug}`,style:({isActive:l})=>({...ju.link,...l?ju.active:{}}),children:a.title},a.slug))})}const ju={sidebar:{width:260,padding:"1rem",background:"var(--sidebar-bg)",borderRight:"1px solid #e5e7eb"},link:{display:"block",padding:"1rem 1rem",borderRadius:8,textDecoration:"none",color:"var(--text)",marginBottom:4,borderBottom:"1px solid #ccc"},active:{background:"var(--active-bg)",color:"var(--active-text)",fontWeight:600}};function f1(a,l){const r={};return(a[a.length-1]===""?[...a,""]:a).join((r.padRight?" ":"")+","+(r.padLeft===!1?"":" ")).trim()}const d1=/^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,h1=/^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,m1={};function Wm(a,l){return(m1.jsx?h1:d1).test(a)}const p1=/[ \t\n\f\r]/g;function g1(a){return typeof a=="object"?a.type==="text"?Km(a.value):!1:Km(a)}function Km(a){return a.replace(p1,"")===""}class Ol{constructor(l,r,o){this.normal=r,this.property=l,o&&(this.space=o)}}Ol.prototype.normal={};Ol.prototype.property={};Ol.prototype.space=void 0;function eg(a,l){const r={},o={};for(const c of a)Object.assign(r,c.property),Object.assign(o,c.normal);return new Ol(r,o,l)}function ac(a){return a.toLowerCase()}class _n{constructor(l,r){this.attribute=r,this.property=l}}_n.prototype.attribute="";_n.prototype.booleanish=!1;_n.prototype.boolean=!1;_n.prototype.commaOrSpaceSeparated=!1;_n.prototype.commaSeparated=!1;_n.prototype.defined=!1;_n.prototype.mustUseProperty=!1;_n.prototype.number=!1;_n.prototype.overloadedBoolean=!1;_n.prototype.property="";_n.prototype.spaceSeparated=!1;_n.prototype.space=void 0;let y1=0;const ve=Da(),tn=Da(),ic=Da(),X=Da(),qe=Da(),bi=Da(),Hn=Da();function Da(){return 2**++y1}const lc=Object.freeze(Object.defineProperty({__proto__:null,boolean:ve,booleanish:tn,commaOrSpaceSeparated:Hn,commaSeparated:bi,number:X,overloadedBoolean:ic,spaceSeparated:qe},Symbol.toStringTag,{value:"Module"})),qu=Object.keys(lc);class xc extends _n{constructor(l,r,o,c){let f=-1;if(super(l,r),Zm(this,"space",c),typeof o=="number")for(;++f<qu.length;){const d=qu[f];Zm(this,qu[f],(o&lc[d])===lc[d])}}}xc.prototype.defined=!0;function Zm(a,l,r){r&&(a[l]=r)}function Ci(a){const l={},r={};for(const[o,c]of Object.entries(a.properties)){const f=new xc(o,a.transform(a.attributes||{},o),c,a.space);a.mustUseProperty&&a.mustUseProperty.includes(o)&&(f.mustUseProperty=!0),l[o]=f,r[ac(o)]=o,r[ac(f.attribute)]=o}return new Ol(l,r,a.space)}const ng=Ci({properties:{ariaActiveDescendant:null,ariaAtomic:tn,ariaAutoComplete:null,ariaBusy:tn,ariaChecked:tn,ariaColCount:X,ariaColIndex:X,ariaColSpan:X,ariaControls:qe,ariaCurrent:null,ariaDescribedBy:qe,ariaDetails:null,ariaDisabled:tn,ariaDropEffect:qe,ariaErrorMessage:null,ariaExpanded:tn,ariaFlowTo:qe,ariaGrabbed:tn,ariaHasPopup:null,ariaHidden:tn,ariaInvalid:null,ariaKeyShortcuts:null,ariaLabel:null,ariaLabelledBy:qe,ariaLevel:X,ariaLive:null,ariaModal:tn,ariaMultiLine:tn,ariaMultiSelectable:tn,ariaOrientation:null,ariaOwns:qe,ariaPlaceholder:null,ariaPosInSet:X,ariaPressed:tn,ariaReadOnly:tn,ariaRelevant:null,ariaRequired:tn,ariaRoleDescription:qe,ariaRowCount:X,ariaRowIndex:X,ariaRowSpan:X,ariaSelected:tn,ariaSetSize:X,ariaSort:null,ariaValueMax:X,ariaValueMin:X,ariaValueNow:X,ariaValueText:null,role:null},transform(a,l){return l==="role"?l:"aria-"+l.slice(4).toLowerCase()}});function tg(a,l){return l in a?a[l]:l}function ag(a,l){return tg(a,l.toLowerCase())}const v1=Ci({attributes:{acceptcharset:"accept-charset",classname:"class",htmlfor:"for",httpequiv:"http-equiv"},mustUseProperty:["checked","multiple","muted","selected"],properties:{abbr:null,accept:bi,acceptCharset:qe,accessKey:qe,action:null,allow:null,allowFullScreen:ve,allowPaymentRequest:ve,allowUserMedia:ve,alt:null,as:null,async:ve,autoCapitalize:null,autoComplete:qe,autoFocus:ve,autoPlay:ve,blocking:qe,capture:null,charSet:null,checked:ve,cite:null,className:qe,cols:X,colSpan:null,content:null,contentEditable:tn,controls:ve,controlsList:qe,coords:X|bi,crossOrigin:null,data:null,dateTime:null,decoding:null,default:ve,defer:ve,dir:null,dirName:null,disabled:ve,download:ic,draggable:tn,encType:null,enterKeyHint:null,fetchPriority:null,form:null,formAction:null,formEncType:null,formMethod:null,formNoValidate:ve,formTarget:null,headers:qe,height:X,hidden:ic,high:X,href:null,hrefLang:null,htmlFor:qe,httpEquiv:qe,id:null,imageSizes:null,imageSrcSet:null,inert:ve,inputMode:null,integrity:null,is:null,isMap:ve,itemId:null,itemProp:qe,itemRef:qe,itemScope:ve,itemType:qe,kind:null,label:null,lang:null,language:null,list:null,loading:null,loop:ve,low:X,manifest:null,max:null,maxLength:X,media:null,method:null,min:null,minLength:X,multiple:ve,muted:ve,name:null,nonce:null,noModule:ve,noValidate:ve,onAbort:null,onAfterPrint:null,onAuxClick:null,onBeforeMatch:null,onBeforePrint:null,onBeforeToggle:null,onBeforeUnload:null,onBlur:null,onCancel:null,onCanPlay:null,onCanPlayThrough:null,onChange:null,onClick:null,onClose:null,onContextLost:null,onContextMenu:null,onContextRestored:null,onCopy:null,onCueChange:null,onCut:null,onDblClick:null,onDrag:null,onDragEnd:null,onDragEnter:null,onDragExit:null,onDragLeave:null,onDragOver:null,onDragStart:null,onDrop:null,onDurationChange:null,onEmptied:null,onEnded:null,onError:null,onFocus:null,onFormData:null,onHashChange:null,onInput:null,onInvalid:null,onKeyDown:null,onKeyPress:null,onKeyUp:null,onLanguageChange:null,onLoad:null,onLoadedData:null,onLoadedMetadata:null,onLoadEnd:null,onLoadStart:null,onMessage:null,onMessageError:null,onMouseDown:null,onMouseEnter:null,onMouseLeave:null,onMouseMove:null,onMouseOut:null,onMouseOver:null,onMouseUp:null,onOffline:null,onOnline:null,onPageHide:null,onPageShow:null,onPaste:null,onPause:null,onPlay:null,onPlaying:null,onPopState:null,onProgress:null,onRateChange:null,onRejectionHandled:null,onReset:null,onResize:null,onScroll:null,onScrollEnd:null,onSecurityPolicyViolation:null,onSeeked:null,onSeeking:null,onSelect:null,onSlotChange:null,onStalled:null,onStorage:null,onSubmit:null,onSuspend:null,onTimeUpdate:null,onToggle:null,onUnhandledRejection:null,onUnload:null,onVolumeChange:null,onWaiting:null,onWheel:null,open:ve,optimum:X,pattern:null,ping:qe,placeholder:null,playsInline:ve,popover:null,popoverTarget:null,popoverTargetAction:null,poster:null,preload:null,readOnly:ve,referrerPolicy:null,rel:qe,required:ve,reversed:ve,rows:X,rowSpan:X,sandbox:qe,scope:null,scoped:ve,seamless:ve,selected:ve,shadowRootClonable:ve,shadowRootDelegatesFocus:ve,shadowRootMode:null,shape:null,size:X,sizes:null,slot:null,span:X,spellCheck:tn,src:null,srcDoc:null,srcLang:null,srcSet:null,start:X,step:null,style:null,tabIndex:X,target:null,title:null,translate:null,type:null,typeMustMatch:ve,useMap:null,value:tn,width:X,wrap:null,writingSuggestions:null,align:null,aLink:null,archive:qe,axis:null,background:null,bgColor:null,border:X,borderColor:null,bottomMargin:X,cellPadding:null,cellSpacing:null,char:null,charOff:null,classId:null,clear:null,code:null,codeBase:null,codeType:null,color:null,compact:ve,declare:ve,event:null,face:null,frame:null,frameBorder:null,hSpace:X,leftMargin:X,link:null,longDesc:null,lowSrc:null,marginHeight:X,marginWidth:X,noResize:ve,noHref:ve,noShade:ve,noWrap:ve,object:null,profile:null,prompt:null,rev:null,rightMargin:X,rules:null,scheme:null,scrolling:tn,standby:null,summary:null,text:null,topMargin:X,valueType:null,version:null,vAlign:null,vLink:null,vSpace:X,allowTransparency:null,autoCorrect:null,autoSave:null,disablePictureInPicture:ve,disableRemotePlayback:ve,prefix:null,property:null,results:X,security:null,unselectable:null},space:"html",transform:ag}),b1=Ci({attributes:{accentHeight:"accent-height",alignmentBaseline:"alignment-baseline",arabicForm:"arabic-form",baselineShift:"baseline-shift",capHeight:"cap-height",className:"class",clipPath:"clip-path",clipRule:"clip-rule",colorInterpolation:"color-interpolation",colorInterpolationFilters:"color-interpolation-filters",colorProfile:"color-profile",colorRendering:"color-rendering",crossOrigin:"crossorigin",dataType:"datatype",dominantBaseline:"dominant-baseline",enableBackground:"enable-background",fillOpacity:"fill-opacity",fillRule:"fill-rule",floodColor:"flood-color",floodOpacity:"flood-opacity",fontFamily:"font-family",fontSize:"font-size",fontSizeAdjust:"font-size-adjust",fontStretch:"font-stretch",fontStyle:"font-style",fontVariant:"font-variant",fontWeight:"font-weight",glyphName:"glyph-name",glyphOrientationHorizontal:"glyph-orientation-horizontal",glyphOrientationVertical:"glyph-orientation-vertical",hrefLang:"hreflang",horizAdvX:"horiz-adv-x",horizOriginX:"horiz-origin-x",horizOriginY:"horiz-origin-y",imageRendering:"image-rendering",letterSpacing:"letter-spacing",lightingColor:"lighting-color",markerEnd:"marker-end",markerMid:"marker-mid",markerStart:"marker-start",navDown:"nav-down",navDownLeft:"nav-down-left",navDownRight:"nav-down-right",navLeft:"nav-left",navNext:"nav-next",navPrev:"nav-prev",navRight:"nav-right",navUp:"nav-up",navUpLeft:"nav-up-left",navUpRight:"nav-up-right",onAbort:"onabort",onActivate:"onactivate",onAfterPrint:"onafterprint",onBeforePrint:"onbeforeprint",onBegin:"onbegin",onCancel:"oncancel",onCanPlay:"oncanplay",onCanPlayThrough:"oncanplaythrough",onChange:"onchange",onClick:"onclick",onClose:"onclose",onCopy:"oncopy",onCueChange:"oncuechange",onCut:"oncut",onDblClick:"ondblclick",onDrag:"ondrag",onDragEnd:"ondragend",onDragEnter:"ondragenter",onDragExit:"ondragexit",onDragLeave:"ondragleave",onDragOver:"ondragover",onDragStart:"ondragstart",onDrop:"ondrop",onDurationChange:"ondurationchange",onEmptied:"onemptied",onEnd:"onend",onEnded:"onended",onError:"onerror",onFocus:"onfocus",onFocusIn:"onfocusin",onFocusOut:"onfocusout",onHashChange:"onhashchange",onInput:"oninput",onInvalid:"oninvalid",onKeyDown:"onkeydown",onKeyPress:"onkeypress",onKeyUp:"onkeyup",onLoad:"onload",onLoadedData:"onloadeddata",onLoadedMetadata:"onloadedmetadata",onLoadStart:"onloadstart",onMessage:"onmessage",onMouseDown:"onmousedown",onMouseEnter:"onmouseenter",onMouseLeave:"onmouseleave",onMouseMove:"onmousemove",onMouseOut:"onmouseout",onMouseOver:"onmouseover",onMouseUp:"onmouseup",onMouseWheel:"onmousewheel",onOffline:"onoffline",onOnline:"ononline",onPageHide:"onpagehide",onPageShow:"onpageshow",onPaste:"onpaste",onPause:"onpause",onPlay:"onplay",onPlaying:"onplaying",onPopState:"onpopstate",onProgress:"onprogress",onRateChange:"onratechange",onRepeat:"onrepeat",onReset:"onreset",onResize:"onresize",onScroll:"onscroll",onSeeked:"onseeked",onSeeking:"onseeking",onSelect:"onselect",onShow:"onshow",onStalled:"onstalled",onStorage:"onstorage",onSubmit:"onsubmit",onSuspend:"onsuspend",onTimeUpdate:"ontimeupdate",onToggle:"ontoggle",onUnload:"onunload",onVolumeChange:"onvolumechange",onWaiting:"onwaiting",onZoom:"onzoom",overlinePosition:"overline-position",overlineThickness:"overline-thickness",paintOrder:"paint-order",panose1:"panose-1",pointerEvents:"pointer-events",referrerPolicy:"referrerpolicy",renderingIntent:"rendering-intent",shapeRendering:"shape-rendering",stopColor:"stop-color",stopOpacity:"stop-opacity",strikethroughPosition:"strikethrough-position",strikethroughThickness:"strikethrough-thickness",strokeDashArray:"stroke-dasharray",strokeDashOffset:"stroke-dashoffset",strokeLineCap:"stroke-linecap",strokeLineJoin:"stroke-linejoin",strokeMiterLimit:"stroke-miterlimit",strokeOpacity:"stroke-opacity",strokeWidth:"stroke-width",tabIndex:"tabindex",textAnchor:"text-anchor",textDecoration:"text-decoration",textRendering:"text-rendering",transformOrigin:"transform-origin",typeOf:"typeof",underlinePosition:"underline-position",underlineThickness:"underline-thickness",unicodeBidi:"unicode-bidi",unicodeRange:"unicode-range",unitsPerEm:"units-per-em",vAlphabetic:"v-alphabetic",vHanging:"v-hanging",vIdeographic:"v-ideographic",vMathematical:"v-mathematical",vectorEffect:"vector-effect",vertAdvY:"vert-adv-y",vertOriginX:"vert-origin-x",vertOriginY:"vert-origin-y",wordSpacing:"word-spacing",writingMode:"writing-mode",xHeight:"x-height",playbackOrder:"playbackorder",timelineBegin:"timelinebegin"},properties:{about:Hn,accentHeight:X,accumulate:null,additive:null,alignmentBaseline:null,alphabetic:X,amplitude:X,arabicForm:null,ascent:X,attributeName:null,attributeType:null,azimuth:X,bandwidth:null,baselineShift:null,baseFrequency:null,baseProfile:null,bbox:null,begin:null,bias:X,by:null,calcMode:null,capHeight:X,className:qe,clip:null,clipPath:null,clipPathUnits:null,clipRule:null,color:null,colorInterpolation:null,colorInterpolationFilters:null,colorProfile:null,colorRendering:null,content:null,contentScriptType:null,contentStyleType:null,crossOrigin:null,cursor:null,cx:null,cy:null,d:null,dataType:null,defaultAction:null,descent:X,diffuseConstant:X,direction:null,display:null,dur:null,divisor:X,dominantBaseline:null,download:ve,dx:null,dy:null,edgeMode:null,editable:null,elevation:X,enableBackground:null,end:null,event:null,exponent:X,externalResourcesRequired:null,fill:null,fillOpacity:X,fillRule:null,filter:null,filterRes:null,filterUnits:null,floodColor:null,floodOpacity:null,focusable:null,focusHighlight:null,fontFamily:null,fontSize:null,fontSizeAdjust:null,fontStretch:null,fontStyle:null,fontVariant:null,fontWeight:null,format:null,fr:null,from:null,fx:null,fy:null,g1:bi,g2:bi,glyphName:bi,glyphOrientationHorizontal:null,glyphOrientationVertical:null,glyphRef:null,gradientTransform:null,gradientUnits:null,handler:null,hanging:X,hatchContentUnits:null,hatchUnits:null,height:null,href:null,hrefLang:null,horizAdvX:X,horizOriginX:X,horizOriginY:X,id:null,ideographic:X,imageRendering:null,initialVisibility:null,in:null,in2:null,intercept:X,k:X,k1:X,k2:X,k3:X,k4:X,kernelMatrix:Hn,kernelUnitLength:null,keyPoints:null,keySplines:null,keyTimes:null,kerning:null,lang:null,lengthAdjust:null,letterSpacing:null,lightingColor:null,limitingConeAngle:X,local:null,markerEnd:null,markerMid:null,markerStart:null,markerHeight:null,markerUnits:null,markerWidth:null,mask:null,maskContentUnits:null,maskUnits:null,mathematical:null,max:null,media:null,mediaCharacterEncoding:null,mediaContentEncodings:null,mediaSize:X,mediaTime:null,method:null,min:null,mode:null,name:null,navDown:null,navDownLeft:null,navDownRight:null,navLeft:null,navNext:null,navPrev:null,navRight:null,navUp:null,navUpLeft:null,navUpRight:null,numOctaves:null,observer:null,offset:null,onAbort:null,onActivate:null,onAfterPrint:null,onBeforePrint:null,onBegin:null,onCancel:null,onCanPlay:null,onCanPlayThrough:null,onChange:null,onClick:null,onClose:null,onCopy:null,onCueChange:null,onCut:null,onDblClick:null,onDrag:null,onDragEnd:null,onDragEnter:null,onDragExit:null,onDragLeave:null,onDragOver:null,onDragStart:null,onDrop:null,onDurationChange:null,onEmptied:null,onEnd:null,onEnded:null,onError:null,onFocus:null,onFocusIn:null,onFocusOut:null,onHashChange:null,onInput:null,onInvalid:null,onKeyDown:null,onKeyPress:null,onKeyUp:null,onLoad:null,onLoadedData:null,onLoadedMetadata:null,onLoadStart:null,onMessage:null,onMouseDown:null,onMouseEnter:null,onMouseLeave:null,onMouseMove:null,onMouseOut:null,onMouseOver:null,onMouseUp:null,onMouseWheel:null,onOffline:null,onOnline:null,onPageHide:null,onPageShow:null,onPaste:null,onPause:null,onPlay:null,onPlaying:null,onPopState:null,onProgress:null,onRateChange:null,onRepeat:null,onReset:null,onResize:null,onScroll:null,onSeeked:null,onSeeking:null,onSelect:null,onShow:null,onStalled:null,onStorage:null,onSubmit:null,onSuspend:null,onTimeUpdate:null,onToggle:null,onUnload:null,onVolumeChange:null,onWaiting:null,onZoom:null,opacity:null,operator:null,order:null,orient:null,orientation:null,origin:null,overflow:null,overlay:null,overlinePosition:X,overlineThickness:X,paintOrder:null,panose1:null,path:null,pathLength:X,patternContentUnits:null,patternTransform:null,patternUnits:null,phase:null,ping:qe,pitch:null,playbackOrder:null,pointerEvents:null,points:null,pointsAtX:X,pointsAtY:X,pointsAtZ:X,preserveAlpha:null,preserveAspectRatio:null,primitiveUnits:null,propagate:null,property:Hn,r:null,radius:null,referrerPolicy:null,refX:null,refY:null,rel:Hn,rev:Hn,renderingIntent:null,repeatCount:null,repeatDur:null,requiredExtensions:Hn,requiredFeatures:Hn,requiredFonts:Hn,requiredFormats:Hn,resource:null,restart:null,result:null,rotate:null,rx:null,ry:null,scale:null,seed:null,shapeRendering:null,side:null,slope:null,snapshotTime:null,specularConstant:X,specularExponent:X,spreadMethod:null,spacing:null,startOffset:null,stdDeviation:null,stemh:null,stemv:null,stitchTiles:null,stopColor:null,stopOpacity:null,strikethroughPosition:X,strikethroughThickness:X,string:null,stroke:null,strokeDashArray:Hn,strokeDashOffset:null,strokeLineCap:null,strokeLineJoin:null,strokeMiterLimit:X,strokeOpacity:X,strokeWidth:null,style:null,surfaceScale:X,syncBehavior:null,syncBehaviorDefault:null,syncMaster:null,syncTolerance:null,syncToleranceDefault:null,systemLanguage:Hn,tabIndex:X,tableValues:null,target:null,targetX:X,targetY:X,textAnchor:null,textDecoration:null,textRendering:null,textLength:null,timelineBegin:null,title:null,transformBehavior:null,type:null,typeOf:Hn,to:null,transform:null,transformOrigin:null,u1:null,u2:null,underlinePosition:X,underlineThickness:X,unicode:null,unicodeBidi:null,unicodeRange:null,unitsPerEm:X,values:null,vAlphabetic:X,vMathematical:X,vectorEffect:null,vHanging:X,vIdeographic:X,version:null,vertAdvY:X,vertOriginX:X,vertOriginY:X,viewBox:null,viewTarget:null,visibility:null,width:null,widths:null,wordSpacing:null,writingMode:null,x:null,x1:null,x2:null,xChannelSelector:null,xHeight:X,y:null,y1:null,y2:null,yChannelSelector:null,z:null,zoomAndPan:null},space:"svg",transform:tg}),ig=Ci({properties:{xLinkActuate:null,xLinkArcRole:null,xLinkHref:null,xLinkRole:null,xLinkShow:null,xLinkTitle:null,xLinkType:null},space:"xlink",transform(a,l){return"xlink:"+l.slice(5).toLowerCase()}}),lg=Ci({attributes:{xmlnsxlink:"xmlns:xlink"},properties:{xmlnsXLink:null,xmlns:null},space:"xmlns",transform:ag}),rg=Ci({properties:{xmlBase:null,xmlLang:null,xmlSpace:null},space:"xml",transform(a,l){return"xml:"+l.slice(3).toLowerCase()}}),S1={classId:"classID",dataType:"datatype",itemId:"itemID",strokeDashArray:"strokeDasharray",strokeDashOffset:"strokeDashoffset",strokeLineCap:"strokeLinecap",strokeLineJoin:"strokeLinejoin",strokeMiterLimit:"strokeMiterlimit",typeOf:"typeof",xLinkActuate:"xlinkActuate",xLinkArcRole:"xlinkArcrole",xLinkHref:"xlinkHref",xLinkRole:"xlinkRole",xLinkShow:"xlinkShow",xLinkTitle:"xlinkTitle",xLinkType:"xlinkType",xmlnsXLink:"xmlnsXlink"},w1=/[A-Z]/g,Jm=/-[a-z]/g,x1=/^data[-\w.:]+$/i;function C1(a,l){const r=ac(l);let o=l,c=_n;if(r in a.normal)return a.property[a.normal[r]];if(r.length>4&&r.slice(0,4)==="data"&&x1.test(l)){if(l.charAt(4)==="-"){const f=l.slice(5).replace(Jm,T1);o="data"+f.charAt(0).toUpperCase()+f.slice(1)}else{const f=l.slice(4);if(!Jm.test(f)){let d=f.replace(w1,k1);d.charAt(0)!=="-"&&(d="-"+d),l="data"+d}}c=xc}return new c(o,l)}function k1(a){return"-"+a.toLowerCase()}function T1(a){return a.charAt(1).toUpperCase()}const E1=eg([ng,v1,ig,lg,rg],"html"),Cc=eg([ng,b1,ig,lg,rg],"svg");function A1(a){return a.join(" ").trim()}var yi={},Yu,$m;function D1(){if($m)return Yu;$m=1;var a=/\/\*[^*]*\*+([^/*][^*]*\*+)*\//g,l=/\n/g,r=/^\s*/,o=/^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/,c=/^:\s*/,f=/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/,d=/^[;\s]*/,p=/^\s+|\s+$/g,g=`
`,m="/",y="*",v="",x="comment",S="declaration";function U(B,O){if(typeof B!="string")throw new TypeError("First argument must be a string");if(!B)return[];O=O||{};var V=1,F=1;function re(ae){var Q=ae.match(l);Q&&(V+=Q.length);var z=ae.lastIndexOf(g);F=~z?ae.length-z:F+ae.length}function oe(){var ae={line:V,column:F};return function(Q){return Q.position=new H(ae),fe(),Q}}function H(ae){this.start=ae,this.end={line:V,column:F},this.source=O.source}H.prototype.content=B;function K(ae){var Q=new Error(O.source+":"+V+":"+F+": "+ae);if(Q.reason=ae,Q.filename=O.source,Q.line=V,Q.column=F,Q.source=B,!O.silent)throw Q}function ce(ae){var Q=ae.exec(B);if(Q){var z=Q[0];return re(z),B=B.slice(z.length),Q}}function fe(){ce(r)}function ge(ae){var Q;for(ae=ae||[];Q=ee();)Q!==!1&&ae.push(Q);return ae}function ee(){var ae=oe();if(!(m!=B.charAt(0)||y!=B.charAt(1))){for(var Q=2;v!=B.charAt(Q)&&(y!=B.charAt(Q)||m!=B.charAt(Q+1));)++Q;if(Q+=2,v===B.charAt(Q-1))return K("End of comment missing");var z=B.slice(2,Q-2);return F+=2,re(z),B=B.slice(Q),F+=2,ae({type:x,comment:z})}}function J(){var ae=oe(),Q=ce(o);if(Q){if(ee(),!ce(c))return K("property missing ':'");var z=ce(f),P=ae({type:S,property:L(Q[0].replace(a,v)),value:z?L(z[0].replace(a,v)):v});return ce(d),P}}function Ae(){var ae=[];ge(ae);for(var Q;Q=J();)Q!==!1&&(ae.push(Q),ge(ae));return ae}return fe(),Ae()}function L(B){return B?B.replace(p,v):v}return Yu=U,Yu}var ep;function _1(){if(ep)return yi;ep=1;var a=yi&&yi.__importDefault||function(o){return o&&o.__esModule?o:{default:o}};Object.defineProperty(yi,"__esModule",{value:!0}),yi.default=r;const l=a(D1());function r(o,c){let f=null;if(!o||typeof o!="string")return f;const d=(0,l.default)(o),p=typeof c=="function";return d.forEach(g=>{if(g.type!=="declaration")return;const{property:m,value:y}=g;p?c(m,y,g):y&&(f=f||{},f[m]=y)}),f}return yi}var wl={},np;function R1(){if(np)return wl;np=1,Object.defineProperty(wl,"__esModule",{value:!0}),wl.camelCase=void 0;var a=/^--[a-zA-Z0-9_-]+$/,l=/-([a-z])/g,r=/^[^-]+$/,o=/^-(webkit|moz|ms|o|khtml)-/,c=/^-(ms)-/,f=function(m){return!m||r.test(m)||a.test(m)},d=function(m,y){return y.toUpperCase()},p=function(m,y){return"".concat(y,"-")},g=function(m,y){return y===void 0&&(y={}),f(m)?m:(m=m.toLowerCase(),y.reactCompat?m=m.replace(c,p):m=m.replace(o,p),m.replace(l,d))};return wl.camelCase=g,wl}var xl,tp;function z1(){if(tp)return xl;tp=1;var a=xl&&xl.__importDefault||function(c){return c&&c.__esModule?c:{default:c}},l=a(_1()),r=R1();function o(c,f){var d={};return!c||typeof c!="string"||(0,l.default)(c,function(p,g){p&&g&&(d[(0,r.camelCase)(p,f)]=g)}),d}return o.default=o,xl=o,xl}var O1=z1();const M1=uo(O1),og=sg("end"),kc=sg("start");function sg(a){return l;function l(r){const o=r&&r.position&&r.position[a]||{};if(typeof o.line=="number"&&o.line>0&&typeof o.column=="number"&&o.column>0)return{line:o.line,column:o.column,offset:typeof o.offset=="number"&&o.offset>-1?o.offset:void 0}}}function L1(a){const l=kc(a),r=og(a);if(l&&r)return{start:l,end:r}}function Tl(a){return!a||typeof a!="object"?"":"position"in a||"type"in a?ap(a.position):"start"in a||"end"in a?ap(a):"line"in a||"column"in a?rc(a):""}function rc(a){return ip(a&&a.line)+":"+ip(a&&a.column)}function ap(a){return rc(a&&a.start)+"-"+rc(a&&a.end)}function ip(a){return a&&typeof a=="number"?a:1}class pn extends Error{constructor(l,r,o){super(),typeof r=="string"&&(o=r,r=void 0);let c="",f={},d=!1;if(r&&("line"in r&&"column"in r?f={place:r}:"start"in r&&"end"in r?f={place:r}:"type"in r?f={ancestors:[r],place:r.position}:f={...r}),typeof l=="string"?c=l:!f.cause&&l&&(d=!0,c=l.message,f.cause=l),!f.ruleId&&!f.source&&typeof o=="string"){const g=o.indexOf(":");g===-1?f.ruleId=o:(f.source=o.slice(0,g),f.ruleId=o.slice(g+1))}if(!f.place&&f.ancestors&&f.ancestors){const g=f.ancestors[f.ancestors.length-1];g&&(f.place=g.position)}const p=f.place&&"start"in f.place?f.place.start:f.place;this.ancestors=f.ancestors||void 0,this.cause=f.cause||void 0,this.column=p?p.column:void 0,this.fatal=void 0,this.file="",this.message=c,this.line=p?p.line:void 0,this.name=Tl(f.place)||"1:1",this.place=f.place||void 0,this.reason=this.message,this.ruleId=f.ruleId||void 0,this.source=f.source||void 0,this.stack=d&&f.cause&&typeof f.cause.stack=="string"?f.cause.stack:"",this.actual=void 0,this.expected=void 0,this.note=void 0,this.url=void 0}}pn.prototype.file="";pn.prototype.name="";pn.prototype.reason="";pn.prototype.message="";pn.prototype.stack="";pn.prototype.column=void 0;pn.prototype.line=void 0;pn.prototype.ancestors=void 0;pn.prototype.cause=void 0;pn.prototype.fatal=void 0;pn.prototype.place=void 0;pn.prototype.ruleId=void 0;pn.prototype.source=void 0;const Tc={}.hasOwnProperty,N1=new Map,U1=/[A-Z]/g,B1=new Set(["table","tbody","thead","tfoot","tr"]),H1=new Set(["td","th"]),ug="https://github.com/syntax-tree/hast-util-to-jsx-runtime";function I1(a,l){if(!l||l.Fragment===void 0)throw new TypeError("Expected `Fragment` in options");const r=l.filePath||void 0;let o;if(l.development){if(typeof l.jsxDEV!="function")throw new TypeError("Expected `jsxDEV` in options when `development: true`");o=X1(r,l.jsxDEV)}else{if(typeof l.jsx!="function")throw new TypeError("Expected `jsx` in production options");if(typeof l.jsxs!="function")throw new TypeError("Expected `jsxs` in production options");o=P1(r,l.jsx,l.jsxs)}const c={Fragment:l.Fragment,ancestors:[],components:l.components||{},create:o,elementAttributeNameCase:l.elementAttributeNameCase||"react",evaluater:l.createEvaluater?l.createEvaluater():void 0,filePath:r,ignoreInvalidStyle:l.ignoreInvalidStyle||!1,passKeys:l.passKeys!==!1,passNode:l.passNode||!1,schema:l.space==="svg"?Cc:E1,stylePropertyNameCase:l.stylePropertyNameCase||"dom",tableCellAlignToStyle:l.tableCellAlignToStyle!==!1},f=cg(c,a,void 0);return f&&typeof f!="string"?f:c.create(a,c.Fragment,{children:f||void 0},void 0)}function cg(a,l,r){if(l.type==="element")return j1(a,l,r);if(l.type==="mdxFlowExpression"||l.type==="mdxTextExpression")return q1(a,l);if(l.type==="mdxJsxFlowElement"||l.type==="mdxJsxTextElement")return G1(a,l,r);if(l.type==="mdxjsEsm")return Y1(a,l);if(l.type==="root")return F1(a,l,r);if(l.type==="text")return V1(a,l)}function j1(a,l,r){const o=a.schema;let c=o;l.tagName.toLowerCase()==="svg"&&o.space==="html"&&(c=Cc,a.schema=c),a.ancestors.push(l);const f=dg(a,l.tagName,!1),d=Q1(a,l);let p=Ac(a,l);return B1.has(l.tagName)&&(p=p.filter(function(g){return typeof g=="string"?!g1(g):!0})),fg(a,d,f,l),Ec(d,p),a.ancestors.pop(),a.schema=o,a.create(l,f,d,r)}function q1(a,l){if(l.data&&l.data.estree&&a.evaluater){const o=l.data.estree.body[0];return o.type,a.evaluater.evaluateExpression(o.expression)}_l(a,l.position)}function Y1(a,l){if(l.data&&l.data.estree&&a.evaluater)return a.evaluater.evaluateProgram(l.data.estree);_l(a,l.position)}function G1(a,l,r){const o=a.schema;let c=o;l.name==="svg"&&o.space==="html"&&(c=Cc,a.schema=c),a.ancestors.push(l);const f=l.name===null?a.Fragment:dg(a,l.name,!0),d=W1(a,l),p=Ac(a,l);return fg(a,d,f,l),Ec(d,p),a.ancestors.pop(),a.schema=o,a.create(l,f,d,r)}function F1(a,l,r){const o={};return Ec(o,Ac(a,l)),a.create(l,a.Fragment,o,r)}function V1(a,l){return l.value}function fg(a,l,r,o){typeof r!="string"&&r!==a.Fragment&&a.passNode&&(l.node=o)}function Ec(a,l){if(l.length>0){const r=l.length>1?l:l[0];r&&(a.children=r)}}function P1(a,l,r){return o;function o(c,f,d,p){const m=Array.isArray(d.children)?r:l;return p?m(f,d,p):m(f,d)}}function X1(a,l){return r;function r(o,c,f,d){const p=Array.isArray(f.children),g=kc(o);return l(c,f,d,p,{columnNumber:g?g.column-1:void 0,fileName:a,lineNumber:g?g.line:void 0},void 0)}}function Q1(a,l){const r={};let o,c;for(c in l.properties)if(c!=="children"&&Tc.call(l.properties,c)){const f=K1(a,c,l.properties[c]);if(f){const[d,p]=f;a.tableCellAlignToStyle&&d==="align"&&typeof p=="string"&&H1.has(l.tagName)?o=p:r[d]=p}}if(o){const f=r.style||(r.style={});f[a.stylePropertyNameCase==="css"?"text-align":"textAlign"]=o}return r}function W1(a,l){const r={};for(const o of l.attributes)if(o.type==="mdxJsxExpressionAttribute")if(o.data&&o.data.estree&&a.evaluater){const f=o.data.estree.body[0];f.type;const d=f.expression;d.type;const p=d.properties[0];p.type,Object.assign(r,a.evaluater.evaluateExpression(p.argument))}else _l(a,l.position);else{const c=o.name;let f;if(o.value&&typeof o.value=="object")if(o.value.data&&o.value.data.estree&&a.evaluater){const p=o.value.data.estree.body[0];p.type,f=a.evaluater.evaluateExpression(p.expression)}else _l(a,l.position);else f=o.value===null?!0:o.value;r[c]=f}return r}function Ac(a,l){const r=[];let o=-1;const c=a.passKeys?new Map:N1;for(;++o<l.children.length;){const f=l.children[o];let d;if(a.passKeys){const g=f.type==="element"?f.tagName:f.type==="mdxJsxFlowElement"||f.type==="mdxJsxTextElement"?f.name:void 0;if(g){const m=c.get(g)||0;d=g+"-"+m,c.set(g,m+1)}}const p=cg(a,f,d);p!==void 0&&r.push(p)}return r}function K1(a,l,r){const o=C1(a.schema,l);if(!(r==null||typeof r=="number"&&Number.isNaN(r))){if(Array.isArray(r)&&(r=o.commaSeparated?f1(r):A1(r)),o.property==="style"){let c=typeof r=="object"?r:Z1(a,String(r));return a.stylePropertyNameCase==="css"&&(c=J1(c)),["style",c]}return[a.elementAttributeNameCase==="react"&&o.space?S1[o.property]||o.property:o.attribute,r]}}function Z1(a,l){try{return M1(l,{reactCompat:!0})}catch(r){if(a.ignoreInvalidStyle)return{};const o=r,c=new pn("Cannot parse `style` attribute",{ancestors:a.ancestors,cause:o,ruleId:"style",source:"hast-util-to-jsx-runtime"});throw c.file=a.filePath||void 0,c.url=ug+"#cannot-parse-style-attribute",c}}function dg(a,l,r){let o;if(!r)o={type:"Literal",value:l};else if(l.includes(".")){const c=l.split(".");let f=-1,d;for(;++f<c.length;){const p=Wm(c[f])?{type:"Identifier",name:c[f]}:{type:"Literal",value:c[f]};d=d?{type:"MemberExpression",object:d,property:p,computed:!!(f&&p.type==="Literal"),optional:!1}:p}o=d}else o=Wm(l)&&!/^[a-z]/.test(l)?{type:"Identifier",name:l}:{type:"Literal",value:l};if(o.type==="Literal"){const c=o.value;return Tc.call(a.components,c)?a.components[c]:c}if(a.evaluater)return a.evaluater.evaluateExpression(o);_l(a)}function _l(a,l){const r=new pn("Cannot handle MDX estrees without `createEvaluater`",{ancestors:a.ancestors,place:l,ruleId:"mdx-estree",source:"hast-util-to-jsx-runtime"});throw r.file=a.filePath||void 0,r.url=ug+"#cannot-handle-mdx-estrees-without-createevaluater",r}function J1(a){const l={};let r;for(r in a)Tc.call(a,r)&&(l[$1(r)]=a[r]);return l}function $1(a){let l=a.replace(U1,ew);return l.slice(0,3)==="ms-"&&(l="-"+l),l}function ew(a){return"-"+a.toLowerCase()}const Gu={action:["form"],cite:["blockquote","del","ins","q"],data:["object"],formAction:["button","input"],href:["a","area","base","link"],icon:["menuitem"],itemId:null,manifest:["html"],ping:["a","area"],poster:["video"],src:["audio","embed","iframe","img","input","script","source","track","video"]},nw={};function tw(a,l){const r=nw,o=typeof r.includeImageAlt=="boolean"?r.includeImageAlt:!0,c=typeof r.includeHtml=="boolean"?r.includeHtml:!0;return hg(a,o,c)}function hg(a,l,r){if(aw(a)){if("value"in a)return a.type==="html"&&!r?"":a.value;if(l&&"alt"in a&&a.alt)return a.alt;if("children"in a)return lp(a.children,l,r)}return Array.isArray(a)?lp(a,l,r):""}function lp(a,l,r){const o=[];let c=-1;for(;++c<a.length;)o[c]=hg(a[c],l,r);return o.join("")}function aw(a){return!!(a&&typeof a=="object")}const rp=document.createElement("i");function Dc(a){const l="&"+a+";";rp.innerHTML=l;const r=rp.textContent;return r.charCodeAt(r.length-1)===59&&a!=="semi"||r===l?!1:r}function ft(a,l,r,o){const c=a.length;let f=0,d;if(l<0?l=-l>c?0:c+l:l=l>c?c:l,r=r>0?r:0,o.length<1e4)d=Array.from(o),d.unshift(l,r),a.splice(...d);else for(r&&a.splice(l,r);f<o.length;)d=o.slice(f,f+1e4),d.unshift(l,0),a.splice(...d),f+=1e4,l+=1e4}function $n(a,l){return a.length>0?(ft(a,a.length,0,l),a):l}const op={}.hasOwnProperty;function iw(a){const l={};let r=-1;for(;++r<a.length;)lw(l,a[r]);return l}function lw(a,l){let r;for(r in l){const c=(op.call(a,r)?a[r]:void 0)||(a[r]={}),f=l[r];let d;if(f)for(d in f){op.call(c,d)||(c[d]=[]);const p=f[d];rw(c[d],Array.isArray(p)?p:p?[p]:[])}}}function rw(a,l){let r=-1;const o=[];for(;++r<l.length;)(l[r].add==="after"?a:o).push(l[r]);ft(a,0,0,o)}function mg(a,l){const r=Number.parseInt(a,l);return r<9||r===11||r>13&&r<32||r>126&&r<160||r>55295&&r<57344||r>64975&&r<65008||(r&65535)===65535||(r&65535)===65534||r>1114111?"�":String.fromCodePoint(r)}function Si(a){return a.replace(/[\t\n\r ]+/g," ").replace(/^ | $/g,"").toLowerCase().toUpperCase()}const ct=sa(/[A-Za-z]/),In=sa(/[\dA-Za-z]/),ow=sa(/[#-'*+\--9=?A-Z^-~]/);function oc(a){return a!==null&&(a<32||a===127)}const sc=sa(/\d/),sw=sa(/[\dA-Fa-f]/),uw=sa(/[!-/:-@[-`{-~]/);function he(a){return a!==null&&a<-2}function Dn(a){return a!==null&&(a<0||a===32)}function ze(a){return a===-2||a===-1||a===32}const cw=sa(new RegExp("\\p{P}|\\p{S}","u")),fw=sa(/\s/);function sa(a){return l;function l(r){return r!==null&&r>-1&&a.test(String.fromCharCode(r))}}function ki(a){const l=[];let r=-1,o=0,c=0;for(;++r<a.length;){const f=a.charCodeAt(r);let d="";if(f===37&&In(a.charCodeAt(r+1))&&In(a.charCodeAt(r+2)))c=2;else if(f<128)/[!#$&-;=?-Z_a-z~]/.test(String.fromCharCode(f))||(d=String.fromCharCode(f));else if(f>55295&&f<57344){const p=a.charCodeAt(r+1);f<56320&&p>56319&&p<57344?(d=String.fromCharCode(f,p),c=1):d="�"}else d=String.fromCharCode(f);d&&(l.push(a.slice(o,r),encodeURIComponent(d)),o=r+c+1,d=""),c&&(r+=c,c=0)}return l.join("")+a.slice(o)}function Ye(a,l,r,o){const c=o?o-1:Number.POSITIVE_INFINITY;let f=0;return d;function d(g){return ze(g)?(a.enter(r),p(g)):l(g)}function p(g){return ze(g)&&f++<c?(a.consume(g),p):(a.exit(r),l(g))}}const dw={tokenize:hw};function hw(a){const l=a.attempt(this.parser.constructs.contentInitial,o,c);let r;return l;function o(p){if(p===null){a.consume(p);return}return a.enter("lineEnding"),a.consume(p),a.exit("lineEnding"),Ye(a,l,"linePrefix")}function c(p){return a.enter("paragraph"),f(p)}function f(p){const g=a.enter("chunkText",{contentType:"text",previous:r});return r&&(r.next=g),r=g,d(p)}function d(p){if(p===null){a.exit("chunkText"),a.exit("paragraph"),a.consume(p);return}return he(p)?(a.consume(p),a.exit("chunkText"),f):(a.consume(p),d)}}const mw={tokenize:pw},sp={tokenize:gw};function pw(a){const l=this,r=[];let o=0,c,f,d;return p;function p(F){if(o<r.length){const re=r[o];return l.containerState=re[1],a.attempt(re[0].continuation,g,m)(F)}return m(F)}function g(F){if(o++,l.containerState._closeFlow){l.containerState._closeFlow=void 0,c&&V();const re=l.events.length;let oe=re,H;for(;oe--;)if(l.events[oe][0]==="exit"&&l.events[oe][1].type==="chunkFlow"){H=l.events[oe][1].end;break}O(o);let K=re;for(;K<l.events.length;)l.events[K][1].end={...H},K++;return ft(l.events,oe+1,0,l.events.slice(re)),l.events.length=K,m(F)}return p(F)}function m(F){if(o===r.length){if(!c)return x(F);if(c.currentConstruct&&c.currentConstruct.concrete)return U(F);l.interrupt=!!(c.currentConstruct&&!c._gfmTableDynamicInterruptHack)}return l.containerState={},a.check(sp,y,v)(F)}function y(F){return c&&V(),O(o),x(F)}function v(F){return l.parser.lazy[l.now().line]=o!==r.length,d=l.now().offset,U(F)}function x(F){return l.containerState={},a.attempt(sp,S,U)(F)}function S(F){return o++,r.push([l.currentConstruct,l.containerState]),x(F)}function U(F){if(F===null){c&&V(),O(0),a.consume(F);return}return c=c||l.parser.flow(l.now()),a.enter("chunkFlow",{_tokenizer:c,contentType:"flow",previous:f}),L(F)}function L(F){if(F===null){B(a.exit("chunkFlow"),!0),O(0),a.consume(F);return}return he(F)?(a.consume(F),B(a.exit("chunkFlow")),o=0,l.interrupt=void 0,p):(a.consume(F),L)}function B(F,re){const oe=l.sliceStream(F);if(re&&oe.push(null),F.previous=f,f&&(f.next=F),f=F,c.defineSkip(F.start),c.write(oe),l.parser.lazy[F.start.line]){let H=c.events.length;for(;H--;)if(c.events[H][1].start.offset<d&&(!c.events[H][1].end||c.events[H][1].end.offset>d))return;const K=l.events.length;let ce=K,fe,ge;for(;ce--;)if(l.events[ce][0]==="exit"&&l.events[ce][1].type==="chunkFlow"){if(fe){ge=l.events[ce][1].end;break}fe=!0}for(O(o),H=K;H<l.events.length;)l.events[H][1].end={...ge},H++;ft(l.events,ce+1,0,l.events.slice(K)),l.events.length=H}}function O(F){let re=r.length;for(;re-- >F;){const oe=r[re];l.containerState=oe[1],oe[0].exit.call(l,a)}r.length=F}function V(){c.write([null]),f=void 0,c=void 0,l.containerState._closeFlow=void 0}}function gw(a,l,r){return Ye(a,a.attempt(this.parser.constructs.document,l,r),"linePrefix",this.parser.constructs.disable.null.includes("codeIndented")?void 0:4)}function up(a){if(a===null||Dn(a)||fw(a))return 1;if(cw(a))return 2}function _c(a,l,r){const o=[];let c=-1;for(;++c<a.length;){const f=a[c].resolveAll;f&&!o.includes(f)&&(l=f(l,r),o.push(f))}return l}const uc={name:"attention",resolveAll:yw,tokenize:vw};function yw(a,l){let r=-1,o,c,f,d,p,g,m,y;for(;++r<a.length;)if(a[r][0]==="enter"&&a[r][1].type==="attentionSequence"&&a[r][1]._close){for(o=r;o--;)if(a[o][0]==="exit"&&a[o][1].type==="attentionSequence"&&a[o][1]._open&&l.sliceSerialize(a[o][1]).charCodeAt(0)===l.sliceSerialize(a[r][1]).charCodeAt(0)){if((a[o][1]._close||a[r][1]._open)&&(a[r][1].end.offset-a[r][1].start.offset)%3&&!((a[o][1].end.offset-a[o][1].start.offset+a[r][1].end.offset-a[r][1].start.offset)%3))continue;g=a[o][1].end.offset-a[o][1].start.offset>1&&a[r][1].end.offset-a[r][1].start.offset>1?2:1;const v={...a[o][1].end},x={...a[r][1].start};cp(v,-g),cp(x,g),d={type:g>1?"strongSequence":"emphasisSequence",start:v,end:{...a[o][1].end}},p={type:g>1?"strongSequence":"emphasisSequence",start:{...a[r][1].start},end:x},f={type:g>1?"strongText":"emphasisText",start:{...a[o][1].end},end:{...a[r][1].start}},c={type:g>1?"strong":"emphasis",start:{...d.start},end:{...p.end}},a[o][1].end={...d.start},a[r][1].start={...p.end},m=[],a[o][1].end.offset-a[o][1].start.offset&&(m=$n(m,[["enter",a[o][1],l],["exit",a[o][1],l]])),m=$n(m,[["enter",c,l],["enter",d,l],["exit",d,l],["enter",f,l]]),m=$n(m,_c(l.parser.constructs.insideSpan.null,a.slice(o+1,r),l)),m=$n(m,[["exit",f,l],["enter",p,l],["exit",p,l],["exit",c,l]]),a[r][1].end.offset-a[r][1].start.offset?(y=2,m=$n(m,[["enter",a[r][1],l],["exit",a[r][1],l]])):y=0,ft(a,o-1,r-o+3,m),r=o+m.length-y-2;break}}for(r=-1;++r<a.length;)a[r][1].type==="attentionSequence"&&(a[r][1].type="data");return a}function vw(a,l){const r=this.parser.constructs.attentionMarkers.null,o=this.previous,c=up(o);let f;return d;function d(g){return f=g,a.enter("attentionSequence"),p(g)}function p(g){if(g===f)return a.consume(g),p;const m=a.exit("attentionSequence"),y=up(g),v=!y||y===2&&c||r.includes(g),x=!c||c===2&&y||r.includes(o);return m._open=!!(f===42?v:v&&(c||!x)),m._close=!!(f===42?x:x&&(y||!v)),l(g)}}function cp(a,l){a.column+=l,a.offset+=l,a._bufferIndex+=l}const bw={name:"autolink",tokenize:Sw};function Sw(a,l,r){let o=0;return c;function c(S){return a.enter("autolink"),a.enter("autolinkMarker"),a.consume(S),a.exit("autolinkMarker"),a.enter("autolinkProtocol"),f}function f(S){return ct(S)?(a.consume(S),d):S===64?r(S):m(S)}function d(S){return S===43||S===45||S===46||In(S)?(o=1,p(S)):m(S)}function p(S){return S===58?(a.consume(S),o=0,g):(S===43||S===45||S===46||In(S))&&o++<32?(a.consume(S),p):(o=0,m(S))}function g(S){return S===62?(a.exit("autolinkProtocol"),a.enter("autolinkMarker"),a.consume(S),a.exit("autolinkMarker"),a.exit("autolink"),l):S===null||S===32||S===60||oc(S)?r(S):(a.consume(S),g)}function m(S){return S===64?(a.consume(S),y):ow(S)?(a.consume(S),m):r(S)}function y(S){return In(S)?v(S):r(S)}function v(S){return S===46?(a.consume(S),o=0,y):S===62?(a.exit("autolinkProtocol").type="autolinkEmail",a.enter("autolinkMarker"),a.consume(S),a.exit("autolinkMarker"),a.exit("autolink"),l):x(S)}function x(S){if((S===45||In(S))&&o++<63){const U=S===45?x:v;return a.consume(S),U}return r(S)}}const ho={partial:!0,tokenize:ww};function ww(a,l,r){return o;function o(f){return ze(f)?Ye(a,c,"linePrefix")(f):c(f)}function c(f){return f===null||he(f)?l(f):r(f)}}const pg={continuation:{tokenize:Cw},exit:kw,name:"blockQuote",tokenize:xw};function xw(a,l,r){const o=this;return c;function c(d){if(d===62){const p=o.containerState;return p.open||(a.enter("blockQuote",{_container:!0}),p.open=!0),a.enter("blockQuotePrefix"),a.enter("blockQuoteMarker"),a.consume(d),a.exit("blockQuoteMarker"),f}return r(d)}function f(d){return ze(d)?(a.enter("blockQuotePrefixWhitespace"),a.consume(d),a.exit("blockQuotePrefixWhitespace"),a.exit("blockQuotePrefix"),l):(a.exit("blockQuotePrefix"),l(d))}}function Cw(a,l,r){const o=this;return c;function c(d){return ze(d)?Ye(a,f,"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(d):f(d)}function f(d){return a.attempt(pg,l,r)(d)}}function kw(a){a.exit("blockQuote")}const gg={name:"characterEscape",tokenize:Tw};function Tw(a,l,r){return o;function o(f){return a.enter("characterEscape"),a.enter("escapeMarker"),a.consume(f),a.exit("escapeMarker"),c}function c(f){return uw(f)?(a.enter("characterEscapeValue"),a.consume(f),a.exit("characterEscapeValue"),a.exit("characterEscape"),l):r(f)}}const yg={name:"characterReference",tokenize:Ew};function Ew(a,l,r){const o=this;let c=0,f,d;return p;function p(v){return a.enter("characterReference"),a.enter("characterReferenceMarker"),a.consume(v),a.exit("characterReferenceMarker"),g}function g(v){return v===35?(a.enter("characterReferenceMarkerNumeric"),a.consume(v),a.exit("characterReferenceMarkerNumeric"),m):(a.enter("characterReferenceValue"),f=31,d=In,y(v))}function m(v){return v===88||v===120?(a.enter("characterReferenceMarkerHexadecimal"),a.consume(v),a.exit("characterReferenceMarkerHexadecimal"),a.enter("characterReferenceValue"),f=6,d=sw,y):(a.enter("characterReferenceValue"),f=7,d=sc,y(v))}function y(v){if(v===59&&c){const x=a.exit("characterReferenceValue");return d===In&&!Dc(o.sliceSerialize(x))?r(v):(a.enter("characterReferenceMarker"),a.consume(v),a.exit("characterReferenceMarker"),a.exit("characterReference"),l)}return d(v)&&c++<f?(a.consume(v),y):r(v)}}const fp={partial:!0,tokenize:Dw},dp={concrete:!0,name:"codeFenced",tokenize:Aw};function Aw(a,l,r){const o=this,c={partial:!0,tokenize:oe};let f=0,d=0,p;return g;function g(H){return m(H)}function m(H){const K=o.events[o.events.length-1];return f=K&&K[1].type==="linePrefix"?K[2].sliceSerialize(K[1],!0).length:0,p=H,a.enter("codeFenced"),a.enter("codeFencedFence"),a.enter("codeFencedFenceSequence"),y(H)}function y(H){return H===p?(d++,a.consume(H),y):d<3?r(H):(a.exit("codeFencedFenceSequence"),ze(H)?Ye(a,v,"whitespace")(H):v(H))}function v(H){return H===null||he(H)?(a.exit("codeFencedFence"),o.interrupt?l(H):a.check(fp,L,re)(H)):(a.enter("codeFencedFenceInfo"),a.enter("chunkString",{contentType:"string"}),x(H))}function x(H){return H===null||he(H)?(a.exit("chunkString"),a.exit("codeFencedFenceInfo"),v(H)):ze(H)?(a.exit("chunkString"),a.exit("codeFencedFenceInfo"),Ye(a,S,"whitespace")(H)):H===96&&H===p?r(H):(a.consume(H),x)}function S(H){return H===null||he(H)?v(H):(a.enter("codeFencedFenceMeta"),a.enter("chunkString",{contentType:"string"}),U(H))}function U(H){return H===null||he(H)?(a.exit("chunkString"),a.exit("codeFencedFenceMeta"),v(H)):H===96&&H===p?r(H):(a.consume(H),U)}function L(H){return a.attempt(c,re,B)(H)}function B(H){return a.enter("lineEnding"),a.consume(H),a.exit("lineEnding"),O}function O(H){return f>0&&ze(H)?Ye(a,V,"linePrefix",f+1)(H):V(H)}function V(H){return H===null||he(H)?a.check(fp,L,re)(H):(a.enter("codeFlowValue"),F(H))}function F(H){return H===null||he(H)?(a.exit("codeFlowValue"),V(H)):(a.consume(H),F)}function re(H){return a.exit("codeFenced"),l(H)}function oe(H,K,ce){let fe=0;return ge;function ge(Q){return H.enter("lineEnding"),H.consume(Q),H.exit("lineEnding"),ee}function ee(Q){return H.enter("codeFencedFence"),ze(Q)?Ye(H,J,"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(Q):J(Q)}function J(Q){return Q===p?(H.enter("codeFencedFenceSequence"),Ae(Q)):ce(Q)}function Ae(Q){return Q===p?(fe++,H.consume(Q),Ae):fe>=d?(H.exit("codeFencedFenceSequence"),ze(Q)?Ye(H,ae,"whitespace")(Q):ae(Q)):ce(Q)}function ae(Q){return Q===null||he(Q)?(H.exit("codeFencedFence"),K(Q)):ce(Q)}}}function Dw(a,l,r){const o=this;return c;function c(d){return d===null?r(d):(a.enter("lineEnding"),a.consume(d),a.exit("lineEnding"),f)}function f(d){return o.parser.lazy[o.now().line]?r(d):l(d)}}const Fu={name:"codeIndented",tokenize:Rw},_w={partial:!0,tokenize:zw};function Rw(a,l,r){const o=this;return c;function c(m){return a.enter("codeIndented"),Ye(a,f,"linePrefix",5)(m)}function f(m){const y=o.events[o.events.length-1];return y&&y[1].type==="linePrefix"&&y[2].sliceSerialize(y[1],!0).length>=4?d(m):r(m)}function d(m){return m===null?g(m):he(m)?a.attempt(_w,d,g)(m):(a.enter("codeFlowValue"),p(m))}function p(m){return m===null||he(m)?(a.exit("codeFlowValue"),d(m)):(a.consume(m),p)}function g(m){return a.exit("codeIndented"),l(m)}}function zw(a,l,r){const o=this;return c;function c(d){return o.parser.lazy[o.now().line]?r(d):he(d)?(a.enter("lineEnding"),a.consume(d),a.exit("lineEnding"),c):Ye(a,f,"linePrefix",5)(d)}function f(d){const p=o.events[o.events.length-1];return p&&p[1].type==="linePrefix"&&p[2].sliceSerialize(p[1],!0).length>=4?l(d):he(d)?c(d):r(d)}}const Ow={name:"codeText",previous:Lw,resolve:Mw,tokenize:Nw};function Mw(a){let l=a.length-4,r=3,o,c;if((a[r][1].type==="lineEnding"||a[r][1].type==="space")&&(a[l][1].type==="lineEnding"||a[l][1].type==="space")){for(o=r;++o<l;)if(a[o][1].type==="codeTextData"){a[r][1].type="codeTextPadding",a[l][1].type="codeTextPadding",r+=2,l-=2;break}}for(o=r-1,l++;++o<=l;)c===void 0?o!==l&&a[o][1].type!=="lineEnding"&&(c=o):(o===l||a[o][1].type==="lineEnding")&&(a[c][1].type="codeTextData",o!==c+2&&(a[c][1].end=a[o-1][1].end,a.splice(c+2,o-c-2),l-=o-c-2,o=c+2),c=void 0);return a}function Lw(a){return a!==96||this.events[this.events.length-1][1].type==="characterEscape"}function Nw(a,l,r){let o=0,c,f;return d;function d(v){return a.enter("codeText"),a.enter("codeTextSequence"),p(v)}function p(v){return v===96?(a.consume(v),o++,p):(a.exit("codeTextSequence"),g(v))}function g(v){return v===null?r(v):v===32?(a.enter("space"),a.consume(v),a.exit("space"),g):v===96?(f=a.enter("codeTextSequence"),c=0,y(v)):he(v)?(a.enter("lineEnding"),a.consume(v),a.exit("lineEnding"),g):(a.enter("codeTextData"),m(v))}function m(v){return v===null||v===32||v===96||he(v)?(a.exit("codeTextData"),g(v)):(a.consume(v),m)}function y(v){return v===96?(a.consume(v),c++,y):c===o?(a.exit("codeTextSequence"),a.exit("codeText"),l(v)):(f.type="codeTextData",m(v))}}class Uw{constructor(l){this.left=l?[...l]:[],this.right=[]}get(l){if(l<0||l>=this.left.length+this.right.length)throw new RangeError("Cannot access index `"+l+"` in a splice buffer of size `"+(this.left.length+this.right.length)+"`");return l<this.left.length?this.left[l]:this.right[this.right.length-l+this.left.length-1]}get length(){return this.left.length+this.right.length}shift(){return this.setCursor(0),this.right.pop()}slice(l,r){const o=r??Number.POSITIVE_INFINITY;return o<this.left.length?this.left.slice(l,o):l>this.left.length?this.right.slice(this.right.length-o+this.left.length,this.right.length-l+this.left.length).reverse():this.left.slice(l).concat(this.right.slice(this.right.length-o+this.left.length).reverse())}splice(l,r,o){const c=r||0;this.setCursor(Math.trunc(l));const f=this.right.splice(this.right.length-c,Number.POSITIVE_INFINITY);return o&&Cl(this.left,o),f.reverse()}pop(){return this.setCursor(Number.POSITIVE_INFINITY),this.left.pop()}push(l){this.setCursor(Number.POSITIVE_INFINITY),this.left.push(l)}pushMany(l){this.setCursor(Number.POSITIVE_INFINITY),Cl(this.left,l)}unshift(l){this.setCursor(0),this.right.push(l)}unshiftMany(l){this.setCursor(0),Cl(this.right,l.reverse())}setCursor(l){if(!(l===this.left.length||l>this.left.length&&this.right.length===0||l<0&&this.left.length===0))if(l<this.left.length){const r=this.left.splice(l,Number.POSITIVE_INFINITY);Cl(this.right,r.reverse())}else{const r=this.right.splice(this.left.length+this.right.length-l,Number.POSITIVE_INFINITY);Cl(this.left,r.reverse())}}}function Cl(a,l){let r=0;if(l.length<1e4)a.push(...l);else for(;r<l.length;)a.push(...l.slice(r,r+1e4)),r+=1e4}function vg(a){const l={};let r=-1,o,c,f,d,p,g,m;const y=new Uw(a);for(;++r<y.length;){for(;r in l;)r=l[r];if(o=y.get(r),r&&o[1].type==="chunkFlow"&&y.get(r-1)[1].type==="listItemPrefix"&&(g=o[1]._tokenizer.events,f=0,f<g.length&&g[f][1].type==="lineEndingBlank"&&(f+=2),f<g.length&&g[f][1].type==="content"))for(;++f<g.length&&g[f][1].type!=="content";)g[f][1].type==="chunkText"&&(g[f][1]._isInFirstContentOfListItem=!0,f++);if(o[0]==="enter")o[1].contentType&&(Object.assign(l,Bw(y,r)),r=l[r],m=!0);else if(o[1]._container){for(f=r,c=void 0;f--;)if(d=y.get(f),d[1].type==="lineEnding"||d[1].type==="lineEndingBlank")d[0]==="enter"&&(c&&(y.get(c)[1].type="lineEndingBlank"),d[1].type="lineEnding",c=f);else if(!(d[1].type==="linePrefix"||d[1].type==="listItemIndent"))break;c&&(o[1].end={...y.get(c)[1].start},p=y.slice(c,r),p.unshift(o),y.splice(c,r-c+1,p))}}return ft(a,0,Number.POSITIVE_INFINITY,y.slice(0)),!m}function Bw(a,l){const r=a.get(l)[1],o=a.get(l)[2];let c=l-1;const f=[];let d=r._tokenizer;d||(d=o.parser[r.contentType](r.start),r._contentTypeTextTrailing&&(d._contentTypeTextTrailing=!0));const p=d.events,g=[],m={};let y,v,x=-1,S=r,U=0,L=0;const B=[L];for(;S;){for(;a.get(++c)[1]!==S;);f.push(c),S._tokenizer||(y=o.sliceStream(S),S.next||y.push(null),v&&d.defineSkip(S.start),S._isInFirstContentOfListItem&&(d._gfmTasklistFirstContentOfListItem=!0),d.write(y),S._isInFirstContentOfListItem&&(d._gfmTasklistFirstContentOfListItem=void 0)),v=S,S=S.next}for(S=r;++x<p.length;)p[x][0]==="exit"&&p[x-1][0]==="enter"&&p[x][1].type===p[x-1][1].type&&p[x][1].start.line!==p[x][1].end.line&&(L=x+1,B.push(L),S._tokenizer=void 0,S.previous=void 0,S=S.next);for(d.events=[],S?(S._tokenizer=void 0,S.previous=void 0):B.pop(),x=B.length;x--;){const O=p.slice(B[x],B[x+1]),V=f.pop();g.push([V,V+O.length-1]),a.splice(V,2,O)}for(g.reverse(),x=-1;++x<g.length;)m[U+g[x][0]]=U+g[x][1],U+=g[x][1]-g[x][0]-1;return m}const Hw={resolve:jw,tokenize:qw},Iw={partial:!0,tokenize:Yw};function jw(a){return vg(a),a}function qw(a,l){let r;return o;function o(p){return a.enter("content"),r=a.enter("chunkContent",{contentType:"content"}),c(p)}function c(p){return p===null?f(p):he(p)?a.check(Iw,d,f)(p):(a.consume(p),c)}function f(p){return a.exit("chunkContent"),a.exit("content"),l(p)}function d(p){return a.consume(p),a.exit("chunkContent"),r.next=a.enter("chunkContent",{contentType:"content",previous:r}),r=r.next,c}}function Yw(a,l,r){const o=this;return c;function c(d){return a.exit("chunkContent"),a.enter("lineEnding"),a.consume(d),a.exit("lineEnding"),Ye(a,f,"linePrefix")}function f(d){if(d===null||he(d))return r(d);const p=o.events[o.events.length-1];return!o.parser.constructs.disable.null.includes("codeIndented")&&p&&p[1].type==="linePrefix"&&p[2].sliceSerialize(p[1],!0).length>=4?l(d):a.interrupt(o.parser.constructs.flow,r,l)(d)}}function bg(a,l,r,o,c,f,d,p,g){const m=g||Number.POSITIVE_INFINITY;let y=0;return v;function v(O){return O===60?(a.enter(o),a.enter(c),a.enter(f),a.consume(O),a.exit(f),x):O===null||O===32||O===41||oc(O)?r(O):(a.enter(o),a.enter(d),a.enter(p),a.enter("chunkString",{contentType:"string"}),L(O))}function x(O){return O===62?(a.enter(f),a.consume(O),a.exit(f),a.exit(c),a.exit(o),l):(a.enter(p),a.enter("chunkString",{contentType:"string"}),S(O))}function S(O){return O===62?(a.exit("chunkString"),a.exit(p),x(O)):O===null||O===60||he(O)?r(O):(a.consume(O),O===92?U:S)}function U(O){return O===60||O===62||O===92?(a.consume(O),S):S(O)}function L(O){return!y&&(O===null||O===41||Dn(O))?(a.exit("chunkString"),a.exit(p),a.exit(d),a.exit(o),l(O)):y<m&&O===40?(a.consume(O),y++,L):O===41?(a.consume(O),y--,L):O===null||O===32||O===40||oc(O)?r(O):(a.consume(O),O===92?B:L)}function B(O){return O===40||O===41||O===92?(a.consume(O),L):L(O)}}function Sg(a,l,r,o,c,f){const d=this;let p=0,g;return m;function m(S){return a.enter(o),a.enter(c),a.consume(S),a.exit(c),a.enter(f),y}function y(S){return p>999||S===null||S===91||S===93&&!g||S===94&&!p&&"_hiddenFootnoteSupport"in d.parser.constructs?r(S):S===93?(a.exit(f),a.enter(c),a.consume(S),a.exit(c),a.exit(o),l):he(S)?(a.enter("lineEnding"),a.consume(S),a.exit("lineEnding"),y):(a.enter("chunkString",{contentType:"string"}),v(S))}function v(S){return S===null||S===91||S===93||he(S)||p++>999?(a.exit("chunkString"),y(S)):(a.consume(S),g||(g=!ze(S)),S===92?x:v)}function x(S){return S===91||S===92||S===93?(a.consume(S),p++,v):v(S)}}function wg(a,l,r,o,c,f){let d;return p;function p(x){return x===34||x===39||x===40?(a.enter(o),a.enter(c),a.consume(x),a.exit(c),d=x===40?41:x,g):r(x)}function g(x){return x===d?(a.enter(c),a.consume(x),a.exit(c),a.exit(o),l):(a.enter(f),m(x))}function m(x){return x===d?(a.exit(f),g(d)):x===null?r(x):he(x)?(a.enter("lineEnding"),a.consume(x),a.exit("lineEnding"),Ye(a,m,"linePrefix")):(a.enter("chunkString",{contentType:"string"}),y(x))}function y(x){return x===d||x===null||he(x)?(a.exit("chunkString"),m(x)):(a.consume(x),x===92?v:y)}function v(x){return x===d||x===92?(a.consume(x),y):y(x)}}function El(a,l){let r;return o;function o(c){return he(c)?(a.enter("lineEnding"),a.consume(c),a.exit("lineEnding"),r=!0,o):ze(c)?Ye(a,o,r?"linePrefix":"lineSuffix")(c):l(c)}}const Gw={name:"definition",tokenize:Vw},Fw={partial:!0,tokenize:Pw};function Vw(a,l,r){const o=this;let c;return f;function f(S){return a.enter("definition"),d(S)}function d(S){return Sg.call(o,a,p,r,"definitionLabel","definitionLabelMarker","definitionLabelString")(S)}function p(S){return c=Si(o.sliceSerialize(o.events[o.events.length-1][1]).slice(1,-1)),S===58?(a.enter("definitionMarker"),a.consume(S),a.exit("definitionMarker"),g):r(S)}function g(S){return Dn(S)?El(a,m)(S):m(S)}function m(S){return bg(a,y,r,"definitionDestination","definitionDestinationLiteral","definitionDestinationLiteralMarker","definitionDestinationRaw","definitionDestinationString")(S)}function y(S){return a.attempt(Fw,v,v)(S)}function v(S){return ze(S)?Ye(a,x,"whitespace")(S):x(S)}function x(S){return S===null||he(S)?(a.exit("definition"),o.parser.defined.push(c),l(S)):r(S)}}function Pw(a,l,r){return o;function o(p){return Dn(p)?El(a,c)(p):r(p)}function c(p){return wg(a,f,r,"definitionTitle","definitionTitleMarker","definitionTitleString")(p)}function f(p){return ze(p)?Ye(a,d,"whitespace")(p):d(p)}function d(p){return p===null||he(p)?l(p):r(p)}}const Xw={name:"hardBreakEscape",tokenize:Qw};function Qw(a,l,r){return o;function o(f){return a.enter("hardBreakEscape"),a.consume(f),c}function c(f){return he(f)?(a.exit("hardBreakEscape"),l(f)):r(f)}}const Ww={name:"headingAtx",resolve:Kw,tokenize:Zw};function Kw(a,l){let r=a.length-2,o=3,c,f;return a[o][1].type==="whitespace"&&(o+=2),r-2>o&&a[r][1].type==="whitespace"&&(r-=2),a[r][1].type==="atxHeadingSequence"&&(o===r-1||r-4>o&&a[r-2][1].type==="whitespace")&&(r-=o+1===r?2:4),r>o&&(c={type:"atxHeadingText",start:a[o][1].start,end:a[r][1].end},f={type:"chunkText",start:a[o][1].start,end:a[r][1].end,contentType:"text"},ft(a,o,r-o+1,[["enter",c,l],["enter",f,l],["exit",f,l],["exit",c,l]])),a}function Zw(a,l,r){let o=0;return c;function c(y){return a.enter("atxHeading"),f(y)}function f(y){return a.enter("atxHeadingSequence"),d(y)}function d(y){return y===35&&o++<6?(a.consume(y),d):y===null||Dn(y)?(a.exit("atxHeadingSequence"),p(y)):r(y)}function p(y){return y===35?(a.enter("atxHeadingSequence"),g(y)):y===null||he(y)?(a.exit("atxHeading"),l(y)):ze(y)?Ye(a,p,"whitespace")(y):(a.enter("atxHeadingText"),m(y))}function g(y){return y===35?(a.consume(y),g):(a.exit("atxHeadingSequence"),p(y))}function m(y){return y===null||y===35||Dn(y)?(a.exit("atxHeadingText"),p(y)):(a.consume(y),m)}}const Jw=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],hp=["pre","script","style","textarea"],$w={concrete:!0,name:"htmlFlow",resolveTo:t0,tokenize:a0},e0={partial:!0,tokenize:l0},n0={partial:!0,tokenize:i0};function t0(a){let l=a.length;for(;l--&&!(a[l][0]==="enter"&&a[l][1].type==="htmlFlow"););return l>1&&a[l-2][1].type==="linePrefix"&&(a[l][1].start=a[l-2][1].start,a[l+1][1].start=a[l-2][1].start,a.splice(l-2,2)),a}function a0(a,l,r){const o=this;let c,f,d,p,g;return m;function m(w){return y(w)}function y(w){return a.enter("htmlFlow"),a.enter("htmlFlowData"),a.consume(w),v}function v(w){return w===33?(a.consume(w),x):w===47?(a.consume(w),f=!0,L):w===63?(a.consume(w),c=3,o.interrupt?l:C):ct(w)?(a.consume(w),d=String.fromCharCode(w),B):r(w)}function x(w){return w===45?(a.consume(w),c=2,S):w===91?(a.consume(w),c=5,p=0,U):ct(w)?(a.consume(w),c=4,o.interrupt?l:C):r(w)}function S(w){return w===45?(a.consume(w),o.interrupt?l:C):r(w)}function U(w){const Z="CDATA[";return w===Z.charCodeAt(p++)?(a.consume(w),p===Z.length?o.interrupt?l:J:U):r(w)}function L(w){return ct(w)?(a.consume(w),d=String.fromCharCode(w),B):r(w)}function B(w){if(w===null||w===47||w===62||Dn(w)){const Z=w===47,ue=d.toLowerCase();return!Z&&!f&&hp.includes(ue)?(c=1,o.interrupt?l(w):J(w)):Jw.includes(d.toLowerCase())?(c=6,Z?(a.consume(w),O):o.interrupt?l(w):J(w)):(c=7,o.interrupt&&!o.parser.lazy[o.now().line]?r(w):f?V(w):F(w))}return w===45||In(w)?(a.consume(w),d+=String.fromCharCode(w),B):r(w)}function O(w){return w===62?(a.consume(w),o.interrupt?l:J):r(w)}function V(w){return ze(w)?(a.consume(w),V):ge(w)}function F(w){return w===47?(a.consume(w),ge):w===58||w===95||ct(w)?(a.consume(w),re):ze(w)?(a.consume(w),F):ge(w)}function re(w){return w===45||w===46||w===58||w===95||In(w)?(a.consume(w),re):oe(w)}function oe(w){return w===61?(a.consume(w),H):ze(w)?(a.consume(w),oe):F(w)}function H(w){return w===null||w===60||w===61||w===62||w===96?r(w):w===34||w===39?(a.consume(w),g=w,K):ze(w)?(a.consume(w),H):ce(w)}function K(w){return w===g?(a.consume(w),g=null,fe):w===null||he(w)?r(w):(a.consume(w),K)}function ce(w){return w===null||w===34||w===39||w===47||w===60||w===61||w===62||w===96||Dn(w)?oe(w):(a.consume(w),ce)}function fe(w){return w===47||w===62||ze(w)?F(w):r(w)}function ge(w){return w===62?(a.consume(w),ee):r(w)}function ee(w){return w===null||he(w)?J(w):ze(w)?(a.consume(w),ee):r(w)}function J(w){return w===45&&c===2?(a.consume(w),z):w===60&&c===1?(a.consume(w),P):w===62&&c===4?(a.consume(w),T):w===63&&c===3?(a.consume(w),C):w===93&&c===5?(a.consume(w),be):he(w)&&(c===6||c===7)?(a.exit("htmlFlowData"),a.check(e0,I,Ae)(w)):w===null||he(w)?(a.exit("htmlFlowData"),Ae(w)):(a.consume(w),J)}function Ae(w){return a.check(n0,ae,I)(w)}function ae(w){return a.enter("lineEnding"),a.consume(w),a.exit("lineEnding"),Q}function Q(w){return w===null||he(w)?Ae(w):(a.enter("htmlFlowData"),J(w))}function z(w){return w===45?(a.consume(w),C):J(w)}function P(w){return w===47?(a.consume(w),d="",te):J(w)}function te(w){if(w===62){const Z=d.toLowerCase();return hp.includes(Z)?(a.consume(w),T):J(w)}return ct(w)&&d.length<8?(a.consume(w),d+=String.fromCharCode(w),te):J(w)}function be(w){return w===93?(a.consume(w),C):J(w)}function C(w){return w===62?(a.consume(w),T):w===45&&c===2?(a.consume(w),C):J(w)}function T(w){return w===null||he(w)?(a.exit("htmlFlowData"),I(w)):(a.consume(w),T)}function I(w){return a.exit("htmlFlow"),l(w)}}function i0(a,l,r){const o=this;return c;function c(d){return he(d)?(a.enter("lineEnding"),a.consume(d),a.exit("lineEnding"),f):r(d)}function f(d){return o.parser.lazy[o.now().line]?r(d):l(d)}}function l0(a,l,r){return o;function o(c){return a.enter("lineEnding"),a.consume(c),a.exit("lineEnding"),a.attempt(ho,l,r)}}const r0={name:"htmlText",tokenize:o0};function o0(a,l,r){const o=this;let c,f,d;return p;function p(C){return a.enter("htmlText"),a.enter("htmlTextData"),a.consume(C),g}function g(C){return C===33?(a.consume(C),m):C===47?(a.consume(C),oe):C===63?(a.consume(C),F):ct(C)?(a.consume(C),ce):r(C)}function m(C){return C===45?(a.consume(C),y):C===91?(a.consume(C),f=0,U):ct(C)?(a.consume(C),V):r(C)}function y(C){return C===45?(a.consume(C),S):r(C)}function v(C){return C===null?r(C):C===45?(a.consume(C),x):he(C)?(d=v,P(C)):(a.consume(C),v)}function x(C){return C===45?(a.consume(C),S):v(C)}function S(C){return C===62?z(C):C===45?x(C):v(C)}function U(C){const T="CDATA[";return C===T.charCodeAt(f++)?(a.consume(C),f===T.length?L:U):r(C)}function L(C){return C===null?r(C):C===93?(a.consume(C),B):he(C)?(d=L,P(C)):(a.consume(C),L)}function B(C){return C===93?(a.consume(C),O):L(C)}function O(C){return C===62?z(C):C===93?(a.consume(C),O):L(C)}function V(C){return C===null||C===62?z(C):he(C)?(d=V,P(C)):(a.consume(C),V)}function F(C){return C===null?r(C):C===63?(a.consume(C),re):he(C)?(d=F,P(C)):(a.consume(C),F)}function re(C){return C===62?z(C):F(C)}function oe(C){return ct(C)?(a.consume(C),H):r(C)}function H(C){return C===45||In(C)?(a.consume(C),H):K(C)}function K(C){return he(C)?(d=K,P(C)):ze(C)?(a.consume(C),K):z(C)}function ce(C){return C===45||In(C)?(a.consume(C),ce):C===47||C===62||Dn(C)?fe(C):r(C)}function fe(C){return C===47?(a.consume(C),z):C===58||C===95||ct(C)?(a.consume(C),ge):he(C)?(d=fe,P(C)):ze(C)?(a.consume(C),fe):z(C)}function ge(C){return C===45||C===46||C===58||C===95||In(C)?(a.consume(C),ge):ee(C)}function ee(C){return C===61?(a.consume(C),J):he(C)?(d=ee,P(C)):ze(C)?(a.consume(C),ee):fe(C)}function J(C){return C===null||C===60||C===61||C===62||C===96?r(C):C===34||C===39?(a.consume(C),c=C,Ae):he(C)?(d=J,P(C)):ze(C)?(a.consume(C),J):(a.consume(C),ae)}function Ae(C){return C===c?(a.consume(C),c=void 0,Q):C===null?r(C):he(C)?(d=Ae,P(C)):(a.consume(C),Ae)}function ae(C){return C===null||C===34||C===39||C===60||C===61||C===96?r(C):C===47||C===62||Dn(C)?fe(C):(a.consume(C),ae)}function Q(C){return C===47||C===62||Dn(C)?fe(C):r(C)}function z(C){return C===62?(a.consume(C),a.exit("htmlTextData"),a.exit("htmlText"),l):r(C)}function P(C){return a.exit("htmlTextData"),a.enter("lineEnding"),a.consume(C),a.exit("lineEnding"),te}function te(C){return ze(C)?Ye(a,be,"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(C):be(C)}function be(C){return a.enter("htmlTextData"),d(C)}}const Rc={name:"labelEnd",resolveAll:f0,resolveTo:d0,tokenize:h0},s0={tokenize:m0},u0={tokenize:p0},c0={tokenize:g0};function f0(a){let l=-1;const r=[];for(;++l<a.length;){const o=a[l][1];if(r.push(a[l]),o.type==="labelImage"||o.type==="labelLink"||o.type==="labelEnd"){const c=o.type==="labelImage"?4:2;o.type="data",l+=c}}return a.length!==r.length&&ft(a,0,a.length,r),a}function d0(a,l){let r=a.length,o=0,c,f,d,p;for(;r--;)if(c=a[r][1],f){if(c.type==="link"||c.type==="labelLink"&&c._inactive)break;a[r][0]==="enter"&&c.type==="labelLink"&&(c._inactive=!0)}else if(d){if(a[r][0]==="enter"&&(c.type==="labelImage"||c.type==="labelLink")&&!c._balanced&&(f=r,c.type!=="labelLink")){o=2;break}}else c.type==="labelEnd"&&(d=r);const g={type:a[f][1].type==="labelLink"?"link":"image",start:{...a[f][1].start},end:{...a[a.length-1][1].end}},m={type:"label",start:{...a[f][1].start},end:{...a[d][1].end}},y={type:"labelText",start:{...a[f+o+2][1].end},end:{...a[d-2][1].start}};return p=[["enter",g,l],["enter",m,l]],p=$n(p,a.slice(f+1,f+o+3)),p=$n(p,[["enter",y,l]]),p=$n(p,_c(l.parser.constructs.insideSpan.null,a.slice(f+o+4,d-3),l)),p=$n(p,[["exit",y,l],a[d-2],a[d-1],["exit",m,l]]),p=$n(p,a.slice(d+1)),p=$n(p,[["exit",g,l]]),ft(a,f,a.length,p),a}function h0(a,l,r){const o=this;let c=o.events.length,f,d;for(;c--;)if((o.events[c][1].type==="labelImage"||o.events[c][1].type==="labelLink")&&!o.events[c][1]._balanced){f=o.events[c][1];break}return p;function p(x){return f?f._inactive?v(x):(d=o.parser.defined.includes(Si(o.sliceSerialize({start:f.end,end:o.now()}))),a.enter("labelEnd"),a.enter("labelMarker"),a.consume(x),a.exit("labelMarker"),a.exit("labelEnd"),g):r(x)}function g(x){return x===40?a.attempt(s0,y,d?y:v)(x):x===91?a.attempt(u0,y,d?m:v)(x):d?y(x):v(x)}function m(x){return a.attempt(c0,y,v)(x)}function y(x){return l(x)}function v(x){return f._balanced=!0,r(x)}}function m0(a,l,r){return o;function o(v){return a.enter("resource"),a.enter("resourceMarker"),a.consume(v),a.exit("resourceMarker"),c}function c(v){return Dn(v)?El(a,f)(v):f(v)}function f(v){return v===41?y(v):bg(a,d,p,"resourceDestination","resourceDestinationLiteral","resourceDestinationLiteralMarker","resourceDestinationRaw","resourceDestinationString",32)(v)}function d(v){return Dn(v)?El(a,g)(v):y(v)}function p(v){return r(v)}function g(v){return v===34||v===39||v===40?wg(a,m,r,"resourceTitle","resourceTitleMarker","resourceTitleString")(v):y(v)}function m(v){return Dn(v)?El(a,y)(v):y(v)}function y(v){return v===41?(a.enter("resourceMarker"),a.consume(v),a.exit("resourceMarker"),a.exit("resource"),l):r(v)}}function p0(a,l,r){const o=this;return c;function c(p){return Sg.call(o,a,f,d,"reference","referenceMarker","referenceString")(p)}function f(p){return o.parser.defined.includes(Si(o.sliceSerialize(o.events[o.events.length-1][1]).slice(1,-1)))?l(p):r(p)}function d(p){return r(p)}}function g0(a,l,r){return o;function o(f){return a.enter("reference"),a.enter("referenceMarker"),a.consume(f),a.exit("referenceMarker"),c}function c(f){return f===93?(a.enter("referenceMarker"),a.consume(f),a.exit("referenceMarker"),a.exit("reference"),l):r(f)}}const y0={name:"labelStartImage",resolveAll:Rc.resolveAll,tokenize:v0};function v0(a,l,r){const o=this;return c;function c(p){return a.enter("labelImage"),a.enter("labelImageMarker"),a.consume(p),a.exit("labelImageMarker"),f}function f(p){return p===91?(a.enter("labelMarker"),a.consume(p),a.exit("labelMarker"),a.exit("labelImage"),d):r(p)}function d(p){return p===94&&"_hiddenFootnoteSupport"in o.parser.constructs?r(p):l(p)}}const b0={name:"labelStartLink",resolveAll:Rc.resolveAll,tokenize:S0};function S0(a,l,r){const o=this;return c;function c(d){return a.enter("labelLink"),a.enter("labelMarker"),a.consume(d),a.exit("labelMarker"),a.exit("labelLink"),f}function f(d){return d===94&&"_hiddenFootnoteSupport"in o.parser.constructs?r(d):l(d)}}const Vu={name:"lineEnding",tokenize:w0};function w0(a,l){return r;function r(o){return a.enter("lineEnding"),a.consume(o),a.exit("lineEnding"),Ye(a,l,"linePrefix")}}const lo={name:"thematicBreak",tokenize:x0};function x0(a,l,r){let o=0,c;return f;function f(m){return a.enter("thematicBreak"),d(m)}function d(m){return c=m,p(m)}function p(m){return m===c?(a.enter("thematicBreakSequence"),g(m)):o>=3&&(m===null||he(m))?(a.exit("thematicBreak"),l(m)):r(m)}function g(m){return m===c?(a.consume(m),o++,g):(a.exit("thematicBreakSequence"),ze(m)?Ye(a,p,"whitespace")(m):p(m))}}const An={continuation:{tokenize:E0},exit:D0,name:"list",tokenize:T0},C0={partial:!0,tokenize:_0},k0={partial:!0,tokenize:A0};function T0(a,l,r){const o=this,c=o.events[o.events.length-1];let f=c&&c[1].type==="linePrefix"?c[2].sliceSerialize(c[1],!0).length:0,d=0;return p;function p(S){const U=o.containerState.type||(S===42||S===43||S===45?"listUnordered":"listOrdered");if(U==="listUnordered"?!o.containerState.marker||S===o.containerState.marker:sc(S)){if(o.containerState.type||(o.containerState.type=U,a.enter(U,{_container:!0})),U==="listUnordered")return a.enter("listItemPrefix"),S===42||S===45?a.check(lo,r,m)(S):m(S);if(!o.interrupt||S===49)return a.enter("listItemPrefix"),a.enter("listItemValue"),g(S)}return r(S)}function g(S){return sc(S)&&++d<10?(a.consume(S),g):(!o.interrupt||d<2)&&(o.containerState.marker?S===o.containerState.marker:S===41||S===46)?(a.exit("listItemValue"),m(S)):r(S)}function m(S){return a.enter("listItemMarker"),a.consume(S),a.exit("listItemMarker"),o.containerState.marker=o.containerState.marker||S,a.check(ho,o.interrupt?r:y,a.attempt(C0,x,v))}function y(S){return o.containerState.initialBlankLine=!0,f++,x(S)}function v(S){return ze(S)?(a.enter("listItemPrefixWhitespace"),a.consume(S),a.exit("listItemPrefixWhitespace"),x):r(S)}function x(S){return o.containerState.size=f+o.sliceSerialize(a.exit("listItemPrefix"),!0).length,l(S)}}function E0(a,l,r){const o=this;return o.containerState._closeFlow=void 0,a.check(ho,c,f);function c(p){return o.containerState.furtherBlankLines=o.containerState.furtherBlankLines||o.containerState.initialBlankLine,Ye(a,l,"listItemIndent",o.containerState.size+1)(p)}function f(p){return o.containerState.furtherBlankLines||!ze(p)?(o.containerState.furtherBlankLines=void 0,o.containerState.initialBlankLine=void 0,d(p)):(o.containerState.furtherBlankLines=void 0,o.containerState.initialBlankLine=void 0,a.attempt(k0,l,d)(p))}function d(p){return o.containerState._closeFlow=!0,o.interrupt=void 0,Ye(a,a.attempt(An,l,r),"linePrefix",o.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(p)}}function A0(a,l,r){const o=this;return Ye(a,c,"listItemIndent",o.containerState.size+1);function c(f){const d=o.events[o.events.length-1];return d&&d[1].type==="listItemIndent"&&d[2].sliceSerialize(d[1],!0).length===o.containerState.size?l(f):r(f)}}function D0(a){a.exit(this.containerState.type)}function _0(a,l,r){const o=this;return Ye(a,c,"listItemPrefixWhitespace",o.parser.constructs.disable.null.includes("codeIndented")?void 0:5);function c(f){const d=o.events[o.events.length-1];return!ze(f)&&d&&d[1].type==="listItemPrefixWhitespace"?l(f):r(f)}}const mp={name:"setextUnderline",resolveTo:R0,tokenize:z0};function R0(a,l){let r=a.length,o,c,f;for(;r--;)if(a[r][0]==="enter"){if(a[r][1].type==="content"){o=r;break}a[r][1].type==="paragraph"&&(c=r)}else a[r][1].type==="content"&&a.splice(r,1),!f&&a[r][1].type==="definition"&&(f=r);const d={type:"setextHeading",start:{...a[o][1].start},end:{...a[a.length-1][1].end}};return a[c][1].type="setextHeadingText",f?(a.splice(c,0,["enter",d,l]),a.splice(f+1,0,["exit",a[o][1],l]),a[o][1].end={...a[f][1].end}):a[o][1]=d,a.push(["exit",d,l]),a}function z0(a,l,r){const o=this;let c;return f;function f(m){let y=o.events.length,v;for(;y--;)if(o.events[y][1].type!=="lineEnding"&&o.events[y][1].type!=="linePrefix"&&o.events[y][1].type!=="content"){v=o.events[y][1].type==="paragraph";break}return!o.parser.lazy[o.now().line]&&(o.interrupt||v)?(a.enter("setextHeadingLine"),c=m,d(m)):r(m)}function d(m){return a.enter("setextHeadingLineSequence"),p(m)}function p(m){return m===c?(a.consume(m),p):(a.exit("setextHeadingLineSequence"),ze(m)?Ye(a,g,"lineSuffix")(m):g(m))}function g(m){return m===null||he(m)?(a.exit("setextHeadingLine"),l(m)):r(m)}}const O0={tokenize:M0};function M0(a){const l=this,r=a.attempt(ho,o,a.attempt(this.parser.constructs.flowInitial,c,Ye(a,a.attempt(this.parser.constructs.flow,c,a.attempt(Hw,c)),"linePrefix")));return r;function o(f){if(f===null){a.consume(f);return}return a.enter("lineEndingBlank"),a.consume(f),a.exit("lineEndingBlank"),l.currentConstruct=void 0,r}function c(f){if(f===null){a.consume(f);return}return a.enter("lineEnding"),a.consume(f),a.exit("lineEnding"),l.currentConstruct=void 0,r}}const L0={resolveAll:Cg()},N0=xg("string"),U0=xg("text");function xg(a){return{resolveAll:Cg(a==="text"?B0:void 0),tokenize:l};function l(r){const o=this,c=this.parser.constructs[a],f=r.attempt(c,d,p);return d;function d(y){return m(y)?f(y):p(y)}function p(y){if(y===null){r.consume(y);return}return r.enter("data"),r.consume(y),g}function g(y){return m(y)?(r.exit("data"),f(y)):(r.consume(y),g)}function m(y){if(y===null)return!0;const v=c[y];let x=-1;if(v)for(;++x<v.length;){const S=v[x];if(!S.previous||S.previous.call(o,o.previous))return!0}return!1}}}function Cg(a){return l;function l(r,o){let c=-1,f;for(;++c<=r.length;)f===void 0?r[c]&&r[c][1].type==="data"&&(f=c,c++):(!r[c]||r[c][1].type!=="data")&&(c!==f+2&&(r[f][1].end=r[c-1][1].end,r.splice(f+2,c-f-2),c=f+2),f=void 0);return a?a(r,o):r}}function B0(a,l){let r=0;for(;++r<=a.length;)if((r===a.length||a[r][1].type==="lineEnding")&&a[r-1][1].type==="data"){const o=a[r-1][1],c=l.sliceStream(o);let f=c.length,d=-1,p=0,g;for(;f--;){const m=c[f];if(typeof m=="string"){for(d=m.length;m.charCodeAt(d-1)===32;)p++,d--;if(d)break;d=-1}else if(m===-2)g=!0,p++;else if(m!==-1){f++;break}}if(l._contentTypeTextTrailing&&r===a.length&&(p=0),p){const m={type:r===a.length||g||p<2?"lineSuffix":"hardBreakTrailing",start:{_bufferIndex:f?d:o.start._bufferIndex+d,_index:o.start._index+f,line:o.end.line,column:o.end.column-p,offset:o.end.offset-p},end:{...o.end}};o.end={...m.start},o.start.offset===o.end.offset?Object.assign(o,m):(a.splice(r,0,["enter",m,l],["exit",m,l]),r+=2)}r++}return a}const H0={42:An,43:An,45:An,48:An,49:An,50:An,51:An,52:An,53:An,54:An,55:An,56:An,57:An,62:pg},I0={91:Gw},j0={[-2]:Fu,[-1]:Fu,32:Fu},q0={35:Ww,42:lo,45:[mp,lo],60:$w,61:mp,95:lo,96:dp,126:dp},Y0={38:yg,92:gg},G0={[-5]:Vu,[-4]:Vu,[-3]:Vu,33:y0,38:yg,42:uc,60:[bw,r0],91:b0,92:[Xw,gg],93:Rc,95:uc,96:Ow},F0={null:[uc,L0]},V0={null:[42,95]},P0={null:[]},X0=Object.freeze(Object.defineProperty({__proto__:null,attentionMarkers:V0,contentInitial:I0,disable:P0,document:H0,flow:q0,flowInitial:j0,insideSpan:F0,string:Y0,text:G0},Symbol.toStringTag,{value:"Module"}));function Q0(a,l,r){let o={_bufferIndex:-1,_index:0,line:r&&r.line||1,column:r&&r.column||1,offset:r&&r.offset||0};const c={},f=[];let d=[],p=[];const g={attempt:K(oe),check:K(H),consume:V,enter:F,exit:re,interrupt:K(H,{interrupt:!0})},m={code:null,containerState:{},defineSkip:L,events:[],now:U,parser:a,previous:null,sliceSerialize:x,sliceStream:S,write:v};let y=l.tokenize.call(m,g);return l.resolveAll&&f.push(l),m;function v(ee){return d=$n(d,ee),B(),d[d.length-1]!==null?[]:(ce(l,0),m.events=_c(f,m.events,m),m.events)}function x(ee,J){return K0(S(ee),J)}function S(ee){return W0(d,ee)}function U(){const{_bufferIndex:ee,_index:J,line:Ae,column:ae,offset:Q}=o;return{_bufferIndex:ee,_index:J,line:Ae,column:ae,offset:Q}}function L(ee){c[ee.line]=ee.column,ge()}function B(){let ee;for(;o._index<d.length;){const J=d[o._index];if(typeof J=="string")for(ee=o._index,o._bufferIndex<0&&(o._bufferIndex=0);o._index===ee&&o._bufferIndex<J.length;)O(J.charCodeAt(o._bufferIndex));else O(J)}}function O(ee){y=y(ee)}function V(ee){he(ee)?(o.line++,o.column=1,o.offset+=ee===-3?2:1,ge()):ee!==-1&&(o.column++,o.offset++),o._bufferIndex<0?o._index++:(o._bufferIndex++,o._bufferIndex===d[o._index].length&&(o._bufferIndex=-1,o._index++)),m.previous=ee}function F(ee,J){const Ae=J||{};return Ae.type=ee,Ae.start=U(),m.events.push(["enter",Ae,m]),p.push(Ae),Ae}function re(ee){const J=p.pop();return J.end=U(),m.events.push(["exit",J,m]),J}function oe(ee,J){ce(ee,J.from)}function H(ee,J){J.restore()}function K(ee,J){return Ae;function Ae(ae,Q,z){let P,te,be,C;return Array.isArray(ae)?I(ae):"tokenize"in ae?I([ae]):T(ae);function T(ie){return Ce;function Ce(Ve){const Ne=Ve!==null&&ie[Ve],Yn=Ve!==null&&ie.null,dt=[...Array.isArray(Ne)?Ne:Ne?[Ne]:[],...Array.isArray(Yn)?Yn:Yn?[Yn]:[]];return I(dt)(Ve)}}function I(ie){return P=ie,te=0,ie.length===0?z:w(ie[te])}function w(ie){return Ce;function Ce(Ve){return C=fe(),be=ie,ie.partial||(m.currentConstruct=ie),ie.name&&m.parser.constructs.disable.null.includes(ie.name)?ue():ie.tokenize.call(J?Object.assign(Object.create(m),J):m,g,Z,ue)(Ve)}}function Z(ie){return ee(be,C),Q}function ue(ie){return C.restore(),++te<P.length?w(P[te]):z}}}function ce(ee,J){ee.resolveAll&&!f.includes(ee)&&f.push(ee),ee.resolve&&ft(m.events,J,m.events.length-J,ee.resolve(m.events.slice(J),m)),ee.resolveTo&&(m.events=ee.resolveTo(m.events,m))}function fe(){const ee=U(),J=m.previous,Ae=m.currentConstruct,ae=m.events.length,Q=Array.from(p);return{from:ae,restore:z};function z(){o=ee,m.previous=J,m.currentConstruct=Ae,m.events.length=ae,p=Q,ge()}}function ge(){o.line in c&&o.column<2&&(o.column=c[o.line],o.offset+=c[o.line]-1)}}function W0(a,l){const r=l.start._index,o=l.start._bufferIndex,c=l.end._index,f=l.end._bufferIndex;let d;if(r===c)d=[a[r].slice(o,f)];else{if(d=a.slice(r,c),o>-1){const p=d[0];typeof p=="string"?d[0]=p.slice(o):d.shift()}f>0&&d.push(a[c].slice(0,f))}return d}function K0(a,l){let r=-1;const o=[];let c;for(;++r<a.length;){const f=a[r];let d;if(typeof f=="string")d=f;else switch(f){case-5:{d="\r";break}case-4:{d=`
`;break}case-3:{d=`\r
`;break}case-2:{d=l?" ":"	";break}case-1:{if(!l&&c)continue;d=" ";break}default:d=String.fromCharCode(f)}c=f===-2,o.push(d)}return o.join("")}function Z0(a){const o={constructs:iw([X0,...(a||{}).extensions||[]]),content:c(dw),defined:[],document:c(mw),flow:c(O0),lazy:{},string:c(N0),text:c(U0)};return o;function c(f){return d;function d(p){return Q0(o,f,p)}}}function J0(a){for(;!vg(a););return a}const pp=/[\0\t\n\r]/g;function $0(){let a=1,l="",r=!0,o;return c;function c(f,d,p){const g=[];let m,y,v,x,S;for(f=l+(typeof f=="string"?f.toString():new TextDecoder(d||void 0).decode(f)),v=0,l="",r&&(f.charCodeAt(0)===65279&&v++,r=void 0);v<f.length;){if(pp.lastIndex=v,m=pp.exec(f),x=m&&m.index!==void 0?m.index:f.length,S=f.charCodeAt(x),!m){l=f.slice(v);break}if(S===10&&v===x&&o)g.push(-3),o=void 0;else switch(o&&(g.push(-5),o=void 0),v<x&&(g.push(f.slice(v,x)),a+=x-v),S){case 0:{g.push(65533),a++;break}case 9:{for(y=Math.ceil(a/4)*4,g.push(-2);a++<y;)g.push(-1);break}case 10:{g.push(-4),a=1;break}default:o=!0,a=1}v=x+1}return p&&(o&&g.push(-5),l&&g.push(l),g.push(null)),g}}const ex=/\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;function nx(a){return a.replace(ex,tx)}function tx(a,l,r){if(l)return l;if(r.charCodeAt(0)===35){const c=r.charCodeAt(1),f=c===120||c===88;return mg(r.slice(f?2:1),f?16:10)}return Dc(r)||a}const kg={}.hasOwnProperty;function ax(a,l,r){return typeof l!="string"&&(r=l,l=void 0),ix(r)(J0(Z0(r).document().write($0()(a,l,!0))))}function ix(a){const l={transforms:[],canContainEols:["emphasis","fragment","heading","paragraph","strong"],enter:{autolink:f(za),autolinkProtocol:fe,autolinkEmail:fe,atxHeading:f(_a),blockQuote:f(Yn),characterEscape:fe,characterReference:fe,codeFenced:f(dt),codeFencedFenceInfo:d,codeFencedFenceMeta:d,codeIndented:f(dt,d),codeText:f(Ti,d),codeTextData:fe,data:fe,codeFlowValue:fe,definition:f(Ll),definitionDestinationString:d,definitionLabelString:d,definitionTitleString:d,emphasis:f(ht),hardBreakEscape:f(Ra),hardBreakTrailing:f(Ra),htmlFlow:f(Nl,d),htmlFlowData:fe,htmlText:f(Nl,d),htmlTextData:fe,image:f(Ul),label:d,link:f(za),listItem:f(Ei),listItemValue:x,listOrdered:f(Oa,v),listUnordered:f(Oa),paragraph:f(go),reference:w,referenceString:d,resourceDestinationString:d,resourceTitleString:d,setextHeading:f(_a),strong:f(yo),thematicBreak:f(vo)},exit:{atxHeading:g(),atxHeadingSequence:oe,autolink:g(),autolinkEmail:Ne,autolinkProtocol:Ve,blockQuote:g(),characterEscapeValue:ge,characterReferenceMarkerHexadecimal:ue,characterReferenceMarkerNumeric:ue,characterReferenceValue:ie,characterReference:Ce,codeFenced:g(B),codeFencedFence:L,codeFencedFenceInfo:S,codeFencedFenceMeta:U,codeFlowValue:ge,codeIndented:g(O),codeText:g(Q),codeTextData:ge,data:ge,definition:g(),definitionDestinationString:re,definitionLabelString:V,definitionTitleString:F,emphasis:g(),hardBreakEscape:g(J),hardBreakTrailing:g(J),htmlFlow:g(Ae),htmlFlowData:ge,htmlText:g(ae),htmlTextData:ge,image:g(P),label:be,labelText:te,lineEnding:ee,link:g(z),listItem:g(),listOrdered:g(),listUnordered:g(),paragraph:g(),referenceString:Z,resourceDestinationString:C,resourceTitleString:T,resource:I,setextHeading:g(ce),setextHeadingLineSequence:K,setextHeadingText:H,strong:g(),thematicBreak:g()}};Tg(l,(a||{}).mdastExtensions||[]);const r={};return o;function o(j){let W={type:"root",children:[]};const de={stack:[W],tokenStack:[],config:l,enter:p,exit:m,buffer:d,resume:y,data:r},Se=[];let Oe=-1;for(;++Oe<j.length;)if(j[Oe][1].type==="listOrdered"||j[Oe][1].type==="listUnordered")if(j[Oe][0]==="enter")Se.push(Oe);else{const Rn=Se.pop();Oe=c(j,Rn,Oe)}for(Oe=-1;++Oe<j.length;){const Rn=l[j[Oe][0]];kg.call(Rn,j[Oe][1].type)&&Rn[j[Oe][1].type].call(Object.assign({sliceSerialize:j[Oe][2].sliceSerialize},de),j[Oe][1])}if(de.tokenStack.length>0){const Rn=de.tokenStack[de.tokenStack.length-1];(Rn[1]||gp).call(de,void 0,Rn[0])}for(W.position={start:ra(j.length>0?j[0][1].start:{line:1,column:1,offset:0}),end:ra(j.length>0?j[j.length-2][1].end:{line:1,column:1,offset:0})},Oe=-1;++Oe<l.transforms.length;)W=l.transforms[Oe](W)||W;return W}function c(j,W,de){let Se=W-1,Oe=-1,Rn=!1,mt,yn,an,bn;for(;++Se<=de;){const Ie=j[Se];switch(Ie[1].type){case"listUnordered":case"listOrdered":case"blockQuote":{Ie[0]==="enter"?Oe++:Oe--,bn=void 0;break}case"lineEndingBlank":{Ie[0]==="enter"&&(mt&&!bn&&!Oe&&!an&&(an=Se),bn=void 0);break}case"linePrefix":case"listItemValue":case"listItemMarker":case"listItemPrefix":case"listItemPrefixWhitespace":break;default:bn=void 0}if(!Oe&&Ie[0]==="enter"&&Ie[1].type==="listItemPrefix"||Oe===-1&&Ie[0]==="exit"&&(Ie[1].type==="listUnordered"||Ie[1].type==="listOrdered")){if(mt){let Nt=Se;for(yn=void 0;Nt--;){const et=j[Nt];if(et[1].type==="lineEnding"||et[1].type==="lineEndingBlank"){if(et[0]==="exit")continue;yn&&(j[yn][1].type="lineEndingBlank",Rn=!0),et[1].type="lineEnding",yn=Nt}else if(!(et[1].type==="linePrefix"||et[1].type==="blockQuotePrefix"||et[1].type==="blockQuotePrefixWhitespace"||et[1].type==="blockQuoteMarker"||et[1].type==="listItemIndent"))break}an&&(!yn||an<yn)&&(mt._spread=!0),mt.end=Object.assign({},yn?j[yn][1].start:Ie[1].end),j.splice(yn||Se,0,["exit",mt,Ie[2]]),Se++,de++}if(Ie[1].type==="listItemPrefix"){const Nt={type:"listItem",_spread:!1,start:Object.assign({},Ie[1].start),end:void 0};mt=Nt,j.splice(Se,0,["enter",Nt,Ie[2]]),Se++,de++,an=void 0,bn=!0}}}return j[W][1]._spread=Rn,de}function f(j,W){return de;function de(Se){p.call(this,j(Se),Se),W&&W.call(this,Se)}}function d(){this.stack.push({type:"fragment",children:[]})}function p(j,W,de){this.stack[this.stack.length-1].children.push(j),this.stack.push(j),this.tokenStack.push([W,de||void 0]),j.position={start:ra(W.start),end:void 0}}function g(j){return W;function W(de){j&&j.call(this,de),m.call(this,de)}}function m(j,W){const de=this.stack.pop(),Se=this.tokenStack.pop();if(Se)Se[0].type!==j.type&&(W?W.call(this,j,Se[0]):(Se[1]||gp).call(this,j,Se[0]));else throw new Error("Cannot close `"+j.type+"` ("+Tl({start:j.start,end:j.end})+"): it’s not open");de.position.end=ra(j.end)}function y(){return tw(this.stack.pop())}function v(){this.data.expectingFirstListItemValue=!0}function x(j){if(this.data.expectingFirstListItemValue){const W=this.stack[this.stack.length-2];W.start=Number.parseInt(this.sliceSerialize(j),10),this.data.expectingFirstListItemValue=void 0}}function S(){const j=this.resume(),W=this.stack[this.stack.length-1];W.lang=j}function U(){const j=this.resume(),W=this.stack[this.stack.length-1];W.meta=j}function L(){this.data.flowCodeInside||(this.buffer(),this.data.flowCodeInside=!0)}function B(){const j=this.resume(),W=this.stack[this.stack.length-1];W.value=j.replace(/^(\r?\n|\r)|(\r?\n|\r)$/g,""),this.data.flowCodeInside=void 0}function O(){const j=this.resume(),W=this.stack[this.stack.length-1];W.value=j.replace(/(\r?\n|\r)$/g,"")}function V(j){const W=this.resume(),de=this.stack[this.stack.length-1];de.label=W,de.identifier=Si(this.sliceSerialize(j)).toLowerCase()}function F(){const j=this.resume(),W=this.stack[this.stack.length-1];W.title=j}function re(){const j=this.resume(),W=this.stack[this.stack.length-1];W.url=j}function oe(j){const W=this.stack[this.stack.length-1];if(!W.depth){const de=this.sliceSerialize(j).length;W.depth=de}}function H(){this.data.setextHeadingSlurpLineEnding=!0}function K(j){const W=this.stack[this.stack.length-1];W.depth=this.sliceSerialize(j).codePointAt(0)===61?1:2}function ce(){this.data.setextHeadingSlurpLineEnding=void 0}function fe(j){const de=this.stack[this.stack.length-1].children;let Se=de[de.length-1];(!Se||Se.type!=="text")&&(Se=gn(),Se.position={start:ra(j.start),end:void 0},de.push(Se)),this.stack.push(Se)}function ge(j){const W=this.stack.pop();W.value+=this.sliceSerialize(j),W.position.end=ra(j.end)}function ee(j){const W=this.stack[this.stack.length-1];if(this.data.atHardBreak){const de=W.children[W.children.length-1];de.position.end=ra(j.end),this.data.atHardBreak=void 0;return}!this.data.setextHeadingSlurpLineEnding&&l.canContainEols.includes(W.type)&&(fe.call(this,j),ge.call(this,j))}function J(){this.data.atHardBreak=!0}function Ae(){const j=this.resume(),W=this.stack[this.stack.length-1];W.value=j}function ae(){const j=this.resume(),W=this.stack[this.stack.length-1];W.value=j}function Q(){const j=this.resume(),W=this.stack[this.stack.length-1];W.value=j}function z(){const j=this.stack[this.stack.length-1];if(this.data.inReference){const W=this.data.referenceType||"shortcut";j.type+="Reference",j.referenceType=W,delete j.url,delete j.title}else delete j.identifier,delete j.label;this.data.referenceType=void 0}function P(){const j=this.stack[this.stack.length-1];if(this.data.inReference){const W=this.data.referenceType||"shortcut";j.type+="Reference",j.referenceType=W,delete j.url,delete j.title}else delete j.identifier,delete j.label;this.data.referenceType=void 0}function te(j){const W=this.sliceSerialize(j),de=this.stack[this.stack.length-2];de.label=nx(W),de.identifier=Si(W).toLowerCase()}function be(){const j=this.stack[this.stack.length-1],W=this.resume(),de=this.stack[this.stack.length-1];if(this.data.inReference=!0,de.type==="link"){const Se=j.children;de.children=Se}else de.alt=W}function C(){const j=this.resume(),W=this.stack[this.stack.length-1];W.url=j}function T(){const j=this.resume(),W=this.stack[this.stack.length-1];W.title=j}function I(){this.data.inReference=void 0}function w(){this.data.referenceType="collapsed"}function Z(j){const W=this.resume(),de=this.stack[this.stack.length-1];de.label=W,de.identifier=Si(this.sliceSerialize(j)).toLowerCase(),this.data.referenceType="full"}function ue(j){this.data.characterReferenceType=j.type}function ie(j){const W=this.sliceSerialize(j),de=this.data.characterReferenceType;let Se;de?(Se=mg(W,de==="characterReferenceMarkerNumeric"?10:16),this.data.characterReferenceType=void 0):Se=Dc(W);const Oe=this.stack[this.stack.length-1];Oe.value+=Se}function Ce(j){const W=this.stack.pop();W.position.end=ra(j.end)}function Ve(j){ge.call(this,j);const W=this.stack[this.stack.length-1];W.url=this.sliceSerialize(j)}function Ne(j){ge.call(this,j);const W=this.stack[this.stack.length-1];W.url="mailto:"+this.sliceSerialize(j)}function Yn(){return{type:"blockquote",children:[]}}function dt(){return{type:"code",lang:null,meta:null,value:""}}function Ti(){return{type:"inlineCode",value:""}}function Ll(){return{type:"definition",identifier:"",label:null,title:null,url:""}}function ht(){return{type:"emphasis",children:[]}}function _a(){return{type:"heading",depth:0,children:[]}}function Ra(){return{type:"break"}}function Nl(){return{type:"html",value:""}}function Ul(){return{type:"image",title:null,url:"",alt:null}}function za(){return{type:"link",title:null,url:"",children:[]}}function Oa(j){return{type:"list",ordered:j.type==="listOrdered",start:null,spread:j._spread,children:[]}}function Ei(j){return{type:"listItem",spread:j._spread,checked:null,children:[]}}function go(){return{type:"paragraph",children:[]}}function yo(){return{type:"strong",children:[]}}function gn(){return{type:"text",value:""}}function vo(){return{type:"thematicBreak"}}}function ra(a){return{line:a.line,column:a.column,offset:a.offset}}function Tg(a,l){let r=-1;for(;++r<l.length;){const o=l[r];Array.isArray(o)?Tg(a,o):lx(a,o)}}function lx(a,l){let r;for(r in l)if(kg.call(l,r))switch(r){case"canContainEols":{const o=l[r];o&&a[r].push(...o);break}case"transforms":{const o=l[r];o&&a[r].push(...o);break}case"enter":case"exit":{const o=l[r];o&&Object.assign(a[r],o);break}}}function gp(a,l){throw a?new Error("Cannot close `"+a.type+"` ("+Tl({start:a.start,end:a.end})+"): a different token (`"+l.type+"`, "+Tl({start:l.start,end:l.end})+") is open"):new Error("Cannot close document, a token (`"+l.type+"`, "+Tl({start:l.start,end:l.end})+") is still open")}function rx(a){const l=this;l.parser=r;function r(o){return ax(o,{...l.data("settings"),...a,extensions:l.data("micromarkExtensions")||[],mdastExtensions:l.data("fromMarkdownExtensions")||[]})}}function ox(a,l){const r={type:"element",tagName:"blockquote",properties:{},children:a.wrap(a.all(l),!0)};return a.patch(l,r),a.applyData(l,r)}function sx(a,l){const r={type:"element",tagName:"br",properties:{},children:[]};return a.patch(l,r),[a.applyData(l,r),{type:"text",value:`
`}]}function ux(a,l){const r=l.value?l.value+`
`:"",o={},c=l.lang?l.lang.split(/\s+/):[];c.length>0&&(o.className=["language-"+c[0]]);let f={type:"element",tagName:"code",properties:o,children:[{type:"text",value:r}]};return l.meta&&(f.data={meta:l.meta}),a.patch(l,f),f=a.applyData(l,f),f={type:"element",tagName:"pre",properties:{},children:[f]},a.patch(l,f),f}function cx(a,l){const r={type:"element",tagName:"del",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function fx(a,l){const r={type:"element",tagName:"em",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function dx(a,l){const r=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",o=String(l.identifier).toUpperCase(),c=ki(o.toLowerCase()),f=a.footnoteOrder.indexOf(o);let d,p=a.footnoteCounts.get(o);p===void 0?(p=0,a.footnoteOrder.push(o),d=a.footnoteOrder.length):d=f+1,p+=1,a.footnoteCounts.set(o,p);const g={type:"element",tagName:"a",properties:{href:"#"+r+"fn-"+c,id:r+"fnref-"+c+(p>1?"-"+p:""),dataFootnoteRef:!0,ariaDescribedBy:["footnote-label"]},children:[{type:"text",value:String(d)}]};a.patch(l,g);const m={type:"element",tagName:"sup",properties:{},children:[g]};return a.patch(l,m),a.applyData(l,m)}function hx(a,l){const r={type:"element",tagName:"h"+l.depth,properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function mx(a,l){if(a.options.allowDangerousHtml){const r={type:"raw",value:l.value};return a.patch(l,r),a.applyData(l,r)}}function Eg(a,l){const r=l.referenceType;let o="]";if(r==="collapsed"?o+="[]":r==="full"&&(o+="["+(l.label||l.identifier)+"]"),l.type==="imageReference")return[{type:"text",value:"!["+l.alt+o}];const c=a.all(l),f=c[0];f&&f.type==="text"?f.value="["+f.value:c.unshift({type:"text",value:"["});const d=c[c.length-1];return d&&d.type==="text"?d.value+=o:c.push({type:"text",value:o}),c}function px(a,l){const r=String(l.identifier).toUpperCase(),o=a.definitionById.get(r);if(!o)return Eg(a,l);const c={src:ki(o.url||""),alt:l.alt};o.title!==null&&o.title!==void 0&&(c.title=o.title);const f={type:"element",tagName:"img",properties:c,children:[]};return a.patch(l,f),a.applyData(l,f)}function gx(a,l){const r={src:ki(l.url)};l.alt!==null&&l.alt!==void 0&&(r.alt=l.alt),l.title!==null&&l.title!==void 0&&(r.title=l.title);const o={type:"element",tagName:"img",properties:r,children:[]};return a.patch(l,o),a.applyData(l,o)}function yx(a,l){const r={type:"text",value:l.value.replace(/\r?\n|\r/g," ")};a.patch(l,r);const o={type:"element",tagName:"code",properties:{},children:[r]};return a.patch(l,o),a.applyData(l,o)}function vx(a,l){const r=String(l.identifier).toUpperCase(),o=a.definitionById.get(r);if(!o)return Eg(a,l);const c={href:ki(o.url||"")};o.title!==null&&o.title!==void 0&&(c.title=o.title);const f={type:"element",tagName:"a",properties:c,children:a.all(l)};return a.patch(l,f),a.applyData(l,f)}function bx(a,l){const r={href:ki(l.url)};l.title!==null&&l.title!==void 0&&(r.title=l.title);const o={type:"element",tagName:"a",properties:r,children:a.all(l)};return a.patch(l,o),a.applyData(l,o)}function Sx(a,l,r){const o=a.all(l),c=r?wx(r):Ag(l),f={},d=[];if(typeof l.checked=="boolean"){const y=o[0];let v;y&&y.type==="element"&&y.tagName==="p"?v=y:(v={type:"element",tagName:"p",properties:{},children:[]},o.unshift(v)),v.children.length>0&&v.children.unshift({type:"text",value:" "}),v.children.unshift({type:"element",tagName:"input",properties:{type:"checkbox",checked:l.checked,disabled:!0},children:[]}),f.className=["task-list-item"]}let p=-1;for(;++p<o.length;){const y=o[p];(c||p!==0||y.type!=="element"||y.tagName!=="p")&&d.push({type:"text",value:`
...
`});const m={type:"element",tagName:"li",properties:f,children:d};return a.patch(l,m),a.applyData(l,m)}function wx(a){let l=!1;if(a.type==="list"){l=a.spread||!1;const r=a.children;let o=-1;for(;!l&&++o<r.length;)l=Ag(r[o])}return l}function Ag(a){const l=a.spread;return l??a.children.length>1}function xx(a,l){const r={},o=a.all(l);let c=-1;for(typeof l.start=="number"&&l.start!==1&&(r.start=l.start);++c<o.length;){const d=o[c];if(d.type==="element"&&d.tagName==="li"&&d.properties&&Array.isArray(d.properties.className)&&d.properties.className.includes("task-list-item")){r.className=["contains-task-list"];break}}const f={type:"element",tagName:l.ordered?"ol":"ul",properties:r,children:a.wrap(o,!0)};return a.patch(l,f),a.applyData(l,f)}function Cx(a,l){const r={type:"element",tagName:"p",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function kx(a,l){const r={type:"root",children:a.wrap(a.all(l))};return a.patch(l,r),a.applyData(l,r)}function Tx(a,l){const r={type:"element",tagName:"strong",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function Ex(a,l){const r=a.all(l),o=r.shift(),c=[];if(o){const d={type:"element",tagName:"thead",properties:{},children:a.wrap([o],!0)};a.patch(l.children[0],d),c.push(d)}if(r.length>0){const d={type:"element",tagName:"tbody",properties:{},children:a.wrap(r,!0)},p=kc(l.children[1]),g=og(l.children[l.children.length-1]);p&&g&&(d.position={start:p,end:g}),c.push(d)}const f={type:"element",tagName:"table",properties:{},children:a.wrap(c,!0)};return a.patch(l,f),a.applyData(l,f)}function Ax(a,l,r){const o=r?r.children:void 0,f=(o?o.indexOf(l):1)===0?"th":"td",d=r&&r.type==="table"?r.align:void 0,p=d?d.length:l.children.length;let g=-1;const m=[];for(;++g<p;){const v=l.children[g],x={},S=d?d[g]:void 0;S&&(x.align=S);let U={type:"element",tagName:f,properties:x,children:[]};v&&(U.children=a.all(v),a.patch(v,U),U=a.applyData(v,U)),m.push(U)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(m,!0)};return a.patch(l,y),a.applyData(l,y)}function Dx(a,l){const r={type:"element",tagName:"td",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}const yp=9,vp=32;function _x(a){const l=String(a),r=/\r?\n|\r/g;let o=r.exec(l),c=0;const f=[];for(;o;)f.push(bp(l.slice(c,o.index),c>0,!0),o[0]),c=o.index+o[0].length,o=r.exec(l);return f.push(bp(l.slice(c),c>0,!1)),f.join("")}function bp(a,l,r){let o=0,c=a.length;if(l){let f=a.codePointAt(o);for(;f===yp||f===vp;)o++,f=a.codePointAt(o)}if(r){let f=a.codePointAt(c-1);for(;f===yp||f===vp;)c--,f=a.codePointAt(c-1)}return c>o?a.slice(o,c):""}function Rx(a,l){const r={type:"text",value:_x(String(l.value))};return a.patch(l,r),a.applyData(l,r)}function zx(a,l){const r={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(l,r),a.applyData(l,r)}const Ox={blockquote:ox,break:sx,code:ux,delete:cx,emphasis:fx,footnoteReference:dx,heading:hx,html:mx,imageReference:px,image:gx,inlineCode:yx,linkReference:vx,link:bx,listItem:Sx,list:xx,paragraph:Cx,root:kx,strong:Tx,table:Ex,tableCell:Dx,tableRow:Ax,text:Rx,thematicBreak:zx,toml:eo,yaml:eo,definition:eo,footnoteDefinition:eo};function eo(){}const Dg=-1,mo=0,Al=1,oo=2,zc=3,Oc=4,Mc=5,Lc=6,_g=7,Rg=8,Sp=typeof self=="object"?self:globalThis,Mx=(a,l)=>{const r=(c,f)=>(a.set(f,c),c),o=c=>{if(a.has(c))return a.get(c);const[f,d]=l[c];switch(f){case mo:case Dg:return r(d,c);case Al:{const p=r([],c);for(const g of d)p.push(o(g));return p}case oo:{const p=r({},c);for(const[g,m]of d)p[o(g)]=o(m);return p}case zc:return r(new Date(d),c);case Oc:{const{source:p,flags:g}=d;return r(new RegExp(p,g),c)}case Mc:{const p=r(new Map,c);for(const[g,m]of d)p.set(o(g),o(m));return p}case Lc:{const p=r(new Set,c);for(const g of d)p.add(o(g));return p}case _g:{const{name:p,message:g}=d;return r(new Sp[p](g),c)}case Rg:return r(BigInt(d),c);case"BigInt":return r(Object(BigInt(d)),c);case"ArrayBuffer":return r(new Uint8Array(d).buffer,d);case"DataView":{const{buffer:p}=new Uint8Array(d);return r(new DataView(p),d)}}return r(new Sp[f](d),c)};return o},wp=a=>Mx(new Map,a)(0),vi="",{toString:Lx}={},{keys:Nx}=Object,kl=a=>{const l=typeof a;if(l!=="object"||!a)return[mo,l];const r=Lx.call(a).slice(8,-1);switch(r){case"Array":return[Al,vi];case"Object":return[oo,vi];case"Date":return[zc,vi];case"RegExp":return[Oc,vi];case"Map":return[Mc,vi];case"Set":return[Lc,vi];case"DataView":return[Al,r]}return r.includes("Array")?[Al,r]:r.includes("Error")?[_g,r]:[oo,r]},no=([a,l])=>a===mo&&(l==="function"||l==="symbol"),Ux=(a,l,r,o)=>{const c=(d,p)=>{const g=o.push(d)-1;return r.set(p,g),g},f=d=>{if(r.has(d))return r.get(d);let[p,g]=kl(d);switch(p){case mo:{let y=d;switch(g){case"bigint":p=Rg,y=d.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+g);y=null;break;case"undefined":return c([Dg],d)}return c([p,y],d)}case Al:{if(g){let x=d;return g==="DataView"?x=new Uint8Array(d.buffer):g==="ArrayBuffer"&&(x=new Uint8Array(d)),c([g,[...x]],d)}const y=[],v=c([p,y],d);for(const x of d)y.push(f(x));return v}case oo:{if(g)switch(g){case"BigInt":return c([g,d.toString()],d);case"Boolean":case"Number":case"String":return c([g,d.valueOf()],d)}if(l&&"toJSON"in d)return f(d.toJSON());const y=[],v=c([p,y],d);for(const x of Nx(d))(a||!no(kl(d[x])))&&y.push([f(x),f(d[x])]);return v}case zc:return c([p,d.toISOString()],d);case Oc:{const{source:y,flags:v}=d;return c([p,{source:y,flags:v}],d)}case Mc:{const y=[],v=c([p,y],d);for(const[x,S]of d)(a||!(no(kl(x))||no(kl(S))))&&y.push([f(x),f(S)]);return v}case Lc:{const y=[],v=c([p,y],d);for(const x of d)(a||!no(kl(x)))&&y.push(f(x));return v}}const{message:m}=d;return c([p,{name:g,message:m}],d)};return f},xp=(a,{json:l,lossy:r}={})=>{const o=[];return Ux(!(l||r),!!l,new Map,o)(a),o},so=typeof structuredClone=="function"?(a,l)=>l&&("json"in l||"lossy"in l)?wp(xp(a,l)):structuredClone(a):(a,l)=>wp(xp(a,l));function Bx(a,l){const r=[{type:"text",value:"↩"}];return l>1&&r.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(l)}]}),r}function Hx(a,l){return"Back to reference "+(a+1)+(l>1?"-"+l:"")}function Ix(a){const l=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",r=a.options.footnoteBackContent||Bx,o=a.options.footnoteBackLabel||Hx,c=a.options.footnoteLabel||"Footnotes",f=a.options.footnoteLabelTagName||"h2",d=a.options.footnoteLabelProperties||{className:["sr-only"]},p=[];let g=-1;for(;++g<a.footnoteOrder.length;){const m=a.footnoteById.get(a.footnoteOrder[g]);if(!m)continue;const y=a.all(m),v=String(m.identifier).toUpperCase(),x=ki(v.toLowerCase());let S=0;const U=[],L=a.footnoteCounts.get(v);for(;L!==void 0&&++S<=L;){U.length>0&&U.push({type:"text",value:" "});let V=typeof r=="string"?r:r(g,S);typeof V=="string"&&(V={type:"text",value:V}),U.push({type:"element",tagName:"a",properties:{href:"#"+l+"fnref-"+x+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof o=="string"?o:o(g,S),className:["data-footnote-backref"]},children:Array.isArray(V)?V:[V]})}const B=y[y.length-1];if(B&&B.type==="element"&&B.tagName==="p"){const V=B.children[B.children.length-1];V&&V.type==="text"?V.value+=" ":B.children.push({type:"text",value:" "}),B.children.push(...U)}else y.push(...U);const O={type:"element",tagName:"li",properties:{id:l+"fn-"+x},children:a.wrap(y,!0)};a.patch(m,O),p.push(O)}if(p.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:f,properties:{...so(d),id:"footnote-label"},children:[{type:"text",value:c}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(p,!0)},{type:"text",value:`
`}]}}const zg=(function(a){if(a==null)return Gx;if(typeof a=="function")return po(a);if(typeof a=="object")return Array.isArray(a)?jx(a):qx(a);if(typeof a=="string")return Yx(a);throw new Error("Expected function, string, or object as test")});function jx(a){const l=[];let r=-1;for(;++r<a.length;)l[r]=zg(a[r]);return po(o);function o(...c){let f=-1;for(;++f<l.length;)if(l[f].apply(this,c))return!0;return!1}}function qx(a){const l=a;return po(r);function r(o){const c=o;let f;for(f in a)if(c[f]!==l[f])return!1;return!0}}function Yx(a){return po(l);function l(r){return r&&r.type===a}}function po(a){return l;function l(r,o,c){return!!(Fx(r)&&a.call(this,r,typeof o=="number"?o:void 0,c||void 0))}}function Gx(){return!0}function Fx(a){return a!==null&&typeof a=="object"&&"type"in a}const Og=[],Vx=!0,Cp=!1,Px="skip";function Xx(a,l,r,o){let c;typeof l=="function"&&typeof r!="function"?(o=r,r=l):c=l;const f=zg(c),d=o?-1:1;p(a,void 0,[])();function p(g,m,y){const v=g&&typeof g=="object"?g:{};if(typeof v.type=="string"){const S=typeof v.tagName=="string"?v.tagName:typeof v.name=="string"?v.name:void 0;Object.defineProperty(x,"name",{value:"node ("+(g.type+(S?"<"+S+">":""))+")"})}return x;function x(){let S=Og,U,L,B;if((!l||f(g,m,y[y.length-1]||void 0))&&(S=Qx(r(g,y)),S[0]===Cp))return S;if("children"in g&&g.children){const O=g;if(O.children&&S[0]!==Px)for(L=(o?O.children.length:-1)+d,B=y.concat(O);L>-1&&L<O.children.length;){const V=O.children[L];if(U=p(V,L,B)(),U[0]===Cp)return U;L=typeof U[1]=="number"?U[1]:L+d}}return S}}}function Qx(a){return Array.isArray(a)?a:typeof a=="number"?[Vx,a]:a==null?Og:[a]}function Mg(a,l,r,o){let c,f,d;typeof l=="function"&&typeof r!="function"?(f=void 0,d=l,c=r):(f=l,d=r,c=o),Xx(a,f,p,c);function p(g,m){const y=m[m.length-1],v=y?y.children.indexOf(g):void 0;return d(g,v,y)}}const cc={}.hasOwnProperty,Wx={};function Kx(a,l){const r=l||Wx,o=new Map,c=new Map,f=new Map,d={...Ox,...r.handlers},p={all:m,applyData:Jx,definitionById:o,footnoteById:c,footnoteCounts:f,footnoteOrder:[],handlers:d,one:g,options:r,patch:Zx,wrap:eC};return Mg(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const v=y.type==="definition"?o:c,x=String(y.identifier).toUpperCase();v.has(x)||v.set(x,y)}}),p;function g(y,v){const x=y.type,S=p.handlers[x];if(cc.call(p.handlers,x)&&S)return S(p,y,v);if(p.options.passThrough&&p.options.passThrough.includes(x)){if("children"in y){const{children:L,...B}=y,O=so(B);return O.children=p.all(y),O}return so(y)}return(p.options.unknownHandler||$x)(p,y,v)}function m(y){const v=[];if("children"in y){const x=y.children;let S=-1;for(;++S<x.length;){const U=p.one(x[S],y);if(U){if(S&&x[S-1].type==="break"&&(!Array.isArray(U)&&U.type==="text"&&(U.value=kp(U.value)),!Array.isArray(U)&&U.type==="element")){const L=U.children[0];L&&L.type==="text"&&(L.value=kp(L.value))}Array.isArray(U)?v.push(...U):v.push(U)}}}return v}}function Zx(a,l){a.position&&(l.position=L1(a))}function Jx(a,l){let r=l;if(a&&a.data){const o=a.data.hName,c=a.data.hChildren,f=a.data.hProperties;if(typeof o=="string")if(r.type==="element")r.tagName=o;else{const d="children"in r?r.children:[r];r={type:"element",tagName:o,properties:{},children:d}}r.type==="element"&&f&&Object.assign(r.properties,so(f)),"children"in r&&r.children&&c!==null&&c!==void 0&&(r.children=c)}return r}function $x(a,l){const r=l.data||{},o="value"in l&&!(cc.call(r,"hProperties")||cc.call(r,"hChildren"))?{type:"text",value:l.value}:{type:"element",tagName:"div",properties:{},children:a.all(l)};return a.patch(l,o),a.applyData(l,o)}function eC(a,l){const r=[];let o=-1;for(l&&r.push({type:"text",value:`
`});++o<a.length;)o&&r.push({type:"text",value:`
`}),r.push(a[o]);return l&&a.length>0&&r.push({type:"text",value:`
`}),r}function kp(a){let l=0,r=a.charCodeAt(l);for(;r===9||r===32;)l++,r=a.charCodeAt(l);return a.slice(l)}function Tp(a,l){const r=Kx(a,l),o=r.one(a,void 0),c=Ix(r),f=Array.isArray(o)?{type:"root",children:o}:o||{type:"root",children:[]};return c&&f.children.push({type:"text",value:`
`},c),f}function nC(a,l){return a&&"run"in a?async function(r,o){const c=Tp(r,{file:o,...l});await a.run(c,o)}:function(r,o){return Tp(r,{file:o,...a||l})}}function Ep(a){if(a)throw a}var Pu,Ap;function tC(){if(Ap)return Pu;Ap=1;var a=Object.prototype.hasOwnProperty,l=Object.prototype.toString,r=Object.defineProperty,o=Object.getOwnPropertyDescriptor,c=function(m){return typeof Array.isArray=="function"?Array.isArray(m):l.call(m)==="[object Array]"},f=function(m){if(!m||l.call(m)!=="[object Object]")return!1;var y=a.call(m,"constructor"),v=m.constructor&&m.constructor.prototype&&a.call(m.constructor.prototype,"isPrototypeOf");if(m.constructor&&!y&&!v)return!1;var x;for(x in m);return typeof x>"u"||a.call(m,x)},d=function(m,y){r&&y.name==="__proto__"?r(m,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):m[y.name]=y.newValue},p=function(m,y){if(y==="__proto__")if(a.call(m,y)){if(o)return o(m,y).value}else return;return m[y]};return Pu=function g(){var m,y,v,x,S,U,L=arguments[0],B=1,O=arguments.length,V=!1;for(typeof L=="boolean"&&(V=L,L=arguments[1]||{},B=2),(L==null||typeof L!="object"&&typeof L!="function")&&(L={});B<O;++B)if(m=arguments[B],m!=null)for(y in m)v=p(L,y),x=p(m,y),L!==x&&(V&&x&&(f(x)||(S=c(x)))?(S?(S=!1,U=v&&c(v)?v:[]):U=v&&f(v)?v:{},d(L,{name:y,newValue:g(V,U,x)})):typeof x<"u"&&d(L,{name:y,newValue:x}));return L},Pu}var aC=tC();const Xu=uo(aC);function fc(a){if(typeof a!="object"||a===null)return!1;const l=Object.getPrototypeOf(a);return(l===null||l===Object.prototype||Object.getPrototypeOf(l)===null)&&!(Symbol.toStringTag in a)&&!(Symbol.iterator in a)}function iC(){const a=[],l={run:r,use:o};return l;function r(...c){let f=-1;const d=c.pop();if(typeof d!="function")throw new TypeError("Expected function as last argument, not "+d);p(null,...c);function p(g,...m){const y=a[++f];let v=-1;if(g){d(g);return}for(;++v<c.length;)(m[v]===null||m[v]===void 0)&&(m[v]=c[v]);c=m,y?lC(y,p)(...m):d(null,...m)}}function o(c){if(typeof c!="function")throw new TypeError("Expected `middelware` to be a function, not "+c);return a.push(c),l}}function lC(a,l){let r;return o;function o(...d){const p=a.length>d.length;let g;p&&d.push(c);try{g=a.apply(this,d)}catch(m){const y=m;if(p&&r)throw y;return c(y)}p||(g&&g.then&&typeof g.then=="function"?g.then(f,c):g instanceof Error?c(g):f(g))}function c(d,...p){r||(r=!0,l(d,...p))}function f(d){c(null,d)}}const ut={basename:rC,dirname:oC,extname:sC,join:uC,sep:"/"};function rC(a,l){if(l!==void 0&&typeof l!="string")throw new TypeError('"ext" argument must be a string');Ml(a);let r=0,o=-1,c=a.length,f;if(l===void 0||l.length===0||l.length>a.length){for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else o<0&&(f=!0,o=c+1);return o<0?"":a.slice(r,o)}if(l===a)return"";let d=-1,p=l.length-1;for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else d<0&&(f=!0,d=c+1),p>-1&&(a.codePointAt(c)===l.codePointAt(p--)?p<0&&(o=c):(p=-1,o=d));return r===o?o=d:o<0&&(o=a.length),a.slice(r,o)}function oC(a){if(Ml(a),a.length===0)return".";let l=-1,r=a.length,o;for(;--r;)if(a.codePointAt(r)===47){if(o){l=r;break}}else o||(o=!0);return l<0?a.codePointAt(0)===47?"/":".":l===1&&a.codePointAt(0)===47?"//":a.slice(0,l)}function sC(a){Ml(a);let l=a.length,r=-1,o=0,c=-1,f=0,d;for(;l--;){const p=a.codePointAt(l);if(p===47){if(d){o=l+1;break}continue}r<0&&(d=!0,r=l+1),p===46?c<0?c=l:f!==1&&(f=1):c>-1&&(f=-1)}return c<0||r<0||f===0||f===1&&c===r-1&&c===o+1?"":a.slice(c,r)}function uC(...a){let l=-1,r;for(;++l<a.length;)Ml(a[l]),a[l]&&(r=r===void 0?a[l]:r+"/"+a[l]);return r===void 0?".":cC(r)}function cC(a){Ml(a);const l=a.codePointAt(0)===47;let r=fC(a,!l);return r.length===0&&!l&&(r="."),r.length>0&&a.codePointAt(a.length-1)===47&&(r+="/"),l?"/"+r:r}function fC(a,l){let r="",o=0,c=-1,f=0,d=-1,p,g;for(;++d<=a.length;){if(d<a.length)p=a.codePointAt(d);else{if(p===47)break;p=47}if(p===47){if(!(c===d-1||f===1))if(c!==d-1&&f===2){if(r.length<2||o!==2||r.codePointAt(r.length-1)!==46||r.codePointAt(r.length-2)!==46){if(r.length>2){if(g=r.lastIndexOf("/"),g!==r.length-1){g<0?(r="",o=0):(r=r.slice(0,g),o=r.length-1-r.lastIndexOf("/")),c=d,f=0;continue}}else if(r.length>0){r="",o=0,c=d,f=0;continue}}l&&(r=r.length>0?r+"/..":"..",o=2)}else r.length>0?r+="/"+a.slice(c+1,d):r=a.slice(c+1,d),o=d-c-1;c=d,f=0}else p===46&&f>-1?f++:f=-1}return r}function Ml(a){if(typeof a!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(a))}const dC={cwd:hC};function hC(){return"/"}function dc(a){return!!(a!==null&&typeof a=="object"&&"href"in a&&a.href&&"protocol"in a&&a.protocol&&a.auth===void 0)}function mC(a){if(typeof a=="string")a=new URL(a);else if(!dc(a)){const l=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+a+"`");throw l.code="ERR_INVALID_ARG_TYPE",l}if(a.protocol!=="file:"){const l=new TypeError("The URL must be of scheme file");throw l.code="ERR_INVALID_URL_SCHEME",l}return pC(a)}function pC(a){if(a.hostname!==""){const o=new TypeError('File URL host must be "localhost" or empty on darwin');throw o.code="ERR_INVALID_FILE_URL_HOST",o}const l=a.pathname;let r=-1;for(;++r<l.length;)if(l.codePointAt(r)===37&&l.codePointAt(r+1)===50){const o=l.codePointAt(r+2);if(o===70||o===102){const c=new TypeError("File URL path must not include encoded / characters");throw c.code="ERR_INVALID_FILE_URL_PATH",c}}return decodeURIComponent(l)}const Qu=["history","path","basename","stem","extname","dirname"];class Lg{constructor(l){let r;l?dc(l)?r={path:l}:typeof l=="string"||gC(l)?r={value:l}:r=l:r={},this.cwd="cwd"in r?"":dC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let o=-1;for(;++o<Qu.length;){const f=Qu[o];f in r&&r[f]!==void 0&&r[f]!==null&&(this[f]=f==="history"?[...r[f]]:r[f])}let c;for(c in r)Qu.includes(c)||(this[c]=r[c])}get basename(){return typeof this.path=="string"?ut.basename(this.path):void 0}set basename(l){Ku(l,"basename"),Wu(l,"basename"),this.path=ut.join(this.dirname||"",l)}get dirname(){return typeof this.path=="string"?ut.dirname(this.path):void 0}set dirname(l){Dp(this.basename,"dirname"),this.path=ut.join(l||"",this.basename)}get extname(){return typeof this.path=="string"?ut.extname(this.path):void 0}set extname(l){if(Wu(l,"extname"),Dp(this.dirname,"extname"),l){if(l.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(l.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=ut.join(this.dirname,this.stem+(l||""))}get path(){return this.history[this.history.length-1]}set path(l){dc(l)&&(l=mC(l)),Ku(l,"path"),this.path!==l&&this.history.push(l)}get stem(){return typeof this.path=="string"?ut.basename(this.path,this.extname):void 0}set stem(l){Ku(l,"stem"),Wu(l,"stem"),this.path=ut.join(this.dirname||"",l+(this.extname||""))}fail(l,r,o){const c=this.message(l,r,o);throw c.fatal=!0,c}info(l,r,o){const c=this.message(l,r,o);return c.fatal=void 0,c}message(l,r,o){const c=new pn(l,r,o);return this.path&&(c.name=this.path+":"+c.name,c.file=this.path),c.fatal=!1,this.messages.push(c),c}toString(l){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(l||void 0).decode(this.value)}}function Wu(a,l){if(a&&a.includes(ut.sep))throw new Error("`"+l+"` cannot be a path: did not expect `"+ut.sep+"`")}function Ku(a,l){if(!a)throw new Error("`"+l+"` cannot be empty")}function Dp(a,l){if(!a)throw new Error("Setting `"+l+"` requires `path` to be set too")}function gC(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const yC=(function(a){const o=this.constructor.prototype,c=o[a],f=function(){return c.apply(f,arguments)};return Object.setPrototypeOf(f,o),f}),vC={}.hasOwnProperty;class Nc extends yC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=iC()}copy(){const l=new Nc;let r=-1;for(;++r<this.attachers.length;){const o=this.attachers[r];l.use(...o)}return l.data(Xu(!0,{},this.namespace)),l}data(l,r){return typeof l=="string"?arguments.length===2?($u("data",this.frozen),this.namespace[l]=r,this):vC.call(this.namespace,l)&&this.namespace[l]||void 0:l?($u("data",this.frozen),this.namespace=l,this):this.namespace}freeze(){if(this.frozen)return this;const l=this;for(;++this.freezeIndex<this.attachers.length;){const[r,...o]=this.attachers[this.freezeIndex];if(o[0]===!1)continue;o[0]===!0&&(o[0]=void 0);const c=r.call(l,...o);typeof c=="function"&&this.transformers.use(c)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(l){this.freeze();const r=to(l),o=this.parser||this.Parser;return Zu("parse",o),o(String(r),r)}process(l,r){const o=this;return this.freeze(),Zu("process",this.parser||this.Parser),Ju("process",this.compiler||this.Compiler),r?c(void 0,r):new Promise(c);function c(f,d){const p=to(l),g=o.parse(p);o.run(g,p,function(y,v,x){if(y||!v||!x)return m(y);const S=v,U=o.stringify(S,x);wC(U)?x.value=U:x.result=U,m(y,x)});function m(y,v){y||!v?d(y):f?f(v):r(void 0,v)}}}processSync(l){let r=!1,o;return this.freeze(),Zu("processSync",this.parser||this.Parser),Ju("processSync",this.compiler||this.Compiler),this.process(l,c),Rp("processSync","process",r),o;function c(f,d){r=!0,Ep(f),o=d}}run(l,r,o){_p(l),this.freeze();const c=this.transformers;return!o&&typeof r=="function"&&(o=r,r=void 0),o?f(void 0,o):new Promise(f);function f(d,p){const g=to(r);c.run(l,g,m);function m(y,v,x){const S=v||l;y?p(y):d?d(S):o(void 0,S,x)}}}runSync(l,r){let o=!1,c;return this.run(l,r,f),Rp("runSync","run",o),c;function f(d,p){Ep(d),c=p,o=!0}}stringify(l,r){this.freeze();const o=to(r),c=this.compiler||this.Compiler;return Ju("stringify",c),_p(l),c(l,o)}use(l,...r){const o=this.attachers,c=this.namespace;if($u("use",this.frozen),l!=null)if(typeof l=="function")g(l,r);else if(typeof l=="object")Array.isArray(l)?p(l):d(l);else throw new TypeError("Expected usable value, not `"+l+"`");return this;function f(m){if(typeof m=="function")g(m,[]);else if(typeof m=="object")if(Array.isArray(m)){const[y,...v]=m;g(y,v)}else d(m);else throw new TypeError("Expected usable value, not `"+m+"`")}function d(m){if(!("plugins"in m)&&!("settings"in m))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");p(m.plugins),m.settings&&(c.settings=Xu(!0,c.settings,m.settings))}function p(m){let y=-1;if(m!=null)if(Array.isArray(m))for(;++y<m.length;){const v=m[y];f(v)}else throw new TypeError("Expected a list of plugins, not `"+m+"`")}function g(m,y){let v=-1,x=-1;for(;++v<o.length;)if(o[v][0]===m){x=v;break}if(x===-1)o.push([m,...y]);else if(y.length>0){let[S,...U]=y;const L=o[x][1];fc(L)&&fc(S)&&(S=Xu(!0,L,S)),o[x]=[m,S,...U]}}}}const bC=new Nc().freeze();function Zu(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `parser`")}function Ju(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `compiler`")}function $u(a,l){if(l)throw new Error("Cannot call `"+a+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function _p(a){if(!fc(a)||typeof a.type!="string")throw new TypeError("Expected node, got `"+a+"`")}function Rp(a,l,r){if(!r)throw new Error("`"+a+"` finished async. Use `"+l+"` instead")}function to(a){return SC(a)?a:new Lg(a)}function SC(a){return!!(a&&typeof a=="object"&&"message"in a&&"messages"in a)}function wC(a){return typeof a=="string"||xC(a)}function xC(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const CC="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",zp=[],Op={allowDangerousHtml:!0},kC=/^(https?|ircs?|mailto|xmpp)$/i,TC=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function EC(a){const l=AC(a),r=DC(a);return _C(l.runSync(l.parse(r),r),a)}function AC(a){const l=a.rehypePlugins||zp,r=a.remarkPlugins||zp,o=a.remarkRehypeOptions?{...a.remarkRehypeOptions,...Op}:Op;return bC().use(rx).use(r).use(nC,o).use(l)}function DC(a){const l=a.children||"",r=new Lg;return typeof l=="string"&&(r.value=l),r}function _C(a,l){const r=l.allowedElements,o=l.allowElement,c=l.components,f=l.disallowedElements,d=l.skipHtml,p=l.unwrapDisallowed,g=l.urlTransform||RC;for(const y of TC)Object.hasOwn(l,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+CC+y.id,void 0);return Mg(a,m),I1(a,{Fragment:sn.Fragment,components:c,ignoreInvalidStyle:!0,jsx:sn.jsx,jsxs:sn.jsxs,passKeys:!0,passNode:!0});function m(y,v,x){if(y.type==="raw"&&x&&typeof v=="number")return d?x.children.splice(v,1):x.children[v]={type:"text",value:y.value},v;if(y.type==="element"){let S;for(S in Gu)if(Object.hasOwn(Gu,S)&&Object.hasOwn(y.properties,S)){const U=y.properties[S],L=Gu[S];(L===null||L.includes(y.tagName))&&(y.properties[S]=g(String(U||""),S,y))}}if(y.type==="element"){let S=r?!r.includes(y.tagName):f?f.includes(y.tagName):!1;if(!S&&o&&typeof v=="number"&&(S=!o(y,v,x)),S&&x&&typeof v=="number")return p&&y.children?x.children.splice(v,1,...y.children):x.children.splice(v,1),v}}}function RC(a){const l=a.indexOf(":"),r=a.indexOf("?"),o=a.indexOf("#"),c=a.indexOf("/");return l===-1||c!==-1&&l>c||r!==-1&&l>r||o!==-1&&l>o||kC.test(a.slice(0,l))?a:""}function zC(){const{slug:a}=Gb(),l=wc.find(r=>r.slug===a);return l?sn.jsx("div",{className:"markdown",children:sn.jsx(EC,{children:l.content})}):sn.jsx("div",{children:"Document not found"})}function OC(){return sn.jsx(_S,{children:sn.jsxs("div",{style:{display:"flex",minHeight:"100vh"},children:[sn.jsx(c1,{}),sn.jsxs(lS,{children:[sn.jsx(nc,{path:"/",element:sn.jsx(aS,{to:`/docs/${wc[0].slug}`})}),sn.jsx(nc,{path:"/docs/:slug",element:sn.jsx(zC,{})})]})]})})}rb.createRoot(document.getElementById("root")).render(sn.jsx(Jv.StrictMode,{children:sn.jsx(OC,{})}));
