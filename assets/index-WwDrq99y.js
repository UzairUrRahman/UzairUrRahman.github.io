...
`,FS=`# Google Sheets Text Capitalization
...
\`\`\``,VS=`# Server Security Response Guide
...
That means attempted exploitation, not just scanning.`,QS=`# Make Your Home Computer Reachable From Anywhere (No Public IP, No Router Touching)
## What We Need
...
\`\`\``,XS=`# How to Answer a CTO (How You SOUND Matters)
...
100. Best TPM trait?
Calm, structured thinking under pressure.`,KS=`## Section 1: Linux Basics
...
5.  Add user to group? usermod -aG`,ZS=`# Linux Security Cheat Sheet
...
23.  ### Legal Warning Banners
    ...
    \`\`\``,$S=`# 15 Linux One-Liners That Feel Like Cheating
...
-   1m ~ 5m ~ 15m — The load is consistent (stable).`,JS=`# Linux Commands: Find All SUID Binaries (for Privilege Escalation)
...
10.  Server works with IP but not hostname. How do you fix it?`,nw=`# 12 Golden Rules for Low Latency Every System Design Engineer MUST Know
...
12.  ## Use Message Queues for Background Processing
    ...
    \`\`\``,tw=`# 9 Ridiculously Useful macOS Tahoe Settings You're 100% Not Using
...
This command turns experience into a searchable database. The longer you work in Linux, the more powerful it becomes.`,iw=`# Reflections on My Tenure at Iskaan
...
Sincerely,  
[Your Full Name]`,lw=`# I Showed This Resume Trick to 27 Developers — 19 Got 2x Offers in 30 Days
...
Don't beautify. Don't format. Don't redesign. Just rewrite.`,rw=`# Run Claude Code Locally on Apple Silicon Using LM Studio and LiteLLM (Zero Cost)
...
[Service Provider]`,sw=`# Passwordless SSH Login Using SSH Key Authentication (Step-by-Step Guide)
...
\`\`\`
ssh -vvv user@server
\`\`\``,uw=`# Secure SSH Like a Pro: 7 Steps Every Linux Admin Should Know
...
7.  ## Enable Two-Factor Authentication (2FA)
    ...
    Pro Tip: Backup your 2FA secrets securely.`,cw=`# Setting a Login Banner on Linux Servers 
...
\`\`\``,fw=`# What SRE Interviewers Really Look For
...
Used correctly, this boosts productivity massively.`,dw=`## Convert a Meeting from Video .mp4 to Audio with AI in Mac Terminal and Generating MoM's. 
...
> "Summarize the following meeting transcript into key decisions, action items, and important discussion points and generate a MoM for this."`,hw=`# 10 Underrated CLI Commands You've (Probably) Never Heard Of
...
10.  ## grex - Generate Regex from Examples
    ...
    It outputs a working regex that matches both. Add flags like  \`--digits\`  or  \`--repetitions\`  for more generalized patterns. It's a lifesaver when you know what you want to match but can't remember how.`,mw=`# Using Manga-Downloader on Mac
...
Check flags on how to use CLI properly from the documentation.`,pw=`# Zabbix Automation For AWS Server Reboot
...
`,gw=`# DevOps Commands Cheat Sheet (With Real-World Examples)
...
48.  \`journalctl\`  — View system logs
    ...
    Copy:  \`journalctl -u nginx\`  # Shows logs for the nginx service.`,yw=`# How to Write Markdown .md Files in Your Code and Push It to GitHub Pages (Deployment)
...
to publish the changes to the GitHub repo (main branch) and it will automatically push the new build to the gh-pages branch (where you can check the deployment status).`,bw=`Terminal Tools For Mac OS and Linux
==============
...
nyancat in action`,vw=`# ✏️ Start writing
...
`});const m={type:"element",tagName:"li",properties:f,children:d};return a.patch(l,m),a.applyData(l,m)}function Mx(a){let l=!1;if(a.type==="list"){l=a.spread||!1;const r=a.children;let o=-1;for(;!l&&++o<r.length;)l=Eg(r[o])}return l}function Eg(a){const l=a.spread;return l??a.children.length>1}function Lx(a,l){const r={},o=a.all(l);let c=-1;for(typeof l.start=="number"&&l.start!==1&&(r.start=l.start);++c<o.length;){const d=o[c];if(d.type==="element"&&d.tagName==="li"&&d.properties&&Array.isArray(d.properties.className)&&d.properties.className.includes("task-list-item")){r.className=["contains-task-list"];break}}const f={type:"element",tagName:l.ordered?"ol":"ul",properties:r,children:a.wrap(o,!0)};return a.patch(l,f),a.applyData(l,f)}function zx(a,l){const r={type:"element",tagName:"p",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function Nx(a,l){const r={type:"root",children:a.wrap(a.all(l))};return a.patch(l,r),a.applyData(l,r)}function Ix(a,l){const r={type:"element",tagName:"strong",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function Ux(a,l){const r=a.all(l),o=r.shift(),c=[];if(o){const d={type:"element",tagName:"thead",properties:{},children:a.wrap([o],!0)};a.patch(l.children[0],d),c.push(d)}if(r.length>0){const d={type:"element",tagName:"tbody",properties:{},children:a.wrap(r,!0)},p=Cc(l.children[1]),g=og(l.children[l.children.length-1]);p&&g&&(d.position={start:p,end:g}),c.push(d)}const f={type:"element",tagName:"table",properties:{},children:a.wrap(c,!0)};return a.patch(l,f),a.applyData(l,f)}function Bx(a,l,r){const o=r?r.children:void 0,f=(o?o.indexOf(l):1)===0?"th":"td",d=r&&r.type==="table"?r.align:void 0,p=d?d.length:l.children.length;let g=-1;const m=[];for(;++g<p;){const b=l.children[g],x={},S=d?d[g]:void 0;S&&(x.align=S);let I={type:"element",tagName:f,properties:x,children:[]};b&&(I.children=a.all(b),a.patch(b,I),I=a.applyData(b,I)),m.push(I)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(m,!0)};return a.patch(l,y),a.applyData(l,y)}function Hx(a,l){const r={type:"element",tagName:"td",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}const yp=9,bp=32;function qx(a){const l=String(a),r=/\r?\n|\r/g;let o=r.exec(l),c=0;const f=[];for(;o;)f.push(vp(l.slice(c,o.index),c>0,!0),o[0]),c=o.index+o[0].length,o=r.exec(l);return f.push(vp(l.slice(c),c>0,!1)),f.join("")}function vp(a,l,r){let o=0,c=a.length;if(l){let f=a.codePointAt(o);for(;f===yp||f===bp;)o++,f=a.codePointAt(o)}if(r){let f=a.codePointAt(c-1);for(;f===yp||f===bp;)c--,f=a.codePointAt(c-1)}return c>o?a.slice(o,c):""}function jx(a,l){const r={type:"text",value:qx(String(l.value))};return a.patch(l,r),a.applyData(l,r)}function Px(a,l){const r={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(l,r),a.applyData(l,r)}const Yx={blockquote:bx,break:vx,code:Sx,delete:wx,emphasis:xx,footnoteReference:kx,heading:Cx,html:Tx,imageReference:Ax,image:Ex,inlineCode:_x,linkReference:Dx,link:Rx,listItem:Ox,list:Lx,paragraph:zx,root:Nx,strong:Ix,table:Ux,tableCell:Hx,tableRow:Bx,text:jx,thematicBreak:Px,toml:eo,yaml:eo,definition:eo,footnoteDefinition:eo};function eo(){}const _g=-1,mo=0,El=1,oo=2,Oc=3,Mc=4,Lc=5,zc=6,Dg=7,Rg=8,Sp=typeof self=="object"?self:globalThis,Gx=(a,l)=>{const r=(c,f)=>(a.set(f,c),c),o=c=>{if(a.has(c))return a.get(c);const[f,d]=l[c];switch(f){case mo:case _g:return r(d,c);case El:{const p=r([],c);for(const g of d)p.push(o(g));return p}case oo:{const p=r({},c);for(const[g,m]of d)p[o(g)]=o(m);return p}case Oc:return r(new Date(d),c);case Mc:{const{source:p,flags:g}=d;return r(new RegExp(p,g),c)}case Lc:{const p=r(new Map,c);for(const[g,m]of d)p.set(o(g),o(m));return p}case zc:{const p=r(new Set,c);for(const g of d)p.add(o(g));return p}case Dg:{const{name:p,message:g}=d;return r(new Sp[p](g),c)}case Rg:return r(BigInt(d),c);case"BigInt":return r(Object(BigInt(d)),c);case"ArrayBuffer":return r(new Uint8Array(d).buffer,d);case"DataView":{const{buffer:p}=new Uint8Array(d);return r(new DataView(p),d)}}return r(new Sp[f](d),c)};return o},wp=a=>Gx(new Map,a)(0),bi="",{toString:Wx}={},{keys:Fx}=Object,Cl=a=>{const l=typeof a;if(l!=="object"||!a)return[mo,l];const r=Wx.call(a).slice(8,-1);switch(r){case"Array":return[El,bi];case"Object":return[oo,bi];case"Date":return[Oc,bi];case"RegExp":return[Mc,bi];case"Map":return[Lc,bi];case"Set":return[zc,bi];case"DataView":return[El,r]}return r.includes("Array")?[El,r]:r.includes("Error")?[Dg,r]:[oo,r]},no=([a,l])=>a===mo&&(l==="function"||l==="symbol"),Vx=(a,l,r,o)=>{const c=(d,p)=>{const g=o.push(d)-1;return r.set(p,g),g},f=d=>{if(r.has(d))return r.get(d);let[p,g]=Cl(d);switch(p){case mo:{let y=d;switch(g){case"bigint":p=Rg,y=d.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+g);y=null;break;case"undefined":return c([_g],d)}return c([p,y],d)}case El:{if(g){let x=d;return g==="DataView"?x=new Uint8Array(d.buffer):g==="ArrayBuffer"&&(x=new Uint8Array(d)),c([g,[...x]],d)}const y=[],b=c([p,y],d);for(const x of d)y.push(f(x));return b}case oo:{if(g)switch(g){case"BigInt":return c([g,d.toString()],d);case"Boolean":case"Number":case"String":return c([g,d.valueOf()],d)}if(l&&"toJSON"in d)return f(d.toJSON());const y=[],b=c([p,y],d);for(const x of Fx(d))(a||!no(Cl(d[x])))&&y.push([f(x),f(d[x])]);return b}case Oc:return c([p,d.toISOString()],d);case Mc:{const{source:y,flags:b}=d;return c([p,{source:y,flags:b}],d)}case Lc:{const y=[],b=c([p,y],d);for(const[x,S]of d)(a||!(no(Cl(x))||no(Cl(S))))&&y.push([f(x),f(S)]);return b}case zc:{const y=[],b=c([p,y],d);for(const x of d)(a||!no(Cl(x)))&&y.push(f(x));return b}}const{message:m}=d;return c([p,{name:g,message:m}],d)};return f},xp=(a,{json:l,lossy:r}={})=>{const o=[];return Vx(!(l||r),!!l,new Map,o)(a),o},so=typeof structuredClone=="function"?(a,l)=>l&&("json"in l||"lossy"in l)?wp(xp(a,l)):structuredClone(a):(a,l)=>wp(xp(a,l));function Qx(a,l){const r=[{type:"text",value:"↩"}];return l>1&&r.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(l)}]}),r}function Xx(a,l){return"Back to reference "+(a+1)+(l>1?"-"+l:"")}function Kx(a){const l=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",r=a.options.footnoteBackContent||Qx,o=a.options.footnoteBackLabel||Xx,c=a.options.footnoteLabel||"Footnotes",f=a.options.footnoteLabelTagName||"h2",d=a.options.footnoteLabelProperties||{className:["sr-only"]},p=[];let g=-1;for(;++g<a.footnoteOrder.length;){const m=a.footnoteById.get(a.footnoteOrder[g]);if(!m)continue;const y=a.all(m),b=String(m.identifier).toUpperCase(),x=Ci(b.toLowerCase());let S=0;const I=[],z=a.footnoteCounts.get(b);for(;z!==void 0&&++S<=z;){I.length>0&&I.push({type:"text",value:" "});let W=typeof r=="string"?r:r(g,S);typeof W=="string"&&(W={type:"text",value:W}),I.push({type:"element",tagName:"a",properties:{href:"#"+l+"fnref-"+x+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof o=="string"?o:o(g,S),className:["data-footnote-backref"]},children:Array.isArray(W)?W:[W]})}const U=y[y.length-1];if(U&&U.type==="element"&&U.tagName==="p"){const W=U.children[U.children.length-1];W&&W.type==="text"?W.value+=" ":U.children.push({type:"text",value:" "}),U.children.push(...I)}else y.push(...I);const M={type:"element",tagName:"li",properties:{id:l+"fn-"+x},children:a.wrap(y,!0)};a.patch(m,M),p.push(M)}if(p.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:f,properties:{...so(d),id:"footnote-label"},children:[{type:"text",value:c}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(p,!0)},{type:"text",value:`
`}]}}const Og=(function(a){if(a==null)return ek;if(typeof a=="function")return po(a);if(typeof a=="object")return Array.isArray(a)?Zx(a):$x(a);if(typeof a=="string")return Jx(a);throw new Error("Expected function, string, or object as test")});function Zx(a){const l=[];let r=-1;for(;++r<a.length;)l[r]=Og(a[r]);return po(o);function o(...c){let f=-1;for(;++f<l.length;)if(l[f].apply(this,c))return!0;return!1}}function $x(a){const l=a;return po(r);function r(o){const c=o;let f;for(f in a)if(c[f]!==l[f])return!1;return!0}}function Jx(a){return po(l);function l(r){return r&&r.type===a}}function po(a){return l;function l(r,o,c){return!!(nk(r)&&a.call(this,r,typeof o=="number"?o:void 0,c||void 0))}}function ek(){return!0}function nk(a){return a!==null&&typeof a=="object"&&"type"in a}const Mg=[],tk=!0,kp=!1,ak="skip";function ik(a,l,r,o){let c;typeof l=="function"&&typeof r!="function"?(o=r,r=l):c=l;const f=Og(c),d=o?-1:1;p(a,void 0,[])();function p(g,m,y){const b=g&&typeof g=="object"?g:{};if(typeof b.type=="string"){const S=typeof b.tagName=="string"?b.tagName:typeof b.name=="string"?b.name:void 0;Object.defineProperty(x,"name",{value:"node ("+(g.type+(S?"<"+S+">":""))+")"})}return x;function x(){let S=Mg,I,z,U;if((!l||f(g,m,y[y.length-1]||void 0))&&(S=lk(r(g,y)),S[0]===kp))return S;if("children"in g&&g.children){const M=g;if(M.children&&S[0]!==ak)for(z=(o?M.children.length:-1)+d,U=y.concat(M);z>-1&&z<M.children.length;){const W=M.children[z];if(I=p(W,z,U)(),I[0]===kp)return I;z=typeof I[1]=="number"?I[1]:z+d}}return S}}}function lk(a){return Array.isArray(a)?a:typeof a=="number"?[tk,a]:a==null?Mg:[a]}function Lg(a,l,r,o){let c,f,d;typeof l=="function"&&typeof r!="function"?(f=void 0,d=l,c=r):(f=l,d=r,c=o),ik(a,f,p,c);function p(g,m){const y=m[m.length-1],b=y?y.children.indexOf(g):void 0;return d(g,b,y)}}const cc={}.hasOwnProperty,rk={};function ok(a,l){const r=l||rk,o=new Map,c=new Map,f=new Map,d={...Yx,...r.handlers},p={all:m,applyData:uk,definitionById:o,footnoteById:c,footnoteCounts:f,footnoteOrder:[],handlers:d,one:g,options:r,patch:sk,wrap:fk};return Lg(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const b=y.type==="definition"?o:c,x=String(y.identifier).toUpperCase();b.has(x)||b.set(x,y)}}),p;function g(y,b){const x=y.type,S=p.handlers[x];if(cc.call(p.handlers,x)&&S)return S(p,y,b);if(p.options.passThrough&&p.options.passThrough.includes(x)){if("children"in y){const{children:z,...U}=y,M=so(U);return M.children=p.all(y),M}return so(y)}return(p.options.unknownHandler||ck)(p,y,b)}function m(y){const b=[];if("children"in y){const x=y.children;let S=-1;for(;++S<x.length;){const I=p.one(x[S],y);if(I){if(S&&x[S-1].type==="break"&&(!Array.isArray(I)&&I.type==="text"&&(I.value=Cp(I.value)),!Array.isArray(I)&&I.type==="element")){const z=I.children[0];z&&z.type==="text"&&(z.value=Cp(z.value))}Array.isArray(I)?b.push(...I):b.push(I)}}}return b}}function sk(a,l){a.position&&(l.position=Ww(a))}function uk(a,l){let r=l;if(a&&a.data){const o=a.data.hName,c=a.data.hChildren,f=a.data.hProperties;if(typeof o=="string")if(r.type==="element")r.tagName=o;else{const d="children"in r?r.children:[r];r={type:"element",tagName:o,properties:{},children:d}}r.type==="element"&&f&&Object.assign(r.properties,so(f)),"children"in r&&r.children&&c!==null&&c!==void 0&&(r.children=c)}return r}function ck(a,l){const r=l.data||{},o="value"in l&&!(cc.call(r,"hProperties")||cc.call(r,"hChildren"))?{type:"text",value:l.value}:{type:"element",tagName:"div",properties:{},children:a.all(l)};return a.patch(l,o),a.applyData(l,o)}function fk(a,l){const r=[];let o=-1;for(l&&r.push({type:"text",value:`
`});++o<a.length;)o&&r.push({type:"text",value:`
`}),r.push(a[o]);return l&&a.length>0&&r.push({type:"text",value:`
`}),r}function Cp(a){let l=0,r=a.charCodeAt(l);for(;r===9||r===32;)l++,r=a.charCodeAt(l);return a.slice(l)}function Tp(a,l){const r=ok(a,l),o=r.one(a,void 0),c=Kx(r),f=Array.isArray(o)?{type:"root",children:o}:o||{type:"root",children:[]};return c&&f.children.push({type:"text",value:`
`},c),f}function dk(a,l){return a&&"run"in a?async function(r,o){const c=Tp(r,{file:o,...l});await a.run(c,o)}:function(r,o){return Tp(r,{file:o,...a||l})}}function Ap(a){if(a)throw a}var Fu,Ep;function hk(){if(Ep)return Fu;Ep=1;var a=Object.prototype.hasOwnProperty,l=Object.prototype.toString,r=Object.defineProperty,o=Object.getOwnPropertyDescriptor,c=function(m){return typeof Array.isArray=="function"?Array.isArray(m):l.call(m)==="[object Array]"},f=function(m){if(!m||l.call(m)!=="[object Object]")return!1;var y=a.call(m,"constructor"),b=m.constructor&&m.constructor.prototype&&a.call(m.constructor.prototype,"isPrototypeOf");if(m.constructor&&!y&&!b)return!1;var x;for(x in m);return typeof x>"u"||a.call(m,x)},d=function(m,y){r&&y.name==="__proto__"?r(m,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):m[y.name]=y.newValue},p=function(m,y){if(y==="__proto__")if(a.call(m,y)){if(o)return o(m,y).value}else return;return m[y]};return Fu=function g(){var m,y,b,x,S,I,z=arguments[0],U=1,M=arguments.length,W=!1;for(typeof z=="boolean"&&(W=z,z=arguments[1]||{},U=2),(z==null||typeof z!="object"&&typeof z!="function")&&(z={});U<M;++U)if(m=arguments[U],m!=null)for(y in m)b=p(z,y),x=p(m,y),z!==x&&(W&&x&&(f(x)||(S=c(x)))?(S?(S=!1,I=b&&c(b)?b:[]):I=b&&f(b)?b:{},d(z,{name:y,newValue:g(W,I,x)})):typeof x<"u"&&d(z,{name:y,newValue:x}));return z},Fu}var mk=hk();const Vu=uo(mk);function fc(a){if(typeof a!="object"||a===null)return!1;const l=Object.getPrototypeOf(a);return(l===null||l===Object.prototype||Object.getPrototypeOf(l)===null)&&!(Symbol.toStringTag in a)&&!(Symbol.iterator in a)}function pk(){const a=[],l={run:r,use:o};return l;function r(...c){let f=-1;const d=c.pop();if(typeof d!="function")throw new TypeError("Expected function as last argument, not "+d);p(null,...c);function p(g,...m){const y=a[++f];let b=-1;if(g){d(g);return}for(;++b<c.length;)(m[b]===null||m[b]===void 0)&&(m[b]=c[b]);c=m,y?gk(y,p)(...m):d(null,...m)}}function o(c){if(typeof c!="function")throw new TypeError("Expected `middelware` to be a function, not "+c);return a.push(c),l}}function gk(a,l){let r;return o;function o(...d){const p=a.length>d.length;let g;p&&d.push(c);try{g=a.apply(this,d)}catch(m){const y=m;if(p&&r)throw y;return c(y)}p||(g&&g.then&&typeof g.then=="function"?g.then(f,c):g instanceof Error?c(g):f(g))}function c(d,...p){r||(r=!0,l(d,...p))}function f(d){c(null,d)}}const ut={basename:yk,dirname:bk,extname:vk,join:Sk,sep:"/"};function yk(a,l){if(l!==void 0&&typeof l!="string")throw new TypeError('"ext" argument must be a string');Ll(a);let r=0,o=-1,c=a.length,f;if(l===void 0||l.length===0||l.length>a.length){for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else o<0&&(f=!0,o=c+1);return o<0?"":a.slice(r,o)}if(l===a)return"";let d=-1,p=l.length-1;for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else d<0&&(f=!0,d=c+1),p>-1&&(a.codePointAt(c)===l.codePointAt(p--)?p<0&&(o=c):(p=-1,o=d));return r===o?o=d:o<0&&(o=a.length),a.slice(r,o)}function bk(a){if(Ll(a),a.length===0)return".";let l=-1,r=a.length,o;for(;--r;)if(a.codePointAt(r)===47){if(o){l=r;break}}else o||(o=!0);return l<0?a.codePointAt(0)===47?"/":".":l===1&&a.codePointAt(0)===47?"//":a.slice(0,l)}function vk(a){Ll(a);let l=a.length,r=-1,o=0,c=-1,f=0,d;for(;l--;){const p=a.codePointAt(l);if(p===47){if(d){o=l+1;break}continue}r<0&&(d=!0,r=l+1),p===46?c<0?c=l:f!==1&&(f=1):c>-1&&(f=-1)}return c<0||r<0||f===0||f===1&&c===r-1&&c===o+1?"":a.slice(c,r)}function Sk(...a){let l=-1,r;for(;++l<a.length;)Ll(a[l]),a[l]&&(r=r===void 0?a[l]:r+"/"+a[l]);return r===void 0?".":wk(r)}function wk(a){Ll(a);const l=a.codePointAt(0)===47;let r=xk(a,!l);return r.length===0&&!l&&(r="."),r.length>0&&a.codePointAt(a.length-1)===47&&(r+="/"),l?"/"+r:r}function xk(a,l){let r="",o=0,c=-1,f=0,d=-1,p,g;for(;++d<=a.length;){if(d<a.length)p=a.codePointAt(d);else{if(p===47)break;p=47}if(p===47){if(!(c===d-1||f===1))if(c!==d-1&&f===2){if(r.length<2||o!==2||r.codePointAt(r.length-1)!==46||r.codePointAt(r.length-2)!==46){if(r.length>2){if(g=r.lastIndexOf("/"),g!==r.length-1){g<0?(r="",o=0):(r=r.slice(0,g),o=r.length-1-r.lastIndexOf("/")),c=d,f=0;continue}}else if(r.length>0){r="",o=0,c=d,f=0;continue}}l&&(r=r.length>0?r+"/..":"..",o=2)}else r.length>0?r+="/"+a.slice(c+1,d):r=a.slice(c+1,d),o=d-c-1;c=d,f=0}else p===46&&f>-1?f++:f=-1}return r}function Ll(a){if(typeof a!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(a))}const kk={cwd:Ck};function Ck(){return"/"}function dc(a){return!!(a!==null&&typeof a=="object"&&"href"in a&&a.href&&"protocol"in a&&a.protocol&&a.auth===void 0)}function Tk(a){if(typeof a=="string")a=new URL(a);else if(!dc(a)){const l=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+a+"`");throw l.code="ERR_INVALID_ARG_TYPE",l}if(a.protocol!=="file:"){const l=new TypeError("The URL must be of scheme file");throw l.code="ERR_INVALID_URL_SCHEME",l}return Ak(a)}function Ak(a){if(a.hostname!==""){const o=new TypeError('File URL host must be "localhost" or empty on darwin');throw o.code="ERR_INVALID_FILE_URL_HOST",o}const l=a.pathname;let r=-1;for(;++r<l.length;)if(l.codePointAt(r)===37&&l.codePointAt(r+1)===50){const o=l.codePointAt(r+2);if(o===70||o===102){const c=new TypeError("File URL path must not include encoded / characters");throw c.code="ERR_INVALID_FILE_URL_PATH",c}}return decodeURIComponent(l)}const Qu=["history","path","basename","stem","extname","dirname"];class zg{constructor(l){let r;l?dc(l)?r={path:l}:typeof l=="string"||Ek(l)?r={value:l}:r=l:r={},this.cwd="cwd"in r?"":kk.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let o=-1;for(;++o<Qu.length;){const f=Qu[o];f in r&&r[f]!==void 0&&r[f]!==null&&(this[f]=f==="history"?[...r[f]]:r[f])}let c;for(c in r)Qu.includes(c)||(this[c]=r[c])}get basename(){return typeof this.path=="string"?ut.basename(this.path):void 0}set basename(l){Ku(l,"basename"),Xu(l,"basename"),this.path=ut.join(this.dirname||"",l)}get dirname(){return typeof this.path=="string"?ut.dirname(this.path):void 0}set dirname(l){_p(this.basename,"dirname"),this.path=ut.join(l||"",this.basename)}get extname(){return typeof this.path=="string"?ut.extname(this.path):void 0}set extname(l){if(Xu(l,"extname"),_p(this.dirname,"extname"),l){if(l.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(l.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=ut.join(this.dirname,this.stem+(l||""))}get path(){return this.history[this.history.length-1]}set path(l){dc(l)&&(l=Tk(l)),Ku(l,"path"),this.path!==l&&this.history.push(l)}get stem(){return typeof this.path=="string"?ut.basename(this.path,this.extname):void 0}set stem(l){Ku(l,"stem"),Xu(l,"stem"),this.path=ut.join(this.dirname||"",l+(this.extname||""))}fail(l,r,o){const c=this.message(l,r,o);throw c.fatal=!0,c}info(l,r,o){const c=this.message(l,r,o);return c.fatal=void 0,c}message(l,r,o){const c=new pn(l,r,o);return this.path&&(c.name=this.path+":"+c.name,c.file=this.path),c.fatal=!1,this.messages.push(c),c}toString(l){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(l||void 0).decode(this.value)}}function Xu(a,l){if(a&&a.includes(ut.sep))throw new Error("`"+l+"` cannot be a path: did not expect `"+ut.sep+"`")}function Ku(a,l){if(!a)throw new Error("`"+l+"` cannot be empty")}function _p(a,l){if(!a)throw new Error("Setting `"+l+"` requires `path` to be set too")}function Ek(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const _k=(function(a){const o=this.constructor.prototype,c=o[a],f=function(){return c.apply(f,arguments)};return Object.setPrototypeOf(f,o),f}),Dk={}.hasOwnProperty;class Nc extends _k{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=pk()}copy(){const l=new Nc;let r=-1;for(;++r<this.attachers.length;){const o=this.attachers[r];l.use(...o)}return l.data(Vu(!0,{},this.namespace)),l}data(l,r){return typeof l=="string"?arguments.length===2?(Ju("data",this.frozen),this.namespace[l]=r,this):Dk.call(this.namespace,l)&&this.namespace[l]||void 0:l?(Ju("data",this.frozen),this.namespace=l,this):this.namespace}freeze(){if(this.frozen)return this;const l=this;for(;++this.freezeIndex<this.attachers.length;){const[r,...o]=this.attachers[this.freezeIndex];if(o[0]===!1)continue;o[0]===!0&&(o[0]=void 0);const c=r.call(l,...o);typeof c=="function"&&this.transformers.use(c)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(l){this.freeze();const r=to(l),o=this.parser||this.Parser;return Zu("parse",o),o(String(r),r)}process(l,r){const o=this;return this.freeze(),Zu("process",this.parser||this.Parser),$u("process",this.compiler||this.Compiler),r?c(void 0,r):new Promise(c);function c(f,d){const p=to(l),g=o.parse(p);o.run(g,p,function(y,b,x){if(y||!b||!x)return m(y);const S=b,I=o.stringify(S,x);Mk(I)?x.value=I:x.result=I,m(y,x)});function m(y,b){y||!b?d(y):f?f(b):r(void 0,b)}}}processSync(l){let r=!1,o;return this.freeze(),Zu("processSync",this.parser||this.Parser),$u("processSync",this.compiler||this.Compiler),this.process(l,c),Rp("processSync","process",r),o;function c(f,d){r=!0,Ap(f),o=d}}run(l,r,o){Dp(l),this.freeze();const c=this.transformers;return!o&&typeof r=="function"&&(o=r,r=void 0),o?f(void 0,o):new Promise(f);function f(d,p){const g=to(r);c.run(l,g,m);function m(y,b,x){const S=b||l;y?p(y):d?d(S):o(void 0,S,x)}}}runSync(l,r){let o=!1,c;return this.run(l,r,f),Rp("runSync","run",o),c;function f(d,p){Ap(d),c=p,o=!0}}stringify(l,r){this.freeze();const o=to(r),c=this.compiler||this.Compiler;return $u("stringify",c),Dp(l),c(l,o)}use(l,...r){const o=this.attachers,c=this.namespace;if(Ju("use",this.frozen),l!=null)if(typeof l=="function")g(l,r);else if(typeof l=="object")Array.isArray(l)?p(l):d(l);else throw new TypeError("Expected usable value, not `"+l+"`");return this;function f(m){if(typeof m=="function")g(m,[]);else if(typeof m=="object")if(Array.isArray(m)){const[y,...b]=m;g(y,b)}else d(m);else throw new TypeError("Expected usable value, not `"+m+"`")}function d(m){if(!("plugins"in m)&&!("settings"in m))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");p(m.plugins),m.settings&&(c.settings=Vu(!0,c.settings,m.settings))}function p(m){let y=-1;if(m!=null)if(Array.isArray(m))for(;++y<m.length;){const b=m[y];f(b)}else throw new TypeError("Expected a list of plugins, not `"+m+"`")}function g(m,y){let b=-1,x=-1;for(;++b<o.length;)if(o[b][0]===m){x=b;break}if(x===-1)o.push([m,...y]);else if(y.length>0){let[S,...I]=y;const z=o[x][1];fc(z)&&fc(S)&&(S=Vu(!0,z,S)),o[x]=[m,S,...I]}}}}const Rk=new Nc().freeze();function Zu(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `parser`")}function $u(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `compiler`")}function Ju(a,l){if(l)throw new Error("Cannot call `"+a+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function Dp(a){if(!fc(a)||typeof a.type!="string")throw new TypeError("Expected node, got `"+a+"`")}function Rp(a,l,r){if(!r)throw new Error("`"+a+"` finished async. Use `"+l+"` instead")}function to(a){return Ok(a)?a:new zg(a)}function Ok(a){return!!(a&&typeof a=="object"&&"message"in a&&"messages"in a)}function Mk(a){return typeof a=="string"||Lk(a)}function Lk(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const zk="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",Op=[],Mp={allowDangerousHtml:!0},Nk=/^(https?|ircs?|mailto|xmpp)$/i,Ik=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function Uk(a){const l=Bk(a),r=Hk(a);return qk(l.runSync(l.parse(r),r),a)}function Bk(a){const l=a.rehypePlugins||Op,r=a.remarkPlugins||Op,o=a.remarkRehypeOptions?{...a.remarkRehypeOptions,...Mp}:Mp;return Rk().use(yx).use(r).use(dk,o).use(l)}function Hk(a){const l=a.children||"",r=new zg;return typeof l=="string"&&(r.value=l),r}function qk(a,l){const r=l.allowedElements,o=l.allowElement,c=l.components,f=l.disallowedElements,d=l.skipHtml,p=l.unwrapDisallowed,g=l.urlTransform||jk;for(const y of Ik)Object.hasOwn(l,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+zk+y.id,void 0);return Lg(a,m),Kw(a,{Fragment:sn.Fragment,components:c,ignoreInvalidStyle:!0,jsx:sn.jsx,jsxs:sn.jsxs,passKeys:!0,passNode:!0});function m(y,b,x){if(y.type==="raw"&&x&&typeof b=="number")return d?x.children.splice(b,1):x.children[b]={type:"text",value:y.value},b;if(y.type==="element"){let S;for(S in Yu)if(Object.hasOwn(Yu,S)&&Object.hasOwn(y.properties,S)){const I=y.properties[S],z=Yu[S];(z===null||z.includes(y.tagName))&&(y.properties[S]=g(String(I||""),S,y))}}if(y.type==="element"){let S=r?!r.includes(y.tagName):f?f.includes(y.tagName):!1;if(!S&&o&&typeof b=="number"&&(S=!o(y,b,x)),S&&x&&typeof b=="number")return p&&y.children?x.children.splice(b,1,...y.children):x.children.splice(b,1),b}}}function jk(a){const l=a.indexOf(":"),r=a.indexOf("?"),o=a.indexOf("#"),c=a.indexOf("/");return l===-1||c!==-1&&l>c||r!==-1&&l>r||o!==-1&&l>o||Nk.test(a.slice(0,l))?a:""}function Pk(){const{slug:a}=Yv(),l=wc.find(r=>r.slug===a);return l?sn.jsx("div",{className:"markdown",children:sn.jsx(Uk,{children:l.content})}):sn.jsx("div",{children:"Document not found"})}function Yk(){return sn.jsx(DS,{children:sn.jsxs("div",{style:{display:"flex",minHeight:"100vh"},children:[sn.jsx(ww,{}),sn.jsxs(lS,{children:[sn.jsx(nc,{path:"/",element:sn.jsx(aS,{to:`/docs/${wc[0].slug}`})}),sn.jsx(nc,{path:"/docs/:slug",element:sn.jsx(Pk,{})})]})]})})}rv.createRoot(document.getElementById("root")).render(sn.jsx($b.StrictMode,{children:sn.jsx(Yk,{})}));
