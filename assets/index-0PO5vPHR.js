...
5.  Add user to group? usermod -aG`,XS=`# Linux Security Cheat Sheet
...
23.  ### Legal Warning Banners
    ...
    \`\`\``,QS=`# 15 Linux One-Liners That Feel Like Cheating
...
-   1m ~ 5m ~ 15m — The load is consistent (stable).`,WS=`# Linux Commands: Find All SUID Binaries (for Privilege Escalation)
...
\`\`\``,PS=`# Most Feared Linux Commands to Know
...
\`\`\`
ssh -vvv user@server
\`\`\``,$S=`# Setting a Login Banner on Linux Servers 
...
\`\`\``,e1=`# What SRE Interviewers Really Look For
...
Used correctly, this boosts productivity massively.`,n1=`## Convert a Meeting from Video .mp4 to Audio with AI in Mac Terminal and Generating MoM's. 
...
> "Summarize the following meeting transcript into key decisions, action items, and important discussion points and generate a MoM for this."`,t1=`# Using Manga-Downloader on Mac
...
Check flags on how to use CLI properly from the documentation.`,a1=`# DevOps Commands Cheat Sheet (With Real-World Examples)
...
48.  \`journalctl\`  — View system logs
    ...
    Copy:  \`journalctl -u nginx\`  # Shows logs for the nginx service.`,i1=`# How to Write Markdown .md Files in Your Code and Push It to GitHub Pages (Deployment)
...
to publish the changes to the GitHub repo (main branch) and it will automatically push the new build to the gh-pages branch (where you can check the deployment status).`,l1=`Terminal Tools For Mac OS and Linux
==============
...
nyancat in action`,r1=`# ✏️ Start writing
...
`});const m={type:"element",tagName:"li",properties:f,children:d};return a.patch(l,m),a.applyData(l,m)}function bx(a){let l=!1;if(a.type==="list"){l=a.spread||!1;const r=a.children;let o=-1;for(;!l&&++o<r.length;)l=Ag(r[o])}return l}function Ag(a){const l=a.spread;return l??a.children.length>1}function Sx(a,l){const r={},o=a.all(l);let c=-1;for(typeof l.start=="number"&&l.start!==1&&(r.start=l.start);++c<o.length;){const d=o[c];if(d.type==="element"&&d.tagName==="li"&&d.properties&&Array.isArray(d.properties.className)&&d.properties.className.includes("task-list-item")){r.className=["contains-task-list"];break}}const f={type:"element",tagName:l.ordered?"ol":"ul",properties:r,children:a.wrap(o,!0)};return a.patch(l,f),a.applyData(l,f)}function wx(a,l){const r={type:"element",tagName:"p",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function xx(a,l){const r={type:"root",children:a.wrap(a.all(l))};return a.patch(l,r),a.applyData(l,r)}function Cx(a,l){const r={type:"element",tagName:"strong",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}function kx(a,l){const r=a.all(l),o=r.shift(),c=[];if(o){const d={type:"element",tagName:"thead",properties:{},children:a.wrap([o],!0)};a.patch(l.children[0],d),c.push(d)}if(r.length>0){const d={type:"element",tagName:"tbody",properties:{},children:a.wrap(r,!0)},p=kc(l.children[1]),g=og(l.children[l.children.length-1]);p&&g&&(d.position={start:p,end:g}),c.push(d)}const f={type:"element",tagName:"table",properties:{},children:a.wrap(c,!0)};return a.patch(l,f),a.applyData(l,f)}function Tx(a,l,r){const o=r?r.children:void 0,f=(o?o.indexOf(l):1)===0?"th":"td",d=r&&r.type==="table"?r.align:void 0,p=d?d.length:l.children.length;let g=-1;const m=[];for(;++g<p;){const v=l.children[g],x={},S=d?d[g]:void 0;S&&(x.align=S);let U={type:"element",tagName:f,properties:x,children:[]};v&&(U.children=a.all(v),a.patch(v,U),U=a.applyData(v,U)),m.push(U)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(m,!0)};return a.patch(l,y),a.applyData(l,y)}function Ex(a,l){const r={type:"element",tagName:"td",properties:{},children:a.all(l)};return a.patch(l,r),a.applyData(l,r)}const yp=9,vp=32;function Ax(a){const l=String(a),r=/\r?\n|\r/g;let o=r.exec(l),c=0;const f=[];for(;o;)f.push(bp(l.slice(c,o.index),c>0,!0),o[0]),c=o.index+o[0].length,o=r.exec(l);return f.push(bp(l.slice(c),c>0,!1)),f.join("")}function bp(a,l,r){let o=0,c=a.length;if(l){let f=a.codePointAt(o);for(;f===yp||f===vp;)o++,f=a.codePointAt(o)}if(r){let f=a.codePointAt(c-1);for(;f===yp||f===vp;)c--,f=a.codePointAt(c-1)}return c>o?a.slice(o,c):""}function Dx(a,l){const r={type:"text",value:Ax(String(l.value))};return a.patch(l,r),a.applyData(l,r)}function Rx(a,l){const r={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(l,r),a.applyData(l,r)}const zx={blockquote:lx,break:rx,code:ox,delete:sx,emphasis:ux,footnoteReference:cx,heading:fx,html:dx,imageReference:hx,image:mx,inlineCode:px,linkReference:gx,link:yx,listItem:vx,list:Sx,paragraph:wx,root:xx,strong:Cx,table:kx,tableCell:Ex,tableRow:Tx,text:Dx,thematicBreak:Rx,toml:eo,yaml:eo,definition:eo,footnoteDefinition:eo};function eo(){}const Dg=-1,mo=0,Al=1,oo=2,Mc=3,Oc=4,_c=5,Lc=6,Rg=7,zg=8,Sp=typeof self=="object"?self:globalThis,Mx=(a,l)=>{const r=(c,f)=>(a.set(f,c),c),o=c=>{if(a.has(c))return a.get(c);const[f,d]=l[c];switch(f){case mo:case Dg:return r(d,c);case Al:{const p=r([],c);for(const g of d)p.push(o(g));return p}case oo:{const p=r({},c);for(const[g,m]of d)p[o(g)]=o(m);return p}case Mc:return r(new Date(d),c);case Oc:{const{source:p,flags:g}=d;return r(new RegExp(p,g),c)}case _c:{const p=r(new Map,c);for(const[g,m]of d)p.set(o(g),o(m));return p}case Lc:{const p=r(new Set,c);for(const g of d)p.add(o(g));return p}case Rg:{const{name:p,message:g}=d;return r(new Sp[p](g),c)}case zg:return r(BigInt(d),c);case"BigInt":return r(Object(BigInt(d)),c);case"ArrayBuffer":return r(new Uint8Array(d).buffer,d);case"DataView":{const{buffer:p}=new Uint8Array(d);return r(new DataView(p),d)}}return r(new Sp[f](d),c)};return o},wp=a=>Mx(new Map,a)(0),vi="",{toString:Ox}={},{keys:_x}=Object,kl=a=>{const l=typeof a;if(l!=="object"||!a)return[mo,l];const r=Ox.call(a).slice(8,-1);switch(r){case"Array":return[Al,vi];case"Object":return[oo,vi];case"Date":return[Mc,vi];case"RegExp":return[Oc,vi];case"Map":return[_c,vi];case"Set":return[Lc,vi];case"DataView":return[Al,r]}return r.includes("Array")?[Al,r]:r.includes("Error")?[Rg,r]:[oo,r]},no=([a,l])=>a===mo&&(l==="function"||l==="symbol"),Lx=(a,l,r,o)=>{const c=(d,p)=>{const g=o.push(d)-1;return r.set(p,g),g},f=d=>{if(r.has(d))return r.get(d);let[p,g]=kl(d);switch(p){case mo:{let y=d;switch(g){case"bigint":p=zg,y=d.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+g);y=null;break;case"undefined":return c([Dg],d)}return c([p,y],d)}case Al:{if(g){let x=d;return g==="DataView"?x=new Uint8Array(d.buffer):g==="ArrayBuffer"&&(x=new Uint8Array(d)),c([g,[...x]],d)}const y=[],v=c([p,y],d);for(const x of d)y.push(f(x));return v}case oo:{if(g)switch(g){case"BigInt":return c([g,d.toString()],d);case"Boolean":case"Number":case"String":return c([g,d.valueOf()],d)}if(l&&"toJSON"in d)return f(d.toJSON());const y=[],v=c([p,y],d);for(const x of _x(d))(a||!no(kl(d[x])))&&y.push([f(x),f(d[x])]);return v}case Mc:return c([p,d.toISOString()],d);case Oc:{const{source:y,flags:v}=d;return c([p,{source:y,flags:v}],d)}case _c:{const y=[],v=c([p,y],d);for(const[x,S]of d)(a||!(no(kl(x))||no(kl(S))))&&y.push([f(x),f(S)]);return v}case Lc:{const y=[],v=c([p,y],d);for(const x of d)(a||!no(kl(x)))&&y.push(f(x));return v}}const{message:m}=d;return c([p,{name:g,message:m}],d)};return f},xp=(a,{json:l,lossy:r}={})=>{const o=[];return Lx(!(l||r),!!l,new Map,o)(a),o},so=typeof structuredClone=="function"?(a,l)=>l&&("json"in l||"lossy"in l)?wp(xp(a,l)):structuredClone(a):(a,l)=>wp(xp(a,l));function Nx(a,l){const r=[{type:"text",value:"↩"}];return l>1&&r.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(l)}]}),r}function Ux(a,l){return"Back to reference "+(a+1)+(l>1?"-"+l:"")}function Hx(a){const l=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",r=a.options.footnoteBackContent||Nx,o=a.options.footnoteBackLabel||Ux,c=a.options.footnoteLabel||"Footnotes",f=a.options.footnoteLabelTagName||"h2",d=a.options.footnoteLabelProperties||{className:["sr-only"]},p=[];let g=-1;for(;++g<a.footnoteOrder.length;){const m=a.footnoteById.get(a.footnoteOrder[g]);if(!m)continue;const y=a.all(m),v=String(m.identifier).toUpperCase(),x=ki(v.toLowerCase());let S=0;const U=[],L=a.footnoteCounts.get(v);for(;L!==void 0&&++S<=L;){U.length>0&&U.push({type:"text",value:" "});let V=typeof r=="string"?r:r(g,S);typeof V=="string"&&(V={type:"text",value:V}),U.push({type:"element",tagName:"a",properties:{href:"#"+l+"fnref-"+x+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof o=="string"?o:o(g,S),className:["data-footnote-backref"]},children:Array.isArray(V)?V:[V]})}const H=y[y.length-1];if(H&&H.type==="element"&&H.tagName==="p"){const V=H.children[H.children.length-1];V&&V.type==="text"?V.value+=" ":H.children.push({type:"text",value:" "}),H.children.push(...U)}else y.push(...U);const O={type:"element",tagName:"li",properties:{id:l+"fn-"+x},children:a.wrap(y,!0)};a.patch(m,O),p.push(O)}if(p.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:f,properties:{...so(d),id:"footnote-label"},children:[{type:"text",value:c}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(p,!0)},{type:"text",value:`
`}]}}const Mg=(function(a){if(a==null)return qx;if(typeof a=="function")return po(a);if(typeof a=="object")return Array.isArray(a)?Bx(a):Ix(a);if(typeof a=="string")return jx(a);throw new Error("Expected function, string, or object as test")});function Bx(a){const l=[];let r=-1;for(;++r<a.length;)l[r]=Mg(a[r]);return po(o);function o(...c){let f=-1;for(;++f<l.length;)if(l[f].apply(this,c))return!0;return!1}}function Ix(a){const l=a;return po(r);function r(o){const c=o;let f;for(f in a)if(c[f]!==l[f])return!1;return!0}}function jx(a){return po(l);function l(r){return r&&r.type===a}}function po(a){return l;function l(r,o,c){return!!(Yx(r)&&a.call(this,r,typeof o=="number"?o:void 0,c||void 0))}}function qx(){return!0}function Yx(a){return a!==null&&typeof a=="object"&&"type"in a}const Og=[],Gx=!0,Cp=!1,Fx="skip";function Vx(a,l,r,o){let c;typeof l=="function"&&typeof r!="function"?(o=r,r=l):c=l;const f=Mg(c),d=o?-1:1;p(a,void 0,[])();function p(g,m,y){const v=g&&typeof g=="object"?g:{};if(typeof v.type=="string"){const S=typeof v.tagName=="string"?v.tagName:typeof v.name=="string"?v.name:void 0;Object.defineProperty(x,"name",{value:"node ("+(g.type+(S?"<"+S+">":""))+")"})}return x;function x(){let S=Og,U,L,H;if((!l||f(g,m,y[y.length-1]||void 0))&&(S=Xx(r(g,y)),S[0]===Cp))return S;if("children"in g&&g.children){const O=g;if(O.children&&S[0]!==Fx)for(L=(o?O.children.length:-1)+d,H=y.concat(O);L>-1&&L<O.children.length;){const V=O.children[L];if(U=p(V,L,H)(),U[0]===Cp)return U;L=typeof U[1]=="number"?U[1]:L+d}}return S}}}function Xx(a){return Array.isArray(a)?a:typeof a=="number"?[Gx,a]:a==null?Og:[a]}function _g(a,l,r,o){let c,f,d;typeof l=="function"&&typeof r!="function"?(f=void 0,d=l,c=r):(f=l,d=r,c=o),Vx(a,f,p,c);function p(g,m){const y=m[m.length-1],v=y?y.children.indexOf(g):void 0;return d(g,v,y)}}const cc={}.hasOwnProperty,Qx={};function Wx(a,l){const r=l||Qx,o=new Map,c=new Map,f=new Map,d={...zx,...r.handlers},p={all:m,applyData:Kx,definitionById:o,footnoteById:c,footnoteCounts:f,footnoteOrder:[],handlers:d,one:g,options:r,patch:Px,wrap:Jx};return _g(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const v=y.type==="definition"?o:c,x=String(y.identifier).toUpperCase();v.has(x)||v.set(x,y)}}),p;function g(y,v){const x=y.type,S=p.handlers[x];if(cc.call(p.handlers,x)&&S)return S(p,y,v);if(p.options.passThrough&&p.options.passThrough.includes(x)){if("children"in y){const{children:L,...H}=y,O=so(H);return O.children=p.all(y),O}return so(y)}return(p.options.unknownHandler||Zx)(p,y,v)}function m(y){const v=[];if("children"in y){const x=y.children;let S=-1;for(;++S<x.length;){const U=p.one(x[S],y);if(U){if(S&&x[S-1].type==="break"&&(!Array.isArray(U)&&U.type==="text"&&(U.value=kp(U.value)),!Array.isArray(U)&&U.type==="element")){const L=U.children[0];L&&L.type==="text"&&(L.value=kp(L.value))}Array.isArray(U)?v.push(...U):v.push(U)}}}return v}}function Px(a,l){a.position&&(l.position=O1(a))}function Kx(a,l){let r=l;if(a&&a.data){const o=a.data.hName,c=a.data.hChildren,f=a.data.hProperties;if(typeof o=="string")if(r.type==="element")r.tagName=o;else{const d="children"in r?r.children:[r];r={type:"element",tagName:o,properties:{},children:d}}r.type==="element"&&f&&Object.assign(r.properties,so(f)),"children"in r&&r.children&&c!==null&&c!==void 0&&(r.children=c)}return r}function Zx(a,l){const r=l.data||{},o="value"in l&&!(cc.call(r,"hProperties")||cc.call(r,"hChildren"))?{type:"text",value:l.value}:{type:"element",tagName:"div",properties:{},children:a.all(l)};return a.patch(l,o),a.applyData(l,o)}function Jx(a,l){const r=[];let o=-1;for(l&&r.push({type:"text",value:`
`});++o<a.length;)o&&r.push({type:"text",value:`
`}),r.push(a[o]);return l&&a.length>0&&r.push({type:"text",value:`
`}),r}function kp(a){let l=0,r=a.charCodeAt(l);for(;r===9||r===32;)l++,r=a.charCodeAt(l);return a.slice(l)}function Tp(a,l){const r=Wx(a,l),o=r.one(a,void 0),c=Hx(r),f=Array.isArray(o)?{type:"root",children:o}:o||{type:"root",children:[]};return c&&f.children.push({type:"text",value:`
`},c),f}function $x(a,l){return a&&"run"in a?async function(r,o){const c=Tp(r,{file:o,...l});await a.run(c,o)}:function(r,o){return Tp(r,{file:o,...a||l})}}function Ep(a){if(a)throw a}var Xu,Ap;function eC(){if(Ap)return Xu;Ap=1;var a=Object.prototype.hasOwnProperty,l=Object.prototype.toString,r=Object.defineProperty,o=Object.getOwnPropertyDescriptor,c=function(m){return typeof Array.isArray=="function"?Array.isArray(m):l.call(m)==="[object Array]"},f=function(m){if(!m||l.call(m)!=="[object Object]")return!1;var y=a.call(m,"constructor"),v=m.constructor&&m.constructor.prototype&&a.call(m.constructor.prototype,"isPrototypeOf");if(m.constructor&&!y&&!v)return!1;var x;for(x in m);return typeof x>"u"||a.call(m,x)},d=function(m,y){r&&y.name==="__proto__"?r(m,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):m[y.name]=y.newValue},p=function(m,y){if(y==="__proto__")if(a.call(m,y)){if(o)return o(m,y).value}else return;return m[y]};return Xu=function g(){var m,y,v,x,S,U,L=arguments[0],H=1,O=arguments.length,V=!1;for(typeof L=="boolean"&&(V=L,L=arguments[1]||{},H=2),(L==null||typeof L!="object"&&typeof L!="function")&&(L={});H<O;++H)if(m=arguments[H],m!=null)for(y in m)v=p(L,y),x=p(m,y),L!==x&&(V&&x&&(f(x)||(S=c(x)))?(S?(S=!1,U=v&&c(v)?v:[]):U=v&&f(v)?v:{},d(L,{name:y,newValue:g(V,U,x)})):typeof x<"u"&&d(L,{name:y,newValue:x}));return L},Xu}var nC=eC();const Qu=uo(nC);function fc(a){if(typeof a!="object"||a===null)return!1;const l=Object.getPrototypeOf(a);return(l===null||l===Object.prototype||Object.getPrototypeOf(l)===null)&&!(Symbol.toStringTag in a)&&!(Symbol.iterator in a)}function tC(){const a=[],l={run:r,use:o};return l;function r(...c){let f=-1;const d=c.pop();if(typeof d!="function")throw new TypeError("Expected function as last argument, not "+d);p(null,...c);function p(g,...m){const y=a[++f];let v=-1;if(g){d(g);return}for(;++v<c.length;)(m[v]===null||m[v]===void 0)&&(m[v]=c[v]);c=m,y?aC(y,p)(...m):d(null,...m)}}function o(c){if(typeof c!="function")throw new TypeError("Expected `middelware` to be a function, not "+c);return a.push(c),l}}function aC(a,l){let r;return o;function o(...d){const p=a.length>d.length;let g;p&&d.push(c);try{g=a.apply(this,d)}catch(m){const y=m;if(p&&r)throw y;return c(y)}p||(g&&g.then&&typeof g.then=="function"?g.then(f,c):g instanceof Error?c(g):f(g))}function c(d,...p){r||(r=!0,l(d,...p))}function f(d){c(null,d)}}const ut={basename:iC,dirname:lC,extname:rC,join:oC,sep:"/"};function iC(a,l){if(l!==void 0&&typeof l!="string")throw new TypeError('"ext" argument must be a string');_l(a);let r=0,o=-1,c=a.length,f;if(l===void 0||l.length===0||l.length>a.length){for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else o<0&&(f=!0,o=c+1);return o<0?"":a.slice(r,o)}if(l===a)return"";let d=-1,p=l.length-1;for(;c--;)if(a.codePointAt(c)===47){if(f){r=c+1;break}}else d<0&&(f=!0,d=c+1),p>-1&&(a.codePointAt(c)===l.codePointAt(p--)?p<0&&(o=c):(p=-1,o=d));return r===o?o=d:o<0&&(o=a.length),a.slice(r,o)}function lC(a){if(_l(a),a.length===0)return".";let l=-1,r=a.length,o;for(;--r;)if(a.codePointAt(r)===47){if(o){l=r;break}}else o||(o=!0);return l<0?a.codePointAt(0)===47?"/":".":l===1&&a.codePointAt(0)===47?"//":a.slice(0,l)}function rC(a){_l(a);let l=a.length,r=-1,o=0,c=-1,f=0,d;for(;l--;){const p=a.codePointAt(l);if(p===47){if(d){o=l+1;break}continue}r<0&&(d=!0,r=l+1),p===46?c<0?c=l:f!==1&&(f=1):c>-1&&(f=-1)}return c<0||r<0||f===0||f===1&&c===r-1&&c===o+1?"":a.slice(c,r)}function oC(...a){let l=-1,r;for(;++l<a.length;)_l(a[l]),a[l]&&(r=r===void 0?a[l]:r+"/"+a[l]);return r===void 0?".":sC(r)}function sC(a){_l(a);const l=a.codePointAt(0)===47;let r=uC(a,!l);return r.length===0&&!l&&(r="."),r.length>0&&a.codePointAt(a.length-1)===47&&(r+="/"),l?"/"+r:r}function uC(a,l){let r="",o=0,c=-1,f=0,d=-1,p,g;for(;++d<=a.length;){if(d<a.length)p=a.codePointAt(d);else{if(p===47)break;p=47}if(p===47){if(!(c===d-1||f===1))if(c!==d-1&&f===2){if(r.length<2||o!==2||r.codePointAt(r.length-1)!==46||r.codePointAt(r.length-2)!==46){if(r.length>2){if(g=r.lastIndexOf("/"),g!==r.length-1){g<0?(r="",o=0):(r=r.slice(0,g),o=r.length-1-r.lastIndexOf("/")),c=d,f=0;continue}}else if(r.length>0){r="",o=0,c=d,f=0;continue}}l&&(r=r.length>0?r+"/..":"..",o=2)}else r.length>0?r+="/"+a.slice(c+1,d):r=a.slice(c+1,d),o=d-c-1;c=d,f=0}else p===46&&f>-1?f++:f=-1}return r}function _l(a){if(typeof a!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(a))}const cC={cwd:fC};function fC(){return"/"}function dc(a){return!!(a!==null&&typeof a=="object"&&"href"in a&&a.href&&"protocol"in a&&a.protocol&&a.auth===void 0)}function dC(a){if(typeof a=="string")a=new URL(a);else if(!dc(a)){const l=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+a+"`");throw l.code="ERR_INVALID_ARG_TYPE",l}if(a.protocol!=="file:"){const l=new TypeError("The URL must be of scheme file");throw l.code="ERR_INVALID_URL_SCHEME",l}return hC(a)}function hC(a){if(a.hostname!==""){const o=new TypeError('File URL host must be "localhost" or empty on darwin');throw o.code="ERR_INVALID_FILE_URL_HOST",o}const l=a.pathname;let r=-1;for(;++r<l.length;)if(l.codePointAt(r)===37&&l.codePointAt(r+1)===50){const o=l.codePointAt(r+2);if(o===70||o===102){const c=new TypeError("File URL path must not include encoded / characters");throw c.code="ERR_INVALID_FILE_URL_PATH",c}}return decodeURIComponent(l)}const Wu=["history","path","basename","stem","extname","dirname"];class Lg{constructor(l){let r;l?dc(l)?r={path:l}:typeof l=="string"||mC(l)?r={value:l}:r=l:r={},this.cwd="cwd"in r?"":cC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let o=-1;for(;++o<Wu.length;){const f=Wu[o];f in r&&r[f]!==void 0&&r[f]!==null&&(this[f]=f==="history"?[...r[f]]:r[f])}let c;for(c in r)Wu.includes(c)||(this[c]=r[c])}get basename(){return typeof this.path=="string"?ut.basename(this.path):void 0}set basename(l){Ku(l,"basename"),Pu(l,"basename"),this.path=ut.join(this.dirname||"",l)}get dirname(){return typeof this.path=="string"?ut.dirname(this.path):void 0}set dirname(l){Dp(this.basename,"dirname"),this.path=ut.join(l||"",this.basename)}get extname(){return typeof this.path=="string"?ut.extname(this.path):void 0}set extname(l){if(Pu(l,"extname"),Dp(this.dirname,"extname"),l){if(l.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(l.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=ut.join(this.dirname,this.stem+(l||""))}get path(){return this.history[this.history.length-1]}set path(l){dc(l)&&(l=dC(l)),Ku(l,"path"),this.path!==l&&this.history.push(l)}get stem(){return typeof this.path=="string"?ut.basename(this.path,this.extname):void 0}set stem(l){Ku(l,"stem"),Pu(l,"stem"),this.path=ut.join(this.dirname||"",l+(this.extname||""))}fail(l,r,o){const c=this.message(l,r,o);throw c.fatal=!0,c}info(l,r,o){const c=this.message(l,r,o);return c.fatal=void 0,c}message(l,r,o){const c=new pn(l,r,o);return this.path&&(c.name=this.path+":"+c.name,c.file=this.path),c.fatal=!1,this.messages.push(c),c}toString(l){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(l||void 0).decode(this.value)}}function Pu(a,l){if(a&&a.includes(ut.sep))throw new Error("`"+l+"` cannot be a path: did not expect `"+ut.sep+"`")}function Ku(a,l){if(!a)throw new Error("`"+l+"` cannot be empty")}function Dp(a,l){if(!a)throw new Error("Setting `"+l+"` requires `path` to be set too")}function mC(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const pC=(function(a){const o=this.constructor.prototype,c=o[a],f=function(){return c.apply(f,arguments)};return Object.setPrototypeOf(f,o),f}),gC={}.hasOwnProperty;class Nc extends pC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=tC()}copy(){const l=new Nc;let r=-1;for(;++r<this.attachers.length;){const o=this.attachers[r];l.use(...o)}return l.data(Qu(!0,{},this.namespace)),l}data(l,r){return typeof l=="string"?arguments.length===2?($u("data",this.frozen),this.namespace[l]=r,this):gC.call(this.namespace,l)&&this.namespace[l]||void 0:l?($u("data",this.frozen),this.namespace=l,this):this.namespace}freeze(){if(this.frozen)return this;const l=this;for(;++this.freezeIndex<this.attachers.length;){const[r,...o]=this.attachers[this.freezeIndex];if(o[0]===!1)continue;o[0]===!0&&(o[0]=void 0);const c=r.call(l,...o);typeof c=="function"&&this.transformers.use(c)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(l){this.freeze();const r=to(l),o=this.parser||this.Parser;return Zu("parse",o),o(String(r),r)}process(l,r){const o=this;return this.freeze(),Zu("process",this.parser||this.Parser),Ju("process",this.compiler||this.Compiler),r?c(void 0,r):new Promise(c);function c(f,d){const p=to(l),g=o.parse(p);o.run(g,p,function(y,v,x){if(y||!v||!x)return m(y);const S=v,U=o.stringify(S,x);bC(U)?x.value=U:x.result=U,m(y,x)});function m(y,v){y||!v?d(y):f?f(v):r(void 0,v)}}}processSync(l){let r=!1,o;return this.freeze(),Zu("processSync",this.parser||this.Parser),Ju("processSync",this.compiler||this.Compiler),this.process(l,c),zp("processSync","process",r),o;function c(f,d){r=!0,Ep(f),o=d}}run(l,r,o){Rp(l),this.freeze();const c=this.transformers;return!o&&typeof r=="function"&&(o=r,r=void 0),o?f(void 0,o):new Promise(f);function f(d,p){const g=to(r);c.run(l,g,m);function m(y,v,x){const S=v||l;y?p(y):d?d(S):o(void 0,S,x)}}}runSync(l,r){let o=!1,c;return this.run(l,r,f),zp("runSync","run",o),c;function f(d,p){Ep(d),c=p,o=!0}}stringify(l,r){this.freeze();const o=to(r),c=this.compiler||this.Compiler;return Ju("stringify",c),Rp(l),c(l,o)}use(l,...r){const o=this.attachers,c=this.namespace;if($u("use",this.frozen),l!=null)if(typeof l=="function")g(l,r);else if(typeof l=="object")Array.isArray(l)?p(l):d(l);else throw new TypeError("Expected usable value, not `"+l+"`");return this;function f(m){if(typeof m=="function")g(m,[]);else if(typeof m=="object")if(Array.isArray(m)){const[y,...v]=m;g(y,v)}else d(m);else throw new TypeError("Expected usable value, not `"+m+"`")}function d(m){if(!("plugins"in m)&&!("settings"in m))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");p(m.plugins),m.settings&&(c.settings=Qu(!0,c.settings,m.settings))}function p(m){let y=-1;if(m!=null)if(Array.isArray(m))for(;++y<m.length;){const v=m[y];f(v)}else throw new TypeError("Expected a list of plugins, not `"+m+"`")}function g(m,y){let v=-1,x=-1;for(;++v<o.length;)if(o[v][0]===m){x=v;break}if(x===-1)o.push([m,...y]);else if(y.length>0){let[S,...U]=y;const L=o[x][1];fc(L)&&fc(S)&&(S=Qu(!0,L,S)),o[x]=[m,S,...U]}}}}const yC=new Nc().freeze();function Zu(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `parser`")}function Ju(a,l){if(typeof l!="function")throw new TypeError("Cannot `"+a+"` without `compiler`")}function $u(a,l){if(l)throw new Error("Cannot call `"+a+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function Rp(a){if(!fc(a)||typeof a.type!="string")throw new TypeError("Expected node, got `"+a+"`")}function zp(a,l,r){if(!r)throw new Error("`"+a+"` finished async. Use `"+l+"` instead")}function to(a){return vC(a)?a:new Lg(a)}function vC(a){return!!(a&&typeof a=="object"&&"message"in a&&"messages"in a)}function bC(a){return typeof a=="string"||SC(a)}function SC(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const wC="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",Mp=[],Op={allowDangerousHtml:!0},xC=/^(https?|ircs?|mailto|xmpp)$/i,CC=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function kC(a){const l=TC(a),r=EC(a);return AC(l.runSync(l.parse(r),r),a)}function TC(a){const l=a.rehypePlugins||Mp,r=a.remarkPlugins||Mp,o=a.remarkRehypeOptions?{...a.remarkRehypeOptions,...Op}:Op;return yC().use(ix).use(r).use($x,o).use(l)}function EC(a){const l=a.children||"",r=new Lg;return typeof l=="string"&&(r.value=l),r}function AC(a,l){const r=l.allowedElements,o=l.allowElement,c=l.components,f=l.disallowedElements,d=l.skipHtml,p=l.unwrapDisallowed,g=l.urlTransform||DC;for(const y of CC)Object.hasOwn(l,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+wC+y.id,void 0);return _g(a,m),H1(a,{Fragment:sn.Fragment,components:c,ignoreInvalidStyle:!0,jsx:sn.jsx,jsxs:sn.jsxs,passKeys:!0,passNode:!0});function m(y,v,x){if(y.type==="raw"&&x&&typeof v=="number")return d?x.children.splice(v,1):x.children[v]={type:"text",value:y.value},v;if(y.type==="element"){let S;for(S in Gu)if(Object.hasOwn(Gu,S)&&Object.hasOwn(y.properties,S)){const U=y.properties[S],L=Gu[S];(L===null||L.includes(y.tagName))&&(y.properties[S]=g(String(U||""),S,y))}}if(y.type==="element"){let S=r?!r.includes(y.tagName):f?f.includes(y.tagName):!1;if(!S&&o&&typeof v=="number"&&(S=!o(y,v,x)),S&&x&&typeof v=="number")return p&&y.children?x.children.splice(v,1,...y.children):x.children.splice(v,1),v}}}function DC(a){const l=a.indexOf(":"),r=a.indexOf("?"),o=a.indexOf("#"),c=a.indexOf("/");return l===-1||c!==-1&&l>c||r!==-1&&l>r||o!==-1&&l>o||xC.test(a.slice(0,l))?a:""}function RC(){const{slug:a}=Gb(),l=wc.find(r=>r.slug===a);return l?sn.jsx("div",{className:"markdown",children:sn.jsx(kC,{children:l.content})}):sn.jsx("div",{children:"Document not found"})}function zC(){return sn.jsx(RS,{children:sn.jsxs("div",{style:{display:"flex",minHeight:"100vh"},children:[sn.jsx(s1,{}),sn.jsxs(lS,{children:[sn.jsx(nc,{path:"/",element:sn.jsx(aS,{to:`/docs/${wc[0].slug}`})}),sn.jsx(nc,{path:"/docs/:slug",element:sn.jsx(RC,{})})]})]})})}rb.createRoot(document.getElementById("root")).render(sn.jsx(Jv.StrictMode,{children:sn.jsx(zC,{})}));
