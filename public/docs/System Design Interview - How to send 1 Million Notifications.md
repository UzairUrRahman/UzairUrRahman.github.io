...
```
for(User user : users) {    notificationService.send(user);}
```
...
![None](https://freedium-mirror.cfd/img/700/1*WQJdtNYFxHiArIsiAdBTKA.png)
...
![None](https://freedium-mirror.cfd/img/700/1*RHZU9emjqwkoIeJCQS1JpA.png)
...
![None](https://freedium-mirror.cfd/img/700/1*T9iWImxEElX0GVAQpRIV9w.png)
...
```
1,000 Workers100 Notifications / Second=100,000 Notifications / Second
```
...
![None](https://freedium-mirror.cfd/img/700/1*7QMng-vVqNEiGRzLYVHsvQ.png)
...
![None](https://freedium-mirror.cfd/img/700/1*dMvXsZUz99OLeROeGnycbA.png)
...
```
1 Request=1 Notification
```

we can do:

```
1 Request=500 Notifications
```
...
![None](https://freedium-mirror.cfd/img/700/1*LLKDiGQ6l3ndEyXJkkx1cA.png)

For example:

```
Retry 1Retry 2Retry 3Retry 4Retry 5
```
...
![None](https://freedium-mirror.cfd/img/700/1*ukCRvahlZ9ZdK32ZBSl3Aw.png)
...
![None](https://freedium-mirror.cfd/img/700/1*-daW8gYiCYj9mFzkleA2Xg.png)
